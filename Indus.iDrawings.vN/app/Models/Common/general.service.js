...
require('rxjs/Rx');
var GeneralService = (function (_super) {
    __extends(GeneralService, _super);
    function GeneralService(http) {
        _super.call(this, http);
        this.http = http;
        this.url = 'Common/GetFieldLookupValuesforList';
    }
    GeneralService.prototype.populateHasRelationddl = function (Id, formFieldId) {
