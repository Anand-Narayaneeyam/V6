...
var tabs_component_1 = require('../../tab/tabs.component');
var tab_component_1 = require('../../tab/tab.component');
var HatchPatternComponent = (function () {
    function HatchPatternComponent() {
        this.selectedTab = 0;
        this.showPicker = "none";
        this.strImageSrc = "";
        this.hatchAngle = new Array();
        this.hatchScale = new Array();
        this.hatchPatterEmit = new core_1.EventEmitter();
        this.angleEmit = new core_1.EventEmitter();
        this.scaleEmit = new core_1.EventEmitter();
        this.arrHatchArray = new Array();
    }
    HatchPatternComponent.prototype.ngOnInit = function () {
        var _this = this;
        for (var i = 0; i < 24; i++) {
        ...
        if (this.patternId != undefined || this.patternId != undefined) {
            ...
            this.arrHatchArray.find(function (e) {
                if (e.PatternId == _this.patternId) {
                    _this.strImageSrc = e.src;
                    return true;
                }
            });
        }
    };
    HatchPatternComponent.prototype.ngAfterViewInit = function () {
    };
    HatchPatternComponent.prototype.getSelectedTab = function (event) {
    };
    HatchPatternComponent.prototype.toggleHatchPattern = function (event) {
    ...
    HatchPatternComponent.prototype.KeyPresstoggleHatchPattern = function (Keyevent) {
    ...
    HatchPatternComponent.prototype.KeyPressselectedImageData = function (event, id) {
        var key = event.keyCode || event.which;
        if (key == 13 || key == 32) {
            var src = event.currentTarget.firstElementChild.src;
            var setImageSrc = "";
    ...
    HatchPatternComponent.prototype.onAngleChange = function (event) {
        this.angleInput = event.target.value;
        this.angleEmit.emit({
            angle: this.angleInput
        });
    };
    HatchPatternComponent.prototype.onScaleChange = function (event) {
        this.scaleInput = event.target.value;
        this.scaleEmit.emit({
            scale: this.scaleInput
        });
    };
    HatchPatternComponent.prototype.selectedImageData = function (event, id) {
    ...
    HatchPatternComponent.prototype.GetHatchArray = function () {
        var contextObj = this;
    ...
    ], HatchPatternComponent.prototype, "hatchPatterEmit", void 0);
    __decorate([
        core_1.Output(), 
        __metadata('design:type', Object)
    ], HatchPatternComponent.prototype, "angleEmit", void 0);
    __decorate([
        core_1.Output(), 
        __metadata('design:type', Object)
    ], HatchPatternComponent.prototype, "scaleEmit", void 0);
    HatchPatternComponent = __decorate([
        core_1.Component({
    ...
    ], HatchPatternComponent);
    return HatchPatternComponent;
}());
exports.HatchPatternComponent = HatchPatternComponent;
//# sourceMappingURL=hatchpattern.component.js.map