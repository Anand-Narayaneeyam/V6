...
export class ColorPickerComponent implements OnInit, AfterViewInit {
    ...
    public hiddenDiv: string = "block";
    public setBackgroundColor: string = "#FF0000";
    colorArray0 = new Array<ColorpickerValues>();
    colorArray1 = new Array<ColorpickerValues>();
    colorArray2 = new Array<ColorpickerValues>();
    colorArray3 = new Array<ColorpickerValues>();
    colorArray4 = new Array<ColorpickerValues>();
    colorArray5 = new Array<ColorpickerValues>();
    colorArray6 = new Array<ColorpickerValues>();
    colorArray7 = new Array<ColorpickerValues>();
    colorArray8 = new Array<ColorpickerValues>();
    colorArray9 = new Array<ColorpickerValues>();
    arrColorArray = new Array<ColorpickerValues>();
    blnShowIcon: boolean = true;
    blnPickerExpanded: boolean = false;
    itemSource: any[];
    @Output() colorPickerValueChange = new EventEmitter<ColorPickerProperties>();
    ...
    colorChange() {
        ...
        if (this.fieldObject) {
            if (this.fieldObject.FieldValue == "" || (this.fieldObject.FieldValue == null)) {
                ...
                var autocadColorId;
                var rgbColor;
                var arrColorData = new Array<ColorpickerValues>();
                ...
                if (arrColorData != undefined) {
                    ...
                    for (let i = 0; i < arrColorData.length; i++) {
    ...
    KeyPressColorPickerToggle(Keyevent) {
    ...
    KeyPresscolorOnClick(Keyevent, autocadColorId, rgb, accessColorId) {
        var key = Keyevent.keyCode || Keyevent.which;
        if (key == 13 || key == 32) {
            Keyevent.preventDefault();
            ...
            if (this.colorArray7[(this.colorArray7.length - 1)].AutocadColorId == autocadColorId) {
                var colorpicker: any = document.getElementById("ColorPickerDiv");                                                 
                if (this.displayStyle == "block") {
                            this.displayStyle = "none";
                            this.hiddenDiv = "none";
                }                                    
    ...
    colorOnClick(autocadColorId, rgb, accessColorId) {
...
export interface ColorPickerProperties {
    AutoCadColorId: string,
    RGBValue: string,
    AccessColorId: string,
    SelectedFieldValue: string,
    ReportFieldId: number
}

export interface ColorpickerValues {
    AccessColorId: number;
    AutocadColorId: number;
    ColorId: number;
    RGB: string;
