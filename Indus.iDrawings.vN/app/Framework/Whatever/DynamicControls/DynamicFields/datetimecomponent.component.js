...
var DateTimeComponent = (function () {
    function DateTimeComponent(renderer) {
        ...
        this.IsCard = false;
        this.datetimepickerOut = new core_1.EventEmitter();
        ...
        if (this.IsCard == true) {
            if (this.fieldObject.FieldValue != undefined) {
                if (this.fieldObject.FieldValue.includes("T")) {
                    ...
                    var strMon = Number(strDate.split("-")[1]);
                    strMon = strMon - 1;
                    ...
                    var dateString = strDay + " " + mon + " " + strYear + " " + strHour + ":" + strMin + " " + meridian;
            ...
            if (this.fieldObject.FieldValue == null || this.fieldObject.FieldValue.toString() == "undefined" || this.fieldObject.FieldValue == "" || this.fieldObject.FieldValue == undefined) {
                if (this.fieldObject.IsMandatory == true && this.showDateTimeOnLoad != false) {
    ...
    DateTimeComponent.prototype.ngAfterViewChecked = function () {
        //if (this.fieldObject.FieldValue != undefined) {
    ...
    DateTimeComponent.prototype.onchange = function () {
    };
    DateTimeComponent.prototype.getKeyPress = function (event) {
        debugger;
    ...
    DateTimeComponent.prototype.handleKeyboardEvents = function (e) {
        if (!e)
            e = window.event;
    ...
    DateTimeComponent.prototype.toggleMode = function () {
    ...
    DateTimeComponent.prototype.datetimepickertoggle = function () {
    ...
    DateTimeComponent.prototype.getBlurEvent = function (event) {
    ...
    DateTimeComponent.prototype.getSelectedValue = function (dt) {
        this.selectedDateValue = this.getformattedDataTimeonSelection(dt);
        this.fieldObject.FieldValue = this.selectedDateValue;
        this.datetimepickerOut.emit({
    ...
    DateTimeComponent.prototype.getChangedVal = function (event) {
        console.log(event);
    };
    DateTimeComponent.prototype.getformattedDataTime = function (dt) {
        var strDate = "";
        var date;
        var time;
        var hh;
    ...
    DateTimeComponent.prototype.getformattedDataTimeonSelection = function (dt) {
        var strDate = "";
        var date;
        var time;
        var hh;
    ...
    ], DateTimeComponent.prototype, "readonlymode", void 0);
    __decorate([
        core_1.Input(), 
        __metadata('design:type', Number)
    ], DateTimeComponent.prototype, "labelwidth", void 0);
    __decorate([
        core_1.Input(), 
        __metadata('design:type', String)
    ], DateTimeComponent.prototype, "SetAlignment", void 0);
    __decorate([
        core_1.Input(), 
        __metadata('design:type', Object)
    ], DateTimeComponent.prototype, "validationData", void 0);
    __decorate([
        core_1.Input(), 
        __metadata('design:type', Boolean)
    ], DateTimeComponent.prototype, "showDateTimeOnLoad", void 0);
    __decorate([
        /*set input true if current date time value should be shown on page load*/ core_1.Input(), 
        __metadata('design:type', Boolean)
    ], DateTimeComponent.prototype, "IsCard", void 0);
    __decorate([
        core_1.Output(), 
        __metadata('design:type', Object)
    ], DateTimeComponent.prototype, "datetimepickerOut", void 0);
    __decorate([
    ...
    DateTimeComponent = __decorate([
        core_1.Component({
            selector: 'DateTimeComponent',
            templateUrl: 'app/Framework/Views/DynamicControls/DynamicFields/datetimecomponent.component.html',
            inputs: ['fieldObject'],
