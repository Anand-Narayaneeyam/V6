...
require("../../../../Scripts/create-symbol-script.js");
var CreateSymbolComponent = (function () {
    function CreateSymbolComponent(_notificationService, _objectsService) {
        this._notificationService = _notificationService;
        this._objectsService = _objectsService;
        this.objiWizCreateSymbolApi = new iWhizAPI();
        this.objectCategoryId = 0;
        this.isMenuCard = true;
        this.sheetWidth = 70;
        this.sheetHeight = 30;
        this.gridScale = 2;
        this.delimiter = new General_1.Delimeter();
        this.userId = 0;
        this.handleGridEntity = "";
        this.disableInputHW = false;
        this.arrLineCordiantes = [];
        this.symbolLinePoints = "";
        this.layerSymbolPolyLineName = "";
        this.enableMenu = [];
        this.lineCordsArryLength = 0;
        this.isSnapEnabled = false;
        this.symbolText = "";
        this.symbolSaveName = "";
        this.symbolTextSize = 2;
        this.symbolSlidePosition = "top-right";
        this.showSymbolSlide = false;
        this.arrReportFieldIdValues = [];
        this.arrGetReportFieldIdValues = [];
        this.arrGetSymbolReportFieldIdValues = [];
        this.symbolSaveString = "";
        this.delimiterSymbolAddColumn = ",";
        this.delimiterSymbolAddRow = ";";
        this.delimiterSymbolColumn = this.delimiter.ColumnDelimeter;
        this.delimiterSymbolRow = this.delimiter.RowDelimeter;
        this.blnLoadSavedSymbol = true;
        this.selectedSymbolId = -1;
        this.blnDisableSymbolDropdown = false;
        this.blnSymbolPrinted = false;
        this.strEnableMenuItems = "";
        this.blnIsMenuSetToString = false;
        this.messageSliderText = "";
        this.messageSliderTarget = 0;
        this.menuData = [{ "id": 1,
                "title": "Delete Symbol",
                "image": "Delete",
                "path": "DeleteSymbol",
        ...
        this.totalItems = this.menuData.length;
    }
    CreateSymbolComponent.prototype.ngAfterViewInit = function () {
        ...
        setTimeout(function () {
            var canvas = objContext.drawingCanvas.nativeElement;
    ...
    CreateSymbolComponent.prototype.ngOnDestroy = function () {
        var contextObj = this;
    ...
    CreateSymbolComponent.prototype.onBeforeunload = function (event) {
        var contextObj = this;
        this.objiWizCreateSymbolApi.close(function (returnCode) {
            contextObj.objiWizCreateSymbolApi = null;
        });
    };
    CreateSymbolComponent.prototype.ngOnInit = function () {
        var objContext = this;
        objContext.getSymbolControldata();
        objContext.getSymbolDropdownData();
    };
    CreateSymbolComponent.prototype.onSubMenuChange = function (event) {
        var objContext = this;
        switch (event.value) {
            case 1:
                //objContext.enableMenu = [2];
    ...
    CreateSymbolComponent.prototype.createSymbolSheet = function () {
        var objContext = this;
    ...
    CreateSymbolComponent.prototype.drawLineOnClick = function () {
        var objContext = this;
    ...
    CreateSymbolComponent.prototype.printTextOnsymbol = function () {
        var objContext = this;
        ...
        if (objContext.symbolTextSize) {
            ...
            if (objContext.symbolText.trim().length == 0) {
                ...
                objContext.objiWizCreateSymbolApi.getEntityMidpoint(objContext.handlecloseSymbolLine, function (resultxj, midX, midY) {
                    objContext.objiWizCreateSymbolApi.createMultilineText(objContext.layerSymbolPolyLineName, 3, midX, midY, 0, objContext.symbolTextSize, 0, 1, objContext.symbolText, "", 5, function (resultxk) {
                        //alert(resultxk);
                    });
                });
            }
    ...
    CreateSymbolComponent.prototype.closeSymbolLine = function () {
        var ratio = [0];
        var objContext = this;
        objContext.symbolLinePoints = "";
        objContext.layerSymbolPolyLineName = "symbolPolylineLayer";
        objContext.arrLineCordiantes.forEach(function (element) {
    ...
    CreateSymbolComponent.prototype.crateSheetGrid = function () {
        var objContext = this;
        ...
        objContext.gridScale = objContext.getCustomFieldValue(2950);
        if (objContext.handleGridEntity != "" && objContext.gridScale > 0) {
    ...
    CreateSymbolComponent.prototype.setGridVisibility = function (isVisible) {
        var objContext = this;
    ...
    CreateSymbolComponent.prototype.undoLineInSymbol = function () {
        var objContext = this;
    ...
    CreateSymbolComponent.prototype.deleteSheetLayers = function (resCallback) {
        var objContext = this;
        objContext.objiWizCreateSymbolApi.exitWaitMode();
        objContext.objiWizCreateSymbolApi.enableRubberband(0, 0, 0, false);
        objContext.enableMenu = [2];
    ...
    CreateSymbolComponent.prototype.saveObjectSymbol = function () {
        var objContext = this;
        for (var p = 0; p < objContext.arrObjectSymbolData.length; p++) {
    ...
    CreateSymbolComponent.prototype.getSymbolDropdownData = function () {
        var objContext = this;
    ...
    CreateSymbolComponent.prototype.Defaultfocus = function () {
        setTimeout(function () {
            var SymbolNameElement = document.getElementById("2941");
    ...
    CreateSymbolComponent.prototype.showSelectedSymbol = function () {
        var loading_indicator = document.getElementById('loading-indicator');
        loading_indicator.style.display = "block";
        var objContext = this, xcord, ycord;
        ;
        objContext.layerSheetName = "symbolSheetLayer";
        objContext.sheetHeight = objContext.getCustomFieldValue(2948);
        objContext.sheetWidth = objContext.getCustomFieldValue(2949);
                    ...
                    objContext.objiWizCreateSymbolApi.createPolyline(objContext.layerSymbolPolyLineName, 3, objContext.symbolSaveString, 0, "", 1, true, function (resultxe, entityPloyLineHandle) {
                        if (resultxe == 0) {
                            ...
                            objContext.objiWizCreateSymbolApi.moveEntity(entityPloyLineHandle, xcord, ycord, function (retCode) {
                                if (retCode == 0) {
                                    objContext.objiWizCreateSymbolApi.createMultilineText(objContext.layerSymbolPolyLineName, 3, xcord, ycord, 0, objContext.symbolTextSize, 0, 1, objContext.symbolText, "", 5, function (resultxk) {
                                        // var loading_indicator = document.getElementById('loading-indicator');
    ...
    CreateSymbolComponent.prototype.deleteSavedSymbol = function () {
        var objContext = this;
        var dataReturn;
    ...
    CreateSymbolComponent.prototype.removeMenuItem = function (element) {
        var objContext = this;
        if (objContext.enableMenu.lastIndexOf(element) != -1) {
            objContext.enableMenu = objContext.enableMenu.filter(function (e) { return e !== element; });
        }
    };
    CreateSymbolComponent.prototype.addMenuItem = function (element) {
        var objContext = this;
        if (objContext.enableMenu.lastIndexOf(element) == -1) {
            objContext.enableMenu.push(element);
        }
    };
    CreateSymbolComponent.prototype.menuItemExists = function (element) {
        var objContext = this;
        if (objContext.enableMenu.lastIndexOf(element) != -1) {
            return true;
        }
    ...
    CreateSymbolComponent.prototype.previousMenuItemExists = function (element) {
        var objContext = this;
    ...
    CreateSymbolComponent.prototype.removeItem = function (arraySrc, element) {
        //const elementIndex = arraySrc.indexOf(element);
        //arraySrc.splice(elementIndex, 1);
        return arraySrc.filter(function (e) { return e !== element; });
    };
    CreateSymbolComponent.prototype.itemExists = function (arraySrc, element) {
    ...
    CreateSymbolComponent.prototype.getLayerName = function () {
        var objContext = this;
        ...
        /////////to find date and time/////////  
        var layerName = "$" + objContext.userId + "_" + date + "_" + time;
        console.log("layerName", layerName);
        return layerName;
    };
    CreateSymbolComponent.prototype.setMenuItemsToString = function () {
        var objContext = this;
    ...
    CreateSymbolComponent.prototype.getSymbolControldata = function () {
        var objContext = this;
        objContext.arrGetReportFieldIdValues = [];
        objContext.arrGetReportFieldIdValues.push({ FieldId: 2938, ReportFieldId: 672, Value: objContext.objectCategoryId });
    ...
    CreateSymbolComponent.prototype.getSymbolField = function (inputFieldId) {
        var objContext = this;
        var objIfield;
    ...
    CreateSymbolComponent.prototype.getCustomFieldValue = function (fieldId) {
        var objContext = this;
    ...
    CreateSymbolComponent.prototype.setCustomFieldValue = function (fieldId, value) {
        var objContext = this;
        for (var i = 0; i < objContext.arrObjectSymbolData.length; i++) {
    ...
    CreateSymbolComponent.prototype.symbolDropdownChange = function (event) {
        var objContext = this;
    ...
    CreateSymbolComponent.prototype.LoadDefaultValue = function () {
        var objContext = this;
        for (var i = 0; i < objContext.arrObjectSymbolData.length; i++) {
    ...
    CreateSymbolComponent.prototype.LoadSavedSymbol = function (symbolId) {
        var objContext = this;
        var dataReturn;
    ...
    CreateSymbolComponent.prototype.closeSlideDialog = function (value, index) {
        switch (index) {
            case 1:
    ...
    CreateSymbolComponent.prototype.okDeleteSymbol = function (event) {
        var objContext = this;
        var symbolId;
    ...
    CreateSymbolComponent.prototype.cancelClick = function (value) {
        var objContext = this;
        var symbolId;
        switch (objContext.messageSliderTarget) {
            case 1:
    ...
    __decorate([
        core_1.ViewChild('iWhizCreateSymbolCanvas'), 
        __metadata('design:type', core_1.ElementRef)
    ], CreateSymbolComponent.prototype, "drawingCanvas", void 0);
    __decorate([
        core_1.HostListener('window:beforeunload', ['$event']), 
        __metadata('design:type', Function), 
        __metadata('design:paramtypes', [Object]), 
        __metadata('design:returntype', void 0)
    ], CreateSymbolComponent.prototype, "onBeforeunload", null);
    CreateSymbolComponent = __decorate([
        core_1.Component({
            ...
            directives: [submenu_component_1.SubMenu, slide_component_1.SlideComponent, dropdownlistcomponent_component_1.DropDownListComponent, stringtextbox_component_1.StringTextBoxComponent],
            providers: [notify_service_1.NotificationService, objects_service_1.ObjectsService],
            inputs: ['objectCategoryId']
        }), 
        __metadata('design:paramtypes', [notify_service_1.NotificationService, objects_service_1.ObjectsService])
    ], CreateSymbolComponent);
    return CreateSymbolComponent;
}());
exports.CreateSymbolComponent = CreateSymbolComponent;
//# sourceMappingURL=createsymbol.component.js.map