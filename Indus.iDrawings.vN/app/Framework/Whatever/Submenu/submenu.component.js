...
var SubMenu = (function () {
    function SubMenu() {
        this.onSubMenuChange = new core_1.EventEmitter();
        this.status = false;
        this.focused = false;
    }
    SubMenu.prototype.imagePath = function (path) {
        if (path == "Add") {
    ...
    SubMenu.prototype.menuClick = function (obj, value, name) {
        obj.preventDefault();
    ...
    SubMenu.prototype.ngOnInit = function () {
    ...
    SubMenu.prototype.ngAfterViewInit = function () {
        if (this.textOnRightSide != undefined)
            $("#rightSideli").append(this.textOnRightSide);
    };
    SubMenu.prototype.checkDisable = function (menuId, image) {
    ...
    SubMenu.prototype.focusDisable = function (menuId, image) {
        if (this.count == 0 || this.menuCard == true) {
            this.status = true;
            var enableIds = this.menuIds;
            for (var item in enableIds) {
    ...
    SubMenu.prototype.ngOnChanges = function (changes) {
        this.source = this.source;
    };
    SubMenu.prototype.showDropDown = function (e) {
    ...
    SubMenu.prototype.HideDropDown = function (e) {
        if (/msie|Trident/.test(navigator.userAgent)) {
            var parent = e.srcElement.parentElement.parentElement;
        }
        else if (/Firefox/.test(navigator.userAgent)) {
    ...
    SubMenu.prototype.onfocusout = function (a, b, e) {
        setTimeout(function () {
            if (a == 0) {
    ...
    SubMenu.prototype.onfocus = function (e) {
        var RootClass = document.activeElement;
        if (RootClass != null) {
    ...
    SubMenu.prototype.onfocusin = function (a, e) {
        if (a == 0)
            e.srcElement.parentElement.parentElement.previousElementSibling.tabIndex = "-1";
    };
    SubMenu.prototype.onSubmenukeypress = function (obj, value, name) {
        this.menuClick(obj, value, name);
    };
    __decorate([
        core_1.Input(), 
        __metadata('design:type', Object)
    ], SubMenu.prototype, "count", void 0);
    __decorate([
        core_1.Input(), 
        __metadata('design:type', Array)
    ], SubMenu.prototype, "menuIds", void 0);
    __decorate([
        core_1.Input(), 
        __metadata('design:type', Object)
    ], SubMenu.prototype, "menuCard", void 0);
    __decorate([
        core_1.Input(), 
        __metadata('design:type', Array)
    ], SubMenu.prototype, "selectedId", void 0);
    __decorate([
        core_1.Input(), 
        __metadata('design:type', Boolean)
    ], SubMenu.prototype, "isVertical", void 0);
    __decorate([
        core_1.Input(), 
        __metadata('design:type', Object)
    ], SubMenu.prototype, "source", void 0);
    __decorate([
        core_1.Input(), 
        __metadata('design:type', String)
    ], SubMenu.prototype, "textOnRightSide", void 0);
    __decorate([
        core_1.Output(), 
        __metadata('design:type', Object)
    ], SubMenu.prototype, "onSubMenuChange", void 0);
    SubMenu = __decorate([
        core_1.Component({
            selector: 'sub-menu',
