...
import { HatchPatternComponent } from '../../Whatever/DynamicControls/DynamicFields/hatchpattern.component';
...
@Component({
    ...
    directives: [Notification, LabelComponent, ColorPickerComponent, HatchPatternComponent],
