...
var hatchpattern_component_1 = require('../../Whatever/DynamicControls/DynamicFields/hatchpattern.component');
var General_1 = require('../../../Models/Common/General');
var administration_service_1 = require('../../../Models/Administration/administration.service');
var TableComponent = (function () {
    function TableComponent(genaralFun, administrationService) {
    ...
    ;
    TableComponent.prototype.widthOfHeader = function (value) {
        if (value.IsEnabled == true)
            return 200;
        else
            return 0;
    };
    TableComponent.prototype.displayOfHeader = function (value) {
        if (value.IsEnabled == true)
            return "";
        else
            return "none";
    };
    TableComponent.prototype.updateField = function (fldObj, Value) {
        fldObj.FieldValue = Value[fldObj.FieldLabel.trim()];
        fldObj.IsMandatory = false;
        return fldObj;
    };
    TableComponent.prototype.onChangeInput = function (e, value, fieldName) {
    ...
    TableComponent.prototype.update = function () {
        ...
        this.Updatetable.emit({
            ReportFieldIdValues: this.output
        });
    };
    TableComponent.prototype.getMultipleFieldValuesAsReportFieldArray = function (fieldObject, DataKey) {
    ...
    TableComponent.prototype.getColorDataArray = function () {
        var contextObj = this;
    ...
    ], TableComponent.prototype, "fieldObject", void 0);
    __decorate([
        core_1.Input(), 
        __metadata('design:type', Object)
    ], TableComponent.prototype, "itemSource", void 0);
    __decorate([
        core_1.Input(), 
        __metadata('design:type', Object)
    ...
    __decorate([
        core_1.Output(), 
        __metadata('design:type', Object)
    ], TableComponent.prototype, "Updatetable", void 0);
    TableComponent = __decorate([
        core_1.Component({
            selector: 'table',
            templateUrl: 'app/Framework/Views/Table/table.component.html',
            styleUrls: ['app/Framework/Views/Table/table.css'],
            directives: [notify_component_1.Notification, labelcomponent_component_1.LabelComponent, colorpickercomponent_component_1.ColorPickerComponent, hatchpattern_component_1.HatchPatternComponent],
            providers: [notify_service_1.NotificationService, General_1.GeneralFunctions, administration_service_1.AdministrationService],
            inputs: ['fields', 'fieldData', 'disableButton'],
        }), 
