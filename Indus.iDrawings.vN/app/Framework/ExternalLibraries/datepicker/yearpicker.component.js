...
var YearPickerComponent = (function () {
    ...
    YearPickerComponent.prototype.changeFocus = function (e) {
        debugger
        var activeElement = $(document.activeElement).closest("tbody td")[0].children[0].children[0].innerText;
        var x = $(document.activeElement).closest("tbody")[0];
        var LastDayOfCalendarId = x.children[3].children[4].children[0].children[0].innerText;
        var dateTimeBack = $(document.activeElement).closest("table")[0].children[0].children[0].children[0].children[0];
        
        if (activeElement == LastDayOfCalendarId) {
