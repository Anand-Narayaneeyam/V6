...
@Injectable()
export class ConfirmToasterService {
    addToast: Observable<Toast>;
    private _addToast: Observer<Toast>;


    clearToasts: Observable<IConfirmClearWrapper>;
    private _clearToasts: Observer<IConfirmClearWrapper>;
...
19      */
    constructor() {
        ...
        this.clearToasts = new Observable<IConfirmClearWrapper>(observer => this._clearToasts = observer).share();
...
74      */
    clear(toastId?: string, toastContainerId?: number) {
        ...
        let clearWrapper: IConfirmClearWrapper = {
...
export interface IConfirmClearWrapper {
    toastId?: string;
