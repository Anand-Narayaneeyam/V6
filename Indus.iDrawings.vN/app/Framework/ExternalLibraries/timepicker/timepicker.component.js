...
function addSeconds(date, seconds) {
    var dt = new Date(date.getTime() + seconds * 60000);
    var newDate = new Date(date);
    newDate.setSeconds(dt.getHours(), dt.getMinutes(),dt.getSeconds());
    return newDate;
}
var TimepickerComponent = (function () {
    ...
    TimepickerComponent.prototype.updateHours = function () {
        ...
        var seconds = this.getSecondsFromTemplate();
    ...
    TimepickerComponent.prototype.detectArrowKey = function (id, e) {
    ...
    TimepickerComponent.prototype.updateSeconds = function () {
        if (this.readonlyInput) {
            return;
        }
        var minutes = this.getMinutesFromTemplate();
        ...
        this.invalidMinutes = !isDefined(minutes);
        this.invalidHours = !isDefined(hours);
        this.invalidSeconds = !isDefined(seconds);
        if (this.invalidMinutes || this.invalidHours || this.invalidSeconds) {
            // TODO: needed a validation functionality.
            return;
        }
        //this.selected.setMinutes(minutes);
        this.selected.setSeconds(seconds);
        this.invalidSeconds = (this.selected < this.min || this.selected > this.max);
        if (this.invalidSeconds) {
            // todo: validation
            // invalidate(undefined, true);
            return;
        }
    ...
    TimepickerComponent.prototype.secondsOnBlur = function () {
        if (this.readonlyInput) {
            return;
        }
        if (!this.invalidSeconds && parseInt(this.seconds, 10) < 10) {
    ...
    TimepickerComponent.prototype.changeFocus = function (e) {
        debugger
        
        if (e.keyCode == 9 && document.activeElement)
        {
            var getFocusElement = $(document.activeElement).closest("#dateTimeContainerDiv")[0].querySelectorAll("datepicker table")[0].children[0].children[0].children[0].children[0];
    ...
    TimepickerComponent.prototype.getMinutesFromTemplate = function () {
     ...
     TimepickerComponent.prototype.getSecondsFromTemplate = function () {
        var seconds = parseInt(this.seconds, 10);
    ...
    TimepickerComponent.prototype.noDecrementSeconds = function () {
        var decrementedSelected = addSeconds(this.selected, -this.minuteStep);
        return decrementedSelected < this.min ||
            (decrementedSelected > this.selected && decrementedSelected > this.max);
    };
    ...
    TimepickerComponent = __decorate([
        core_1.Component({
            ...
            template: "\n<table>\n <tbody>\n  <tr class=\"text-center\" [ngClass]=\"{hidden: !showSpinners}\">\n  <td><a autofocus tabindex=\"0\" (click)=\"incrementHours()\" aria-label=\"Press Enter Key to Increment Hours\" (keydown)=\"detectArrowKey(1,$event)\" [ngClass]=\"{disabled: noIncrementHours()}\" class=\"btn btn-link\"><span><img src=\"./Content/Images/chevron-arrow-up.png\"  height=\"10\" width=\"10\"></span></a></td>\n   <td>&nbsp;</td>\n  <td><a tabindex=\"0\" (click)=\"incrementMinutes()\" aria-label=\"Press Enter Key to Increment Minutes\"  (keydown)=\"detectArrowKey(2,$event)\" [ngClass]=\"{disabled: noIncrementMinutes()}\" class=\"btn btn-link\"><span><img src=\"./Content/Images/chevron-arrow-up.png\" height=\"10\" width=\"10\"></span></a></td>\n  <td [ngClass]=\"{hidden: !showMeridian}\" *ngIf=\"showMeridian\"></td>\n  </tr>\n  <tr>\n  <td class=\"form-group\" [ngClass]=\"{'has-error': invalidHours}\">\n  <input style=\"width:50px;\" type=\"text\" [(ngModel)]=\"hours\" (change)=\"updateHours()\" class=\"form-control text-center\" [readonly]=\"readonlyInput\" (blur)=\"hoursOnBlur($event)\" maxlength=\"2\">\n  </td>\n <td>:</td>\n <td class=\"form-group\" [ngClass]=\"{'has-error': invalidMinutes}\">\n <input style=\"width:50px;\" type=\"text\" [(ngModel)]=\"minutes\" (change)=\"updateMinutes()\" class=\"form-control text-center\" [readonly]=\"readonlyInput\" (blur)=\"minutesOnBlur($event)\" maxlength=\"2\">\n  </td>\n  <td [ngClass]=\"{hidden: !showMeridian}\" *ngIf=\"showMeridian\"><button type=\"button\" tabindex=\"0\" [ngClass]=\"{disabled: noToggleMeridian()}\" class=\"btn btn-default text-center\"  (click)=\"toggleMeridian()\" aria-label=\"Press Enter Key to Change Meridian\">{{meridian}}</button></td>\n </tr>\n <tr class=\"text-center\" [ngClass]=\"{hidden: !showSpinners}\">\n <td><a tabindex=\"0\" (click)=\"decrementHours()\" aria-label=\"Press Enter Key to Decrement Hours\"  (keydown)=\"detectArrowKey(3,$event)\" [ngClass]=\"{disabled: noDecrementHours()}\" class=\"btn btn-link\"><span><img src=\"./Content/Images/chevron-arrow-down.png\"  height=\"10\" width=\"10\"></span></a></td>\n  <td>&nbsp;</td>\n <td><a tabindex=\"0\" (click)=\"decrementMinutes()\" aria-label=\"Press Enter Key to Increment Minutes\" (keydown)=\"changeFocus($event)\" (keydown)=\"detectArrowKey(4,$event)\" [ngClass]=\"{disabled: noDecrementMinutes()}\" class=\"btn btn-link\"><span><img src=\"./Content/Images/chevron-arrow-down.png\" height=\"10\" width=\"10\"></span></a></td>\n  <td [ngClass]=\"{hidden: !showMeridian}\" *ngIf=\"showMeridian\"></td>\n </tr>\n </tbody>\n </table>\n  "
        }),
