...
var DashBoardHelpComponent = (function () {
    ...
    DashBoardHelpComponent.prototype.ngOnInit = function () {
        var objContext = this;
        objContext.pagePath = "Help / Administration / Dash Board";
    };
    DashBoardHelpComponent.prototype.onSectionExpandChange = function (obj) {
    ...
    DashBoardHelpComponent = __decorate([
        core_1.Component({
            selector: 'admDashBoard-Help',
            templateUrl: './app/Views/Help/Administration/adm-dash-board.html',
...
exports.DashBoardHelpComponent = DashBoardHelpComponent;
//# sourceMappingURL=adm-dash-board.js.map