...
var SpacesGeneralSettingsHelpComponent = (function () {
    function SpacesGeneralSettingsHelpComponent() {
    ...
    SpacesGeneralSettingsHelpComponent.prototype.ngOnInit = function () {
        var objContext = this;
        objContext.pagePath = "Help / Space / General Settings";
    };
    SpacesGeneralSettingsHelpComponent.prototype.onSectionExpandChange = function (obj) {
    ...
    ;
    SpacesGeneralSettingsHelpComponent = __decorate([
        core_1.Component({
    ...
    ], SpacesGeneralSettingsHelpComponent);
    return SpacesGeneralSettingsHelpComponent;
}());
exports.SpacesGeneralSettingsHelpComponent = SpacesGeneralSettingsHelpComponent;
//# sourceMappingURL=space-general-settings.js.map