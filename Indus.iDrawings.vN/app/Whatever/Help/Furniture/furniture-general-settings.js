...
var FurnitureGeneralSettingsHelpComponent = (function () {
    function FurnitureGeneralSettingsHelpComponent() {
    ...
    FurnitureGeneralSettingsHelpComponent.prototype.ngOnInit = function () {
        var objContext = this;
        objContext.pagePath = "Help / Furniture / General Settings";
    };
    FurnitureGeneralSettingsHelpComponent.prototype.onSectionExpandChange = function (obj) {
    ...
    ;
    FurnitureGeneralSettingsHelpComponent = __decorate([
        core_1.Component({
    ...
    ], FurnitureGeneralSettingsHelpComponent);
    return FurnitureGeneralSettingsHelpComponent;
}());
exports.FurnitureGeneralSettingsHelpComponent = FurnitureGeneralSettingsHelpComponent;
//# sourceMappingURL=furniture-general-settings.js.map