...
var DocumentsforDocumentGroupsMainListComponent = (function () {
    function DocumentsforDocumentGroupsMainListComponent(administrationService, notificationService, getData, documentService) {
    ...
    DocumentsforDocumentGroupsMainListComponent.prototype.ngAfterViewInit = function () {
        var contextObj = this;
    ...
    DocumentsforDocumentGroupsMainListComponent.prototype.getDocumentGroupMainListData = function () {
        var contextObj = this;
    ...
    DocumentsforDocumentGroupsMainListComponent.prototype.insertDocumentList = function (event) {
        var contextObj = this;
        var selectedRowIds = "";
    ...
    DocumentsforDocumentGroupsMainListComponent.prototype.onSort = function (objGrid) {
        var contextObj = this;
        this.inputItems.sortCol = objGrid.sortCol;
        this.inputItems.sortDir = objGrid.sortDir;
        this.getDocumentGroupMainListData();
    };
    DocumentsforDocumentGroupsMainListComponent.prototype.pageChanged = function (event) {
        var contextObj = this;
    ...
    ], DocumentsforDocumentGroupsMainListComponent.prototype, "submitSuccess", void 0);
    DocumentsforDocumentGroupsMainListComponent = __decorate([
        core_1.Component({
    ...
    ], DocumentsforDocumentGroupsMainListComponent);
    return DocumentsforDocumentGroupsMainListComponent;
}());
exports.DocumentsforDocumentGroupsMainListComponent = DocumentsforDocumentGroupsMainListComponent;
//# sourceMappingURL=document-group-documents-mainList.js.map