...
var NotesAddEditComponent = (function () {
    function NotesAddEditComponent(projService, notificationService) {
        this.projService = projService;
        this.notificationService = notificationService;
        this.submitSuccess = new core_1.EventEmitter();
    }
    NotesAddEditComponent.prototype.ngOnInit = function () {
        debugger;
    };
    NotesAddEditComponent.prototype.onSubmitData = function (event) {
        var context = this;
    ...
    ], NotesAddEditComponent.prototype, "submitSuccess", void 0);
    NotesAddEditComponent = __decorate([
        core_1.Component({
    ...
    return NotesAddEditComponent;
}());
exports.NotesAddEditComponent = NotesAddEditComponent;
//# sourceMappingURL=notes-addedit.js.map