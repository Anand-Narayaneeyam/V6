...
var AllEmployeeAddEditComponent = (function () {
    function AllEmployeeAddEditComponent(employeeService, _validateService, _notificationService, administrationService, generFun) {
    ...
    AllEmployeeAddEditComponent.prototype.ngOnInit = function () {
        var contextObj = this;
    ...
    AllEmployeeAddEditComponent.prototype.Update = function (event) {
        var contextObj = this;
    ...
    AllEmployeeAddEditComponent.prototype.Add = function (event) {
        //  debugger
        var contextObj = this;
        if (event["filedata"] != undefined) {
    ...
    AllEmployeeAddEditComponent.prototype.SubmitEvent = function (event) {
    ...
    AllEmployeeAddEditComponent.prototype.editFileDetails = function (fieldobject, filedata) {
    ...
    AllEmployeeAddEditComponent.prototype.onSubmitData = function (event) {
        var contextObj = this;
    ...
    AllEmployeeAddEditComponent.prototype.getCusSubscribedFeatures = function () {
        var contextObj = this;
    ...
    AllEmployeeAddEditComponent.prototype.ngOnChanges = function (changes) {
        var contextObj = this;
    ...
    AllEmployeeAddEditComponent.prototype.getDateChange = function (event) {
    };
    AllEmployeeAddEditComponent.prototype.fieldChange = function (event) {
        var contextObj = this;
    ...
    ], AllEmployeeAddEditComponent.prototype, "submitSuccess", void 0);
    AllEmployeeAddEditComponent = __decorate([
        core_1.Component({
    ...
    ], AllEmployeeAddEditComponent);
    return AllEmployeeAddEditComponent;
}());
exports.AllEmployeeAddEditComponent = AllEmployeeAddEditComponent;
//# sourceMappingURL=allemployeeaddedit.js.map