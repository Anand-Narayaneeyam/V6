...
export class UnassignedEmployeeAddEditComponent {
                ...
                for (let i = 0; i < contextObj.fieldDetailsSpaceEdit.length; i++) {
                    if (contextObj.fieldDetailsSpaceEdit[i]["FieldId"] == 453) {
                        ...
                        if (contextObj.fieldDetailsSpaceEdit[i].FieldValue != "1") {
                            ...
                            //debugger
                            //  setTimeout(function () {
                            //      contextObj._validateService.initiateValidation(contextObj.fieldDetailsSpaceEdit[i], contextObj, true, relievinginfo);
                            //  }, 100);
                        }
                        // break;
                    }
