...
import {GradeTrendAnalysisChartview } from './gradeTrendAnalysis-chartview';
...
@Component({
    ...
    directives: [SubMenu, TabComponent, TabsComponent, PageComponent, DateComponent, Notification, ListBoxComponent, GradeTrendAnalysisChartview, SplitViewComponent, StringTextBoxComponent],
    providers: [NotificationService, EmployeeService, ValidateService],
})

export class GradeTrendAnalysisComponent implements OnInit {
    ...
    pagePath: any = "Employees / Occupancy by Grade over Time";
