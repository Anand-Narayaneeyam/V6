...
var rateofHiringbyTime_chartView_1 = require('./rateofHiringbyTime-chartView');
...
var employeeTrendAnalysisRateofHiringbyTime = (function () {
    function employeeTrendAnalysisRateofHiringbyTime(notificationService, employeeService, _validateService, spaceService) {
        var _this = this;
    ...
    employeeTrendAnalysisRateofHiringbyTime.prototype.ngOnInit = function () {
        this.menuData = [
            {
                "id": 0,
                "title": "Show Trend",
    ...
    employeeTrendAnalysisRateofHiringbyTime.prototype.onSubMenuChange = function (event) {
        if (event.value == 0) {
            this.forecastFlag = false;
            this.showTrend();
        }
    ...
    employeeTrendAnalysisRateofHiringbyTime.prototype.showTrend = function () {
        var contexObj = this;
    ...
    employeeTrendAnalysisRateofHiringbyTime.prototype.foreCasting = function () {
        if (this.ddlLevel1.FieldValue == "-1")
            this.notificationService.ShowToaster('Select a ' + this.ddlLevel1.FieldLabel, 2);
        else {
    ...
    //}
    employeeTrendAnalysisRateofHiringbyTime.prototype.onChangeDdlLevel1 = function (event, fieldValue) {
        var contextObj = this;
    ...
    employeeTrendAnalysisRateofHiringbyTime.prototype.onChangeDdlLevel2 = function (event, fieldValue) {
        var contextObj = this;
    ...
    employeeTrendAnalysisRateofHiringbyTime.prototype.onChangeDdlLevel3 = function (event, fieldValue) {
        var contextObj = this;
    ...
    employeeTrendAnalysisRateofHiringbyTime.prototype.onChangeDdlLevel4 = function (event, fieldValue) {
        var contextObj = this;
    ...
    employeeTrendAnalysisRateofHiringbyTime.prototype.onChangeDdlLevel5 = function (event, fieldValue) {
        var contextObj = this;
        if (Number(event) > 0) {
            this.OrgUnitId = event;
        }
    ...
    //    }
    //}
    employeeTrendAnalysisRateofHiringbyTime.prototype.onSubmitData = function (event) {
    };
    employeeTrendAnalysisRateofHiringbyTime.prototype.getSelectedTab = function (event) {
    ...
    employeeTrendAnalysisRateofHiringbyTime.prototype.onTabClose = function (event) {
        this.isNextClicked = false;
        this.selectedTab = event[0];
    };
    employeeTrendAnalysisRateofHiringbyTime.prototype.okSubmit = function (event) {
    ...
    ], employeeTrendAnalysisRateofHiringbyTime.prototype, "onSubmitClick", void 0);
    employeeTrendAnalysisRateofHiringbyTime = __decorate([
        core_1.Component({
    ...
    ], employeeTrendAnalysisRateofHiringbyTime);
    return employeeTrendAnalysisRateofHiringbyTime;
}());
exports.employeeTrendAnalysisRateofHiringbyTime = employeeTrendAnalysisRateofHiringbyTime;
//# sourceMappingURL=rateofHiringbyTime-component.js.map