...
var spacestandardtrendanalysis_chartview_1 = require('./spacestandardtrendanalysis-chartview');
...
var SpaceStandardTrendAnalysisComponent = (function () {
    ...
    //}
    function SpaceStandardTrendAnalysisComponent(notificationService, empservice, _validateService) {
        var _this = this;
        ...
        this.tabname = "Trend";
        this.pagePath = "Employees / Seating Capacities by Space Standard over Time";
        this._validateService.getBlacklist().subscribe(function (resultData) { return _this.validationData = resultData; });
    }
    SpaceStandardTrendAnalysisComponent.prototype.ngOnInit = function () {
        this.menuData = [
            {
                "id": 0,
                "title": "Show Trend",
    ...
    SpaceStandardTrendAnalysisComponent.prototype.getListBoxData = function (event) {
    ...
    SpaceStandardTrendAnalysisComponent.prototype.onSubMenuChange = function (event) {
    ...
    SpaceStandardTrendAnalysisComponent.prototype.showTrend = function () {
        var contextObj = this;
    ...
    SpaceStandardTrendAnalysisComponent.prototype.showForecast = function () {
        if (this.ListboxData.MultiFieldValues == null || this.ListboxData.MultiFieldValues.length == 0) {
            this.notificationService.ShowToaster("Select a Space Standard", 2);
        }
        else {
    ...
    SpaceStandardTrendAnalysisComponent.prototype.onSubmitData = function (event) {
    };
    SpaceStandardTrendAnalysisComponent.prototype.getSelectedTab = function (event) {
        this.selectedTab = event[0];
    };
    SpaceStandardTrendAnalysisComponent.prototype.okSubmit = function (event) {
    ...
    SpaceStandardTrendAnalysisComponent = __decorate([
        core_1.Component({
            ...
            directives: [submenu_component_1.SubMenu, tab_component_1.TabComponent, tabs_component_1.TabsComponent, page_component_1.PageComponent, datecomponent_component_1.DateComponent, notify_component_1.Notification, listboxcomponent_component_1.ListBoxComponent, spacestandardtrendanalysis_chartview_1.SpaceStandardTrendAnalysisChartview, split_view_component_1.SplitViewComponent, stringtextbox_component_1.StringTextBoxComponent],
    ...
    ], SpaceStandardTrendAnalysisComponent);
    return SpaceStandardTrendAnalysisComponent;
}());
exports.SpaceStandardTrendAnalysisComponent = SpaceStandardTrendAnalysisComponent;
//# sourceMappingURL=spaceStandardTrendAnalysis.component.js.map