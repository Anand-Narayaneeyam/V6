...
import { employeeTrendAnalysisDivisionWiseSeatingCapacitybyTimeChartView } from './seatingCapacitybyTime-chartView';
...
@Component({
    ...
    directives: [Notification, PageComponent, TabsComponent, TabComponent, DateComponent, SubMenu, employeeTrendAnalysisDivisionWiseSeatingCapacitybyTimeChartView, DropDownListComponent, FieldComponent, SplitViewComponent, StringTextBoxComponent]
})

export class employeeTrendAnalysisDivisionWiseSeatingCapacitybyTime implements OnInit {
