...
var divisionWiseSeatingCapacitybyTime_chartView_1 = require('./divisionWiseSeatingCapacitybyTime-chartView');
...
var employeeTrendAnalysisDivisionWiseSeatingCapacitybyTime = (function () {
    function employeeTrendAnalysisDivisionWiseSeatingCapacitybyTime(commonreportservice, notificationService, realPropertyService, employeeService, _validateService, spaceService) {
        var _this = this;
    ...
    employeeTrendAnalysisDivisionWiseSeatingCapacitybyTime.prototype.ngOnInit = function () {
        ...
        this.employeeService.loadTrendAnalysisDivisionWiseSeatingCapacitybyTime().subscribe(function (resultData) {
            ...
            contextObj.ddlLevel1 = resultData.Data[2];
            contextObj.ddlLevel2 = resultData.Data[3];
            contextObj.ddlLevel3 = resultData.Data[4];
            contextObj.ddlLevel4 = resultData.Data[5];
            contextObj.ddlLevel5 = resultData.Data[6];
    ...
    employeeTrendAnalysisDivisionWiseSeatingCapacitybyTime = __decorate([
        core_1.Component({
            ...
            templateUrl: './app/Views/Employee/TrendAnalysis/DivisionWiseSeatingCapacitybyTime/divisionWiseSeatingCapacitybyTime-component.html',
            providers: [common_service_1.CommonReportService, notify_service_1.NotificationService, realproperty_service_1.RealPropertyService, employee_services_1.EmployeeService, reportviewercomponent_1.Html5ViewerComponent, space_service_1.SpaceService, validation_service_1.ValidateService],
            directives: [paging_component_1.PagingComponent, notify_component_1.Notification, page_component_1.PageComponent, tabs_component_1.TabsComponent, tab_component_1.TabComponent, datecomponent_component_1.DateComponent, submenu_component_1.SubMenu, divisionWiseSeatingCapacitybyTime_chartView_1.employeeTrendAnalysisDivisionWiseSeatingCapacitybyTimeChartView, dropdownlistcomponent_component_1.DropDownListComponent, fieldGeneration_component_1.FieldComponent, split_view_component_1.SplitViewComponent, stringtextbox_component_1.StringTextBoxComponent]
        }), 
        __metadata('design:paramtypes', [common_service_1.CommonReportService, notify_service_1.NotificationService, realproperty_service_1.RealPropertyService, employee_services_1.EmployeeService, validation_service_1.ValidateService, space_service_1.SpaceService])
...
//# sourceMappingURL=divisionWiseSeatingCapacitybyTime-component.js.map