...
var ScenarioOpenDrawing = (function () {
    function ScenarioOpenDrawing(iWhizObject, drawingId, moduleId, extDrwgDetails, http, notificationService) {
        this.iWhizObject = iWhizObject;
        this.isSpace = true;
        this.g_intEmployeeSymbolColor = 70;
        this.g_intScenarioSymbolColor = 31;
        this.movedEmployeeData = [];
        this.scenarioDrwgId = 0;
        this.scenarioId = 0;
        this.initilizeObjects = function (resCallback) {
            ...
            this.empOpenDrwgObj = new employeeopendrawing_services_1.EmployeeOpenDrawing(this.objiWhiz, this.drawingId, this.moduleId, this.http, this.notificationServices);
        ...
        this.getAllScenarioEmpDtls = function () {
            var contextObj = this;
            ...
            contextObj.empDrawingService.getScenarioEmployeeDtls(contextObj.drawingDetails.ScenarioDrawingId, false).subscribe(function (resultData) {
        ...
        this.moveEmployeeToSelectedSpace = function (intEmployeeId, previousXCord, previousYCord, currentXCord, currentYCord, selectedSymbolhandle, spaceId, resCallback) {
            ...
            tempmovedEmployeeData.push({ "ReportFieldId": 912, "Value": intEmployeeId }, { "ReportFieldId": 913, "Value": contextObj.drawingId }, { "ReportFieldId": 904, "Value": contextObj.scenarioId }, { "ReportFieldId": 2993, "Value": spaceId }, { "ReportFieldId": 915, "Value": currentXCord }, { "ReportFieldId": 916, "Value": currentYCord }, { "ReportFieldId": 917, "Value": true });
        ...
        this.saveEmpScenario = function (resCallback) {
            var context = this;
    ...
    ScenarioOpenDrawing.prototype.moveEmployeeInDrawingOnClick = function (resCallback) {
        var contextObj = this;
    ...
    return ScenarioOpenDrawing;
}());
exports.ScenarioOpenDrawing = ScenarioOpenDrawing;
//# sourceMappingURL=scenarioopendrawing.services.js.map