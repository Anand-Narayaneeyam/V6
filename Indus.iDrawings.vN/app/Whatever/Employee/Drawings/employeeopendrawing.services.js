...
var EmployeeOpenDrawing = (function () {
    // spacehandlearray: DataForDrawing[] = [];
    // moveLegedDetails: any;
    function EmployeeOpenDrawing(iWhizObject, drawingId, moduleId, http, notificationService) {
        this.iWhizObject = iWhizObject;
        this.empCount = 0;
        this.categoryId = 6;
        this.addtlDataFieldCategoryId = 8;
        this.empHandlesData = [];
        this.empTooltipData = [];
        this.dataInDrawingTextHandles = [];
        this.empOccupancyLegendData = [];
        this.empSpStandardCapacityLegendData = [];
        this.employeeMoveDataInputList = [];
        this.moveEmpDataArray = [];
        this.g_dblEmpSymbolLineTypeScale = 1.0;
        this.g_dblScaleFactor = 1;
        this.g_dblTextHeight = 1;
        this.g_dblScenarioScaleFactor = 1.5;
        this.g_strEmpSymbolCords = "-1.25,3.125;-2.5,0.625;-3.75,-1.875;-5,-4.375;-6.25,-6.875;-4.25,-6.875;-2.25,-6.875;0.25,-6.875;2.25,-6.875;4.25,-6.875;6.25,-6.875;1.25,3.125;2.5,4.375;2.5,5.625;1.25,6.875;-1.25,6.875;-2.5,5.625;-2.5,4.375;-1.25,3.125;1.25,3.125;";
        this.g_intEmployeeSymbolColor = 70;
        this.g_intScenarioSymbolColor = 31;
        this.g_intEmpStaticFieldEndIndex = 23; //Photo column included
        this.g_strEmployeeTextLayer = "$EmployeeData";
        this.g_strEmployeeSymbolLayer = "$EmployeeSymbol";
        this.g_dblEmpSymbolLineWidth = 0.0;
        this.g_strEmpSymbolLineType = "ByLayer";
        this.g_intEmpTextStyleId = 1;
        this.g_dblEmpTextAngle = 0;
        this.arrayCount = 0;
        this.dataString = "";
        this.selectedOccupancyName = "";
        this.isSpace = true;
        this.g_blnEmployeeModuleAdmin = true;
        this.hatchHandles = [];
        ...
        this.NewScaleFactor = 0;
        this.NewTextHeight = 0;
        ...
        this.getRelinkEmployeeData = function () {
            var contextObj = this;
        ...
        this.isRelinkemployeeExist = function (rescallback) {
        ...
        this.getAllEmployeeDetails = function () {
            var contextObj = this;
            contextObj.empDrawingService.getAllEmployeeDetails(this.drawingId, this.drawingId, 1).subscribe(function (resultData) {
        ...
        this.getEmpDisplaySettingsData = function () {
            var contextObj = this;
        ...
        this.showDataInDrawing = function (dataChange, resCallback) {
            ...
            switch (dataChange) {
                case 'spaceDispChange':
                    ...
                    break;
                case 'empDispChange':
                    contextObj.empDisplaySettingData = null;
                    contextObj.getEmpDisplaySettingsData();
        ...
        this.getTooltipData = function (Handle, resCallback) {
            var contextObj = this;
            var isSymbolHandle = contextObj.empHandlesData.some(function (el) { return el.SymbolHandle === Handle; });
            if (isSymbolHandle) {
        ...
        this.displayEmployeeDataOnDrawing = function (resCallback) {
            var contextObj = this;
        ...
        this.checkIsXpositionNull = function (empData, resCallback) {
            var xPosNullEmpData = [];
            for (var _i = 0, empData_1 = empData; _i < empData_1.length; _i++) {
                var empDataitem = empData_1[_i];
        ...
        //    }
        //}
        this.createEmployeeDataAndTooltipOnDrawing = function (employeeData, empDispSettingsData, ratio, resCallback) {
            var contextObj = this;
            ...
            for (var i = 0; i < employeeData.length; i++) {
                ...
                if (dblSymbolInsertionX && dblSymbolInsertionY) {
                    ...
                    if (SpHandle) {
                        ...
                        for (var _i = 0, empDispSettingsData_1 = empDispSettingsData; _i < empDispSettingsData_1.length; _i++) {
                            var dispSettingsItem = empDispSettingsData_1[_i];
                            if (dispSettingsItem.ShowinDrawing) {
                                var boldText = dispSettingsItem.IsBold ? "b1" : "b0";
                                var italicText = dispSettingsItem.IsItalic ? "i1" : "i0";
                                var textContent = employeeDataItem[dispSettingsItem.FieldName];
                                if (textContent == "null" || textContent == null)
                                    textContent = "-";
            ...
            debugger;
            contextObj.objiWhiz.createCommonSymbolwithData(itemsForCreateText, contextObj.g_strEmployeeTextLayer, 1, contextObj.g_dblEmpTextAngle, ratio[0] * contextObj.g_dblTextHeight, 0, 1, "Standard", contextObj.g_intEmpTextStyleId, contextObj.g_strEmployeeSymbolLayer, intSymbolColor, contextObj.g_strEmpSymbolCords, contextObj.g_dblEmpSymbolLineWidth, contextObj.g_strEmpSymbolLineType, dblEmpSymbolScale, function (retCode, symbolHandles, textHandles) {
        ...
        //    var Ypos;
        //}
        this.getEmployeeTooltipData = function (symbolHandle, resCallback) {
            var contextObj = this;
            ...
            for (var _i = 0, _a = contextObj.empDisplaySettingData; _i < _a.length; _i++) {
        ...
        this.getOccupiedDistributionMapData = function (DistributionTypeNo, resCallback) {
            var contextObj = this;
                ...
                if (contextObj.dataString != null) {
                    switch (DistributionTypeNo) {
                        case DistributionType.Occupied:
                            contextObj.occupiedArea = contextObj.dataString.split(contextObj.colDelimiter).pop();
                        ...
                        case DistributionType.UnOccupied:
                            contextObj.unOccupiedArea = contextObj.dataString.split(contextObj.colDelimiter).pop();
                        ...
                        case DistributionType.UnderOccupied:
                            contextObj.underOccupiedArea = contextObj.dataString.split(contextObj.colDelimiter).pop();
                        ...
                        case DistributionType.OverOccupied:
                            contextObj.overOccupiedArea = +contextObj.dataString.split(contextObj.colDelimiter).pop();
                        ...
                        case DistributionType.NominalOccupied:
                            contextObj.nominalOccupiedArea = +contextObj.dataString.split(contextObj.colDelimiter).pop();
        ...
        this.hatchEmpOccupancyHandles = function (hatchHandleArray, empOccupancyLegendDataObj, resCallback) {
            var contextObj = this;
            var mapHandles = [];
            var rgbColors = [];
        ...
        //    }
        //}
        this.createEmpOccupancyLegend = function (resCallback) {
            var contextObj = this;
        ...
        this.createDistributionLegend = function (dblLegendStartXCord, dblLegendStartYCord, resCallback) {
            var contextObj = this;
            var dblX = dblLegendStartXCord;
            var dblY = dblLegendStartYCord;
            var HL1StartX = dblX - (8 * contextObj.commonDwgServices.g_dblDwgRatio);
            var HL1StartY = dblY + (4 * contextObj.commonDwgServices.g_dblDwgRatio);
            var strTextHandle = [];
            var intDistRectWidth = contextObj.commonDwgServices.g_intLegendTextSize * 2; //g_intDistRectWidth * g_dblDwgRatio+(g_intLegendTextSize/2)
            //console.log("intDistRectWidth", intDistRectWidth);
            var intDistRectHeight = contextObj.commonDwgServices.g_intLegendTextSize * 2; //g_intDistRectHeight * g_dblDwgRatio+(g_intLegendTextSize/2)
            ...
            contextObj.objiWhiz.createText("$LEGEND", 7, dblX, dblY, contextObj.commonDwgServices.g_intSpaceDataTextAngle, (contextObj.commonDwgServices.g_intLegendTextSize) - (contextObj.commonDwgServices.g_intLegendTextSize * .25), contextObj.commonDwgServices.g_intSpaceDataTextWidth, "Hatch", contextObj.commonDwgServices.g_strTextStyleName, 8, function (retCode, textHandle) {
                if (retCode != 0)
                    ...
                    contextObj.objiWhiz.getEntityExtents(textHandle, function (retCode, MinX, MinY, MaxX, MaxY) {
                        if (retCode != 0) {
                            ...
                            contextObj.objiWhiz.createText("$LEGEND", 7, dblX, MinY - (1 * contextObj.commonDwgServices.g_dblDwgRatio), contextObj.commonDwgServices.g_intSpaceDataTextAngle, (contextObj.commonDwgServices.g_intLegendTextSize) - (contextObj.commonDwgServices.g_intLegendTextSize * .25), contextObj.commonDwgServices.g_intSpaceDataTextWidth, "Pattern", contextObj.commonDwgServices.g_strTextStyleName, 2, function (retCode, textHandle2) {
                                contextObj.objiWhiz.setApplicationLayer("$Hatch");
                                if (retCode != 0)
                                    console.log("createText returned with error code : ", retCode);
                                else {
                                    ...
                                    contextObj.getDistributionByName(dblX, intDistRectHeight, dblY, TextMaxX, HL2StartY, intDistRectWidth, HL1StartX, VL2StartX, function (returnCode, rtnTextMaxX, VL1EndY, rtnHL2StartY, rtnVL2StartX, VL3StartX) {
                                        ...
                                        contextObj.spaceOpenDrawingObj.createLegendLines(HL1StartX, HL1StartY, HL1EndX, HL1StartY, function (retCode) {
                                            contextObj.spaceOpenDrawingObj.createLegendLines(HL1StartX, HL1StartY, HL1StartX, VL1EndY, function (retCode) {
                                                contextObj.spaceOpenDrawingObj.createLegendLines(HL1StartX, rtnHL2StartY, HL1EndX, rtnHL2StartY, function (retCode) {
                                                    contextObj.spaceOpenDrawingObj.createLegendLines(HL1StartX, VL1EndY, HL1EndX, VL1EndY, function (retCode) {
                                                        contextObj.spaceOpenDrawingObj.createLegendLines(rtnVL2StartX, HL1StartY, rtnVL2StartX, VL1EndY, function (retCode) {
                                                            contextObj.spaceOpenDrawingObj.createLegendLines(VL3StartX, HL1StartY, VL3StartX, VL1EndY, function (retCode) {
                                                                contextObj.spaceOpenDrawingObj.createLegendLines(HL1EndX, HL1StartY, HL1EndX, VL1EndY, function (retCode) {
        ...
        this.getDistributionByName = function (dblX, intDistRectHeight, dblY, TextMaxX, HL2StartY, intDistRectWidth, HL1StartX, VL2StartX, resCallback) {
            var contextObj = this;
            var dblStartY;
            var dblStartY1;
            var VL1EndY;
            dblX = dblX + (intDistRectHeight / 2);
            contextObj.objiWhiz.createText("$LEGEND", 7, dblX + (intDistRectHeight + (4 * contextObj.commonDwgServices.g_dblDwgRatio)), dblY - (intDistRectHeight / 3), contextObj.commonDwgServices.g_intSpaceDataTextAngle, (contextObj.commonDwgServices.g_intLegendTextSize) - (contextObj.commonDwgServices.g_intLegendTextSize * .25), contextObj.commonDwgServices.g_intSpaceDataTextWidth, contextObj.selectedOccupancyName, contextObj.commonDwgServices.g_strTextStyleName, contextObj.commonDwgServices.g_strSpaceDataTextLegendStyleId, function (retCode, orgLevelTextHandle) {
                if (retCode != 0)
                    console.log("createText returned with error code : ", retCode);
                else {
                        ...
                        if (retCode != 0) {
                            ...
                            contextObj.hatchPatternLegent(contextObj.empOccupancyLegendData, dblX, intDistRectHeight, intDistRectWidth, dblY, VL2StartX, TextMaxX, VL1EndY, function (returnCode, rtnVL2StartX, rtnTextMaxX, rtnVL1EndY) {
                                if (retCode == 0) {
                                    ...
                                    var VL3StartX_1 = rtnTextMaxX + (contextObj.commonDwgServices.g_intLegendTextSize) + (2 * contextObj.commonDwgServices.g_dblDwgRatio);
                                    //'dblX=TextMaxX +100
                                    dblX = rtnTextMaxX + (contextObj.commonDwgServices.g_intLegendTextSize) + (4 * contextObj.commonDwgServices.g_dblDwgRatio);
                                    contextObj.objiWhiz.createText("$LEGEND", 7, dblX, dblY - (intDistRectHeight / 3), contextObj.commonDwgServices.g_intSpaceDataTextAngle, (contextObj.commonDwgServices.g_intLegendTextSize) - (contextObj.commonDwgServices.g_intLegendTextSize * .25), contextObj.commonDwgServices.g_intSpaceDataTextWidth, "Area (" + contextObj.commonDwgServices.areaUnit + ")", contextObj.commonDwgServices.g_strTextStyleName, contextObj.commonDwgServices.g_strSpaceDataTextLegendStyleId, function (retCode, entityHandle) {
                                        if (retCode != 0) {
                                            console.log("createText returned with error code : ", retCode);
                                        }
                                        else {
            ...
            if (legentData.length > contextObj.arrayCount) {
                ...
                if (retCode != 0) {
                    ...
                    if (retCode != 0) {
                        ...
                        contextObj.objiWhiz.createText("$LEGEND", 7, VL2StartX + (2 * contextObj.commonDwgServices.g_dblDwgRatio), dblY - (intDistRectHeight / 3), contextObj.commonDwgServices.g_intSpaceDataTextAngle, (contextObj.commonDwgServices.g_intLegendTextSize) - (contextObj.commonDwgServices.g_intLegendTextSize * .25), contextObj.commonDwgServices.g_intSpaceDataTextWidth, legentDataItem.TextName, contextObj.commonDwgServices.g_strTextStyleName, contextObj.commonDwgServices.g_strSpaceDataTextLegendStyleId, function (retCode, orgLevelItemTextHandle) {
                            if (retCode != 0) {
                                console.log("createText returned with error code : ", retCode);
                                //legentData.pop();
                                contextObj.arrayCount++;
        ...
        //    }
        //}
        this.displayAreaValues = function (legentData, dblY, intDistRectHeight, TextMaxX, resCallback) {
            var contextObj = this;
            if (legentData.length > contextObj.arrayCount) {
                var legentDataItem = legentData[contextObj.arrayCount];
                contextObj.objiWhiz.createText("$LEGEND", 7, TextMaxX, dblY - (intDistRectHeight / 3), contextObj.commonDwgServices.g_intSpaceDataTextAngle, (contextObj.commonDwgServices.g_intLegendTextSize) - (contextObj.commonDwgServices.g_intLegendTextSize * .25), contextObj.commonDwgServices.g_intSpaceDataTextWidth, legentDataItem.Area, contextObj.commonDwgServices.g_strTextStyleName, 9, function (retCode, orgLevelItemTextAreaHandle) {
                    if (retCode != 0) {
                        console.log("createText returned with error code : ", retCode);
                        //legentData.pop();
                        contextObj.arrayCount++;
        ...
        this.getspaceStandardCapacityLegend = function (xPos, yPos, intDistRectHeight, rescallback) {
            var contextObj = this;
            var formatedText = "";
            var contextObj = this;
            var startX = xPos;
            ...
            var ratio = [0];
            contextObj.objiWhiz.clientDWGAreaRatio(ratio);
            contextObj.empDrawingService.getSpaceStandardCapacityLegendForDrawing(contextObj.drawingId, 0, 0).subscribe(function (resultData) {
        ...
        this.getspaceStandardCapacityData = function (spStandardCapacityData, keyData, resCallback) {
            var contextObj = this;
            contextObj.empSpStandardCapacityLegendData = [];
            for (var index = 0; index < keyData.length; index++) {
                contextObj.empSpStandardCapacityLegendData.push({ Key: keyData[index], Value: spStandardCapacityData[keyData[index]] });
            }
            resCallback(0);
        };
        this.createspaceStandardCapacityLegendText = function (empSpStandardCapacityLegendData, startX, startY, intSize, intDistRectHeight, resCallback) {
            var contextObj = this;
            if (empSpStandardCapacityLegendData.length > contextObj.arrayCount) {
                ...
                var legentDataItemString = legentDataItem.Key + ": " + legentDataItem.Value;
                contextObj.objiWhiz.createText("$LEGEND", 1, startX, startY - (intDistRectHeight / 3), contextObj.commonDwgServices.g_intSpaceDataTextAngle, intSize, contextObj.commonDwgServices.g_intSpaceDataTextWidth, legentDataItemString, contextObj.commonDwgServices.g_strTextStyleName, 0, function (retCode, orgLevelItemTextAreaHandle) {
                    if (retCode != 0) {
                        console.log("createText returned with error code : ", retCode);
                    }
                    else {
        ...
        this.showSelectedEmployeeInDrawing = function (empIds, resCallback) {
            var contextObj = this;
            var selectedHandles = [];
            var symbolHandles = [];
            var _loop_1 = function(empId) {
                handle = this_1.getSpaceHandleViaEmpId(empId);
                if (handle != undefined && handle != null && handle != "") {
                    if (selectedHandles.length > 0) {
                        index = selectedHandles.findIndex(function (el) { return el === handle; });
                        if (index == -1)
        ...
        this.hatchMultipleEmployee = function (selectedHandles, resCallback) {
            var contextObj = this;
        ...
        this.showSelectedEmployeeZoomDrawing = function (empId, resCallback) {
            var contextObj = this;
        ...
        this.hatchEmployee = function (symbolHandle, resCallback) {
            var contextObj = this;
        ...
        this.hatchSelectedEmployee = function (symbolHandle, resCallback) {
            var contextObj = this;
            var mapHandle = [symbolHandle];
            var rgbColor = [[255, 255, 255]];
            //  contextObj.deHatchEmployee(function (retCode) {
        ...
        this.deHatchEmployee = function (resCallback) {
            var contextObj = this;
        ...
        this.employeeEditReflectInDrawing = function (editedRowData, resCallback) {
            var contextObj = this;
        ...
        this.getEmployeeAssignRequestStatus = function (employeeId, resCallback) {
            var gradeExist = false;
            var contextObj = this;
            var assignRequestStatus;
            var isFieldSubscribed;
            // to do re-link
            contextObj.empDrawingService.isFieldSubscribed(2, 874).subscribe(function (resultData) {
        ...
        this.invokeAssignEmployee = function (employeeId, employeeName, gradeExist, resCallback) {
            var contextObj = this;
            var blnEditPermission = true;
            var intCompareResult; //Check Edit permission For Facility User
            var spaceId;
        ...
        this.getSeatingCapacity = function (spaceId, resCallback) {
            var contextObj = this;
        ...
        this.insertSpaceAllotments = function (employeeId, spaceId, drawingId, xPosition, yPosition, resCallback) {
            var contextObj = this;
        ...
        this.deAssignEmployeeFromDrawing = function (isDeassign, resCallback) {
            var contextObj = this;
            var selectedEmpId;
        ...
        this.deAssignEmp = function (isDeassign, selectedEmpId, selectedSpacehandle, symbolHandle, resCallback) {
            var contextObj = this;
            contextObj.hatchEmployee(symbolHandle, function (retCode) {
                if (retCode != 0)
                    console.log("hatchEmployee failed due to ", retCode);
        ...
        this.deAssignAfterConfirm = function (employeeId, resCallback) {
            var contextObj = this;
            var index;
        ...
        this.deleteAfterconfirm = function (employeeId, resCallback) {
            var contextObj = this;
        ...
        this.CheckEmployeeStatus = function (empid, resCallback) {
            var contextObj = this;
        ...
        this.cancelEmployeeMoveRequest = function (moveId, moveNo, employeeId, resCallback) {
            this.empDrawingService.cancelEmployeeMoveRequest(moveId, moveNo, employeeId).subscribe(function (resultData) {
                resCallback(0);
            });
        };
        this.clearobjMoveRequestEmpDetails = function (employeeId, resCallback) {
            debugger;
            var contextObj = this;
            var index;
            var currentEmpHandle = "";
            var currentEmpTextHandle = "";
            var currentEmpLeaderHandle = "";
        ...
        this.invokeSelectedEmpDetails = function (intEmployeeId, strEmployeeName, gradeExist, previousXCord, previousYCord, selectedSymbolhandle, resCallback) {
            var contextObj = this;
            contextObj.invokeAssignEmployee(intEmployeeId, strEmployeeName, gradeExist, function (returnCode, seatingCapacity, spaceId, currentXCord, currentYCord, selectedSpaceHandle) {
                ...
                switch (returnCode) {
                    case 1:
                        ...
                        break;
                    case 2:
                        resCallback(returnCode, seatingCapacity, intEmployeeId, previousXCord, previousYCord, currentXCord, currentYCord, selectedSymbolhandle, spaceId, strEmployeeName, gradeExist);
                        break;
                    case 3:
                        resCallback(returnCode, seatingCapacity, intEmployeeId, previousXCord, previousYCord, currentXCord, currentYCord, selectedSymbolhandle, spaceId, strEmployeeName, gradeExist);
                        break;
        ...
        this.moveEmployeeInDrawing = function (isSingleMove, resCallback) {
            var contextObj = this;
            var selectedEmpId;
            var employeeName;
            var employeeCode;
        ...
        this.moveEmployeeToSelectedSpace = function (intEmployeeId, previousXCord, previousYCord, currentXCord, currentYCord, selectedSymbolhandle, spaceId, resCallback) {
            var contextObj = this;
            //contextObj.objiWhiz.enableRubberband(0, 0, 0, false);
        ...
        this.moveEmployeeText = function (empId, xPos, yPos, resCallback) {
            var contextObj = this;
            var textHandle = contextObj.dataInDrawingTextHandles.find(function (el) { return el.Key === empId; }).Value;
        ...
        this.isAdminPrivilage = function (resCallback) {
            var blnEmpMenuVisible = false;
            var contextObj = this;
            var g_blnSpaceModuleAdmin;
        ...
        this.getEmpIdsArray = function (selectedMultipleSpaceIds) {
            var selectedIds = [];
            for (var _i = 0, selectedMultipleSpaceIds_1 = selectedMultipleSpaceIds; _i < selectedMultipleSpaceIds_1.length; _i++) {
                ...
                for (var _a = 0, _b = this.empData; _a < _b.length; _a++) {
                    var empItem = _b[_a];
        ...
        this.addTotalizeLegend = function (totalSpaceCount, resCallback) {
            ...
            for (var _i = 0, _a = this.empTotalizeDataForLegend; _i < _a.length; _i++) {
                var item = _a[_i];
            ...
            contextObj.objiWhiz.getDWGPoint(function (retCode, xPos, yPos) {
                if (retCode == 0) {
                    contextObj.spaceOpenDrawingObj.createDrawingDetailsLegend(xPos, yPos, false, function (startY) {
                        contextObj.objiWhiz.createMultilineText("$LEGEND", 1, xPos, startY, 0, contextObj.commonDwgServices.g_dblDwgRatio * 3, 0, 1, formatedText, "Standard", 0, function (retCode, entityHandle) {
                            if (retCode != 0)
                                console.log("createMultilineText returned with error code : ", retCode);
                            else
                                console.log("Entity handle: " + entityHandle);
        ...
        this.moveMultipleEmployeeInDrawingOnClick = function (resCallback) {
        ...
        this.getMultipleEmployeeForMove = function (selectedEmpDetails, resCallback) {
            var contextObj = this;
        ...
        this.multipleMoveEmployeeToSelectedSpace = function (intEmployeeId, previousXCord, previousYCord, currentXCord, currentYCord, selectedSymbolhandle, spaceId, resCallback) {
            var contextObj = this;
            contextObj.objiWhiz.stopSvgTrails();
            contextObj.objiWhiz.enableRubberband(0, 0, 0, false);
            //   this.empDrawingService.insertSpaceAllotmentDetails(intEmployeeId, spaceId, contextObj.drawingId, currentXCord, currentYCord).subscribe(function (resultData) {
        ...
        this.assignToAnotherFloor = function (empDetails, resCallback) {
            var contextObj = this;
            var empDispSettingsData = contextObj.empDisplaySettingData.slice();
            var ratio = [0];
            contextObj.objiWhiz.clientDWGAreaRatio(ratio);
        ...
        this.moveEmployeeCheckFromContextMenu = function (empId, resCallback) {
            var contextObj = this;
    ...
    EmployeeOpenDrawing.prototype.getSpaceHandlefromXY = function (employeedata, count, spacehandlearray, rescallback) {
        var contextObj = this;
    ...
    EmployeeOpenDrawing.prototype.displayNotProperlyLocatedEmployees = function (xPosNullEmpData) {
        var contextObj = this;
        ...
        var _loop_2 = function() {
            ...
            var spaceId = sortedxPosNullEmpData[i]['AssignedSpaceId'];
            if (spaceId != null && spaceId != undefined) {
                contextObj.commonDwgServices.calculateDwgRatio();
                var previousSpaceId_1 = undefined;
                var entityHandle = contextObj.getSpaceHandleViaSpaceId(spaceId);
                if (i > 0)
                    previousSpaceId_1 = sortedxPosNullEmpData[i - 1]['AssignedSpaceId'];
    ...
    EmployeeOpenDrawing.prototype.getSpaceHandleViaSpaceId = function (spaceId) {
        var selectedSpacehandle = "";
        if (this.isSpace)
    ...
    EmployeeOpenDrawing.prototype.moveLegend = function () {
        var contextObj = this;
    ...
    EmployeeOpenDrawing.prototype.getSpaceIdFromSpaceHandle = function (strSpaceHandle) {
        var spaceId;
        var index;
        if (this.isSpace)
    ...
    EmployeeOpenDrawing.prototype.getSpaceHandleViaEmpId = function (empId) {
        var selectedSpacehandle = "";
        var index;
        if (this.isSpace) {
    ...
    EmployeeOpenDrawing.prototype.checkDataExistsforSelectedHandle = function (strSpaceHandle) {
        var intCompareResult = false; //Check Edit permission For Facility User
        if (this.isSpace)
    ...
    EmployeeOpenDrawing.prototype.moveEmployeeInDrawingOnClick = function (resCallback) {
        var contextObj = this;
    ...
    EmployeeOpenDrawing.prototype.getEmployeeXYCordinates = function (empId) {
        var xPos;
        var yPos;
    ...
    EmployeeOpenDrawing.prototype.moveMultipleEmpText = function (empDetails, arrayCount, resCallback) {
        var contextObj = this;
        var empData;
        var xPos;
        var yPos;
    ...
    EmployeeOpenDrawing.prototype.afterMoveReverse = function () {
        var contextObj = this;
    ...
    EmployeeOpenDrawing.prototype.empSymbolReverseMove = function (empDetails, count, resCallback) {
        var contextObj = this;
    ...
    EmployeeOpenDrawing.prototype.getEmpData = function (empId) {
        var index = this.empData.findIndex(function (el) { return el.Id === empId; });
        return this.empData[index];
    };
    EmployeeOpenDrawing.prototype.getEmpDataSecondFloor = function (empData, empId) {
        debugger;
        var index = empData.findIndex(function (el) { return el.Id === empId; });
        return empData[index];
    };
    EmployeeOpenDrawing.prototype.insertMutlipeEmployees = function (insertEmpDetails, arrayCount, resCallback) {
        var contextObj = this;
    ...
    EmployeeOpenDrawing.prototype.moveMultipleEmployeeWithOutApproval = function (moveEmpDetails, resCallback) {
        debugger;
        this.employeeMoveDataInputList = [];
        var empItem;
        var index;
    ...
    EmployeeOpenDrawing.prototype.checkEmpHasResource = function (empDetails, resCallback) {
        var index;
    ...
    EmployeeOpenDrawing.prototype.scaleAllEmployees = function (scaleFactor, recCallback) {
        debugger;
    ...
    EmployeeOpenDrawing.prototype.ScaleEmployeeReset = function (resCallback) {
        var contextObj = this;
        var employeeData;
        employeeData = contextObj.empData.slice();
        var empDispSettingsData = contextObj.empDisplaySettingData.slice();
    ...
    EmployeeOpenDrawing.prototype.ScaleEmployeesTextHeight = function (TextHeight, recCallback) {
        debugger;
        var ratio = [0];
    ...
    EmployeeOpenDrawing.prototype.updateAttachmentCount = function (empId) {
        var index = this.empData.findIndex(function (el) { return el.Id == empId; });
        if (index != -1) {
    ...
    return EmployeeOpenDrawing;
}());
exports.EmployeeOpenDrawing = EmployeeOpenDrawing;
(function (DistributionType) {
    DistributionType[DistributionType["Occupied"] = 1] = "Occupied";
    DistributionType[DistributionType["UnOccupied"] = 2] = "UnOccupied";
    DistributionType[DistributionType["UnderOccupied"] = 3] = "UnderOccupied";
    DistributionType[DistributionType["OverOccupied"] = 4] = "OverOccupied";
    DistributionType[DistributionType["NominalOccupied"] = 5] = "NominalOccupied";
})(exports.DistributionType || (exports.DistributionType = {}));
var DistributionType = exports.DistributionType;
//# sourceMappingURL=employeeopendrawing.services.js.map