...
import { ReviewAssignRequestComponent } from './reviewAssign-Request.component';

@Component({
    selector: 'reviewAssignRequest-list',
    templateUrl: './app/Views/Employee/Assign Review/assignReviewRequest-list.component.html',
    directives: [PageComponent, SubMenu, SplitViewComponent, GridComponent, PagingComponent, FieldComponent, Notification, SlideComponent, TabsComponent, TabComponent, ReviewAssignRequestComponent],
    providers: [NotificationService, GeneralFunctions, AdministrationService, EmployeeService, WorkOrdereService],
    inputs: [],
})

export class ReviewAssignRequestListComponent implements OnInit {

    pagePath: string = "Employee / Request / Employee Assign";
    ...
    activeInputItems: IGrid = { dataKey: "RequestId", groupBy: [], grpWithCheckBx: false, selectedIds: [], allowAdd: false, allowEdit: false, selectioMode: 'single', sortDir: 'DESC', sortCol: '' };
    fieldObject: IField[];
