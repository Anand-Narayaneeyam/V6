...
var SpaceCostComponent = (function () {
    function SpaceCostComponent(spaceService, notificationService, generFun) {
        ...
        this.fromDate = "";
        this.toDate = "";
        this.ReportTitle = "Trend Analysis: Cost";
        this.selectedTab = 0;
        this.iscard = true;
        this.tabDeleteIndex = 0;
    }
    SpaceCostComponent.prototype.ngOnInit = function () {
        this.menuData = [
            {
                "id": 0,
                "title": "Show Report",
    ...
    SpaceCostComponent.prototype.onSubMenuChange = function (event) {
        this.nextClicked = false;
    ...
    SpaceCostComponent.prototype.getSelectedTab = function (event) {
        if (event[0] == 0) {
            this.selectedTab = 0;
    ...
    SpaceCostComponent = __decorate([
        core_1.Component({
            selector: 'spaceCost',
            templateUrl: './app/Views/Space/TrendAnalysis/Cost/space-cost.select.html',
    ...
    return SpaceCostComponent;
}());
exports.SpaceCostComponent = SpaceCostComponent;
//# sourceMappingURL=space-cost.select.js.map