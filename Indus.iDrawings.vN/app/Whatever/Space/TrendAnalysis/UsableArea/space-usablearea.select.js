...
var SpaceUsableAreaComponent = (function () {
    function SpaceUsableAreaComponent(spaceService, notificationService, generFun) {
        ...
        this.fromDate = "";
        this.toDate = "";
        this.ReportTitle = "Trend Analysis: Usable Area";
        this.selectedTab = 0;
        this.iscard = true;
        this.tabDeleteIndex = 0;
    }
    SpaceUsableAreaComponent.prototype.ngOnInit = function () {
        this.menuData = [
            {
                "id": 0,
                "title": "Show Report",
    ...
    SpaceUsableAreaComponent.prototype.onSubMenuChange = function (event) {
        this.nextClicked = false;
    ...
    SpaceUsableAreaComponent.prototype.getSelectedTab = function (event) {
        if (event[0] == 0) {
            this.selectedTab = 0;
    ...
    SpaceUsableAreaComponent = __decorate([
        core_1.Component({
    ...
    ], SpaceUsableAreaComponent);
    return SpaceUsableAreaComponent;
}());
exports.SpaceUsableAreaComponent = SpaceUsableAreaComponent;
//# sourceMappingURL=space-usablearea.select.js.map