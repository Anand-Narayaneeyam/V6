...
var SpaceFunctionsComponent = (function () {
    function SpaceFunctionsComponent(spaceService, notificationService, generFun) {
        ...
        this.fromDate = "";
        this.toDate = "";
        this.ReportTitle = "Trend Analysis: Space Functions";
        this.SpaceFunctionCusName = "";
        this.selectedTab = 0;
        this.iscard = true;
    ...
    SpaceFunctionsComponent.prototype.ngOnInit = function () {
        ...
        this.pagePath = "Space / Space Functions";
        var contextObj = this;
        contextObj.spaceService.getSpaceFunctionCustomizedName().subscribe(function (resultData) {
            if (resultData.Data != undefined) {
                contextObj.SpaceFunctionCusName = resultData.Data;
                if (contextObj.SpaceFunctionCusName != "") {
                    contextObj.pagePath = "Space / " + contextObj.SpaceFunctionCusName;
                    contextObj.ReportTitle = "Trend Analysis: " + contextObj.SpaceFunctionCusName;
                }
            }
        });
    ...
    SpaceFunctionsComponent.prototype.getSelectedTab = function (event) {
        if (event[0] == 0) {
            this.selectedTab = 0;
    ...
    SpaceFunctionsComponent = __decorate([
        core_1.Component({
            ...
            templateUrl: './app/Views/Space/TrendAnalysis/SpaceFunctions/space-spacefunctions.select.html',
...
//# sourceMappingURL=space-spacefunctions.select.js.map