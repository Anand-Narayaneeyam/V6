...
var SpaceStandardAddEditComponent = (function () {
    function SpaceStandardAddEditComponent(spaceService, _notificationService) {
        this.spaceService = spaceService;
        this._notificationService = _notificationService;
        this.dataKey = "Id";
        this.submitSuccess = new core_1.EventEmitter();
    }
    SpaceStandardAddEditComponent.prototype.onSubmitData = function (event) {
        switch (this.action) {
            case "add":
    ...
    SpaceStandardAddEditComponent.prototype.postSubmit = function (strsubmitField, target) {
        var contextObj = this;
        var field = new Array();
            ...
            switch (resultData["Data"].StatusId) {
                ...
                case 3:
                    if (resultData["Data"].ServerId == -1) {
                        ...
                        setTimeout(function () {
                            var el = document.getElementById("418");
    ...
    ], SpaceStandardAddEditComponent.prototype, "action", void 0);
    __decorate([
        core_1.Input(), 
        __metadata('design:type', Array)
    ], SpaceStandardAddEditComponent.prototype, "fieldDetailsAdd", void 0);
    __decorate([
        core_1.Output(), 
        __metadata('design:type', Object)
    ], SpaceStandardAddEditComponent.prototype, "submitSuccess", void 0);
    SpaceStandardAddEditComponent = __decorate([
        core_1.Component({
    ...
    ], SpaceStandardAddEditComponent);
    return SpaceStandardAddEditComponent;
}());
exports.SpaceStandardAddEditComponent = SpaceStandardAddEditComponent;
//# sourceMappingURL=spacestandard-AddEdit.component.js.map