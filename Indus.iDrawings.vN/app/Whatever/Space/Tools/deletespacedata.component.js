...
var DeleteSpaceDataComponent = (function () {
    function DeleteSpaceDataComponent(_spaceService, differs) {
        this._spaceService = _spaceService;
        this.differs = differs;
        this.selectedTab = 0;
        this.pagePath = "Settings / Space / Delete Space Data ";
        this.getSelectedFloorDrawing = new core_1.EventEmitter();
        this.viewDrawing = false;
        this.differ = differs.find({}).create(null);
    }
    DeleteSpaceDataComponent.prototype.getSelectedTab = function (event) {
        this.selectedTab = event[0];
    };
    DeleteSpaceDataComponent.prototype.ngOnInit = function () {
        this.pageTarget = 4;
        this.moduleId = 3;
    };
    __decorate([
    ...
    ], DeleteSpaceDataComponent.prototype, "getSelectedFloorDrawing", void 0);
    DeleteSpaceDataComponent = __decorate([
        core_1.Component({
    ...
    ], DeleteSpaceDataComponent);
    return DeleteSpaceDataComponent;
}());
exports.DeleteSpaceDataComponent = DeleteSpaceDataComponent;
