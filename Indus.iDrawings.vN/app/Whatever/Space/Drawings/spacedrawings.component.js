...
var SpaceDrawingListComponent = (function () {
    function SpaceDrawingListComponent(_spaceService, differs) {
    ...
    SpaceDrawingListComponent.prototype.getSelectedTab = function (event) {
        this.selectedTab = event[0];
    };
    SpaceDrawingListComponent.prototype.ngOnInit = function () {
        this.pageTarget = 1;
        this.moduleId = 3;
    };
    __decorate([
    ...
    ], SpaceDrawingListComponent.prototype, "getSelectedFloorDrawing", void 0);
    SpaceDrawingListComponent = __decorate([
        core_1.Component({
    ...
    ], SpaceDrawingListComponent);
    return SpaceDrawingListComponent;
}());
exports.SpaceDrawingListComponent = SpaceDrawingListComponent;
//# sourceMappingURL=spacedrawings.component.js.map