...
var AsBuiltsSitesComponent = (function () {
    function AsBuiltsSitesComponent(commonService, notificationService) {
    ...
    AsBuiltsSitesComponent.prototype.ngOnInit = function () {
        this.pagePath = "Reports / As Builts / Sites";
        this.LoadReportData(0);
    };
    AsBuiltsSitesComponent.prototype.LoadReportData = function (IsCustomize) {
    ...
    AsBuiltsSitesComponent.prototype.customizeClick = function (event) {
        var contextObj = this;
    ...
    AsBuiltsSitesComponent.prototype.onSplitViewClose = function (event) {
        this.splitviewInput.showSecondaryView = false;
    };
    AsBuiltsSitesComponent.prototype.applyCustomRptClick = function (event) {
        this.splitviewInput.showSecondaryView = false;
        var contexObj = this;
    ...
    AsBuiltsSitesComponent = __decorate([
        core_1.Component({
            selector: 'asBuiltsSitesComponent-report',
            templateUrl: './app/Views/Reports/AsBuilts/Sites/asbuilts.sites.report.html',
    ...
    ], AsBuiltsSitesComponent);
    return AsBuiltsSitesComponent;
}());
exports.AsBuiltsSitesComponent = AsBuiltsSitesComponent;
//# sourceMappingURL=asbuilts.sites.report.component.js.map