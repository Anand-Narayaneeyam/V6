...
var AsBuiltsAllDrawingsComponent = (function () {
    function AsBuiltsAllDrawingsComponent(commonService, notificationService) {
    ...
    AsBuiltsAllDrawingsComponent.prototype.ngOnInit = function () {
        this.pagePath = "Reports / As Builts / Drawings - All Drawings";
        this.LoadReportData(0);
    };
    AsBuiltsAllDrawingsComponent.prototype.LoadReportData = function (IsCustomize) {
        this.ReportData = { ModuleId: 0, ReportCategoryId: 0, ExportFileName: "", ReportTitle: "", ReportSubTitle: "", ListReportFieldIdValues: [] };
        var arrRptFieldIds = new Array();
        this.ReportData.ModuleId = 1;
        this.ReportData.ReportCategoryId = 13;
        this.ReportData.ExportFileName = "All Drawings";
        this.ReportData.ReportTitle = "All Drawings";
    ...
    AsBuiltsAllDrawingsComponent.prototype.customizeClick = function (event) {
        var contextObj = this;
    ...
    AsBuiltsAllDrawingsComponent.prototype.onSplitViewClose = function (event) {
        this.splitviewInput.showSecondaryView = false;
    };
    AsBuiltsAllDrawingsComponent.prototype.applyCustomRptClick = function (event) {
        this.splitviewInput.showSecondaryView = false;
        var contexObj = this;
    ...
    AsBuiltsAllDrawingsComponent = __decorate([
        core_1.Component({
            selector: 'asBuiltsAllDrawingsComponent-report',
            templateUrl: './app/Views/Reports/AsBuilts/Drawings/AllDrawings/asbuilts.alldrawings.report.html',
    ...
    ], AsBuiltsAllDrawingsComponent);
    return AsBuiltsAllDrawingsComponent;
}());
exports.AsBuiltsAllDrawingsComponent = AsBuiltsAllDrawingsComponent;
//# sourceMappingURL=asbuilts.alldrawings.report.component.js.map