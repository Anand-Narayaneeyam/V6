...
var AsBuiltsMarkupsComponent = (function () {
    function AsBuiltsMarkupsComponent(commonService, notificationService) {
    ...
    AsBuiltsMarkupsComponent.prototype.ngOnInit = function () {
        this.pagePath = "Reports / As Builts / Drawings - Markups";
        this.LoadReportData(0);
    };
    AsBuiltsMarkupsComponent.prototype.LoadReportData = function (IsCustomize) {
        this.ReportData = { ModuleId: 0, ReportCategoryId: 0, ExportFileName: "", ReportTitle: "", ReportSubTitle: "", ListReportFieldIdValues: [] };
        var arrRptFieldIds = new Array();
        this.ReportData.ModuleId = 1;
        this.ReportData.ReportCategoryId = 18;
        this.ReportData.ExportFileName = "All Drawings Markups";
        this.ReportData.ReportTitle = "All Drawings Markups";
    ...
    AsBuiltsMarkupsComponent.prototype.customizeClick = function (event) {
        var contextObj = this;
    ...
    AsBuiltsMarkupsComponent.prototype.onSplitViewClose = function (event) {
        this.splitviewInput.showSecondaryView = false;
    };
    AsBuiltsMarkupsComponent.prototype.applyCustomRptClick = function (event) {
        this.splitviewInput.showSecondaryView = false;
        var contexObj = this;
    ...
    AsBuiltsMarkupsComponent = __decorate([
        core_1.Component({
            selector: 'asBuiltsMarkupsComponent-report',
            templateUrl: './app/Views/Reports/AsBuilts/Drawings/Markups/asbuilts.markups.report.html',
    ...
    ], AsBuiltsMarkupsComponent);
    return AsBuiltsMarkupsComponent;
}());
exports.AsBuiltsMarkupsComponent = AsBuiltsMarkupsComponent;
//# sourceMappingURL=asbuilts.markups.report.component.js.map