...
var AsBuiltsRevisionsComponent = (function () {
    function AsBuiltsRevisionsComponent(commonService, notificationService) {
    ...
    AsBuiltsRevisionsComponent.prototype.ngOnInit = function () {
        this.pagePath = "Reports / As Builts / Drawings - Revisions";
        this.LoadReportData(0);
    };
    AsBuiltsRevisionsComponent.prototype.LoadReportData = function (IsCustomize) {
        this.ReportData = { ModuleId: 0, ReportCategoryId: 0, ExportFileName: "", ReportTitle: "", ReportSubTitle: "", ListReportFieldIdValues: [] };
        var arrRptFieldIds = new Array();
        this.ReportData.ModuleId = 1;
        this.ReportData.ReportCategoryId = 19;
        this.ReportData.ExportFileName = "All Drawings Revisions";
        this.ReportData.ReportTitle = "All Drawings Revisions";
    ...
    AsBuiltsRevisionsComponent.prototype.customizeClick = function (event) {
        var contextObj = this;
    ...
    AsBuiltsRevisionsComponent.prototype.onSplitViewClose = function (event) {
        this.splitviewInput.showSecondaryView = false;
    };
    AsBuiltsRevisionsComponent.prototype.applyCustomRptClick = function (event) {
        this.splitviewInput.showSecondaryView = false;
        var contexObj = this;
    ...
    AsBuiltsRevisionsComponent = __decorate([
        core_1.Component({
            selector: 'asBuiltsRevisionsComponent-report',
            templateUrl: './app/Views/Reports/AsBuilts/Drawings/Revisions/asbuilts.revisions.report.html',
    ...
    ], AsBuiltsRevisionsComponent);
    return AsBuiltsRevisionsComponent;
}());
exports.AsBuiltsRevisionsComponent = AsBuiltsRevisionsComponent;
//# sourceMappingURL=asbuilts.revisions.report.component.js.map