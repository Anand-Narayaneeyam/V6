...
var AsBuiltsBuildingsComponent = (function () {
    function AsBuiltsBuildingsComponent(commonService, notificationService) {
    ...
    AsBuiltsBuildingsComponent.prototype.ngOnInit = function () {
        this.pagePath = "Reports / As Builts / Buildings";
        this.LoadReportData(0);
    };
    AsBuiltsBuildingsComponent.prototype.LoadReportData = function (IsCustomize) {
        this.ReportData = { ModuleId: 0, ReportCategoryId: 0, ExportFileName: "", ReportTitle: "", ReportSubTitle: "", ListReportFieldIdValues: [] };
        var arrRptFieldIds = new Array();
        this.ReportData.ModuleId = 1;
        this.ReportData.ReportCategoryId = 4;
        this.ReportData.ExportFileName = "Buildings";
        this.ReportData.ReportTitle = "Buildings";
    ...
    AsBuiltsBuildingsComponent.prototype.customizeClick = function (event) {
        var contextObj = this;
    ...
    AsBuiltsBuildingsComponent.prototype.onSplitViewClose = function (event) {
        this.splitviewInput.showSecondaryView = false;
    };
    AsBuiltsBuildingsComponent.prototype.applyCustomRptClick = function (event) {
        this.splitviewInput.showSecondaryView = false;
        var contexObj = this;
    ...
    AsBuiltsBuildingsComponent = __decorate([
        core_1.Component({
            selector: 'asBuiltsBuildingsComponent-report',
            templateUrl: './app/Views/Reports/AsBuilts/Buildings/asbuilts.buildings.report.html',
    ...
    ], AsBuiltsBuildingsComponent);
    return AsBuiltsBuildingsComponent;
}());
exports.AsBuiltsBuildingsComponent = AsBuiltsBuildingsComponent;
//# sourceMappingURL=asbuilts.buildings.report.component.js.map