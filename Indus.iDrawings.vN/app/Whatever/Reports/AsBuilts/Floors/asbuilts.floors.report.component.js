...
var AsBuiltsFloorsComponent = (function () {
    function AsBuiltsFloorsComponent(commonService, notificationService) {
    ...
    AsBuiltsFloorsComponent.prototype.ngOnInit = function () {
        this.pagePath = "Reports / As Builts / Floors";
        this.LoadReportData(0);
    };
    AsBuiltsFloorsComponent.prototype.LoadReportData = function (IsCustomize) {
        this.ReportData = { ModuleId: 0, ReportCategoryId: 0, ExportFileName: "", ReportTitle: "", ReportSubTitle: "", ListReportFieldIdValues: [] };
        var arrRptFieldIds = new Array();
        this.ReportData.ModuleId = 1;
        this.ReportData.ReportCategoryId = 5;
        this.ReportData.ExportFileName = "Floors";
        this.ReportData.ReportTitle = "Floors";
    ...
    AsBuiltsFloorsComponent.prototype.customizeClick = function (event) {
        var contextObj = this;
    ...
    AsBuiltsFloorsComponent.prototype.onSplitViewClose = function (event) {
        this.splitviewInput.showSecondaryView = false;
    };
    AsBuiltsFloorsComponent.prototype.applyCustomRptClick = function (event) {
        this.splitviewInput.showSecondaryView = false;
        var contexObj = this;
    ...
    AsBuiltsFloorsComponent = __decorate([
        core_1.Component({
            selector: 'asBuiltsFloorsComponent-report',
            templateUrl: './app/Views/Reports/AsBuilts/Floors/asbuilts.floors.report.html',
    ...
    ], AsBuiltsFloorsComponent);
    return AsBuiltsFloorsComponent;
}());
exports.AsBuiltsFloorsComponent = AsBuiltsFloorsComponent;
//# sourceMappingURL=asbuilts.floors.report.component.js.map