...
var SpaceBuildingsComponent = (function () {
    function SpaceBuildingsComponent(commonService, notificationService) {
    ...
    SpaceBuildingsComponent.prototype.ngOnInit = function () {
        this.pagePath = "Reports / Space / Buildings";
        this.LoadReportData(0);
    };
    SpaceBuildingsComponent.prototype.LoadReportData = function (IsCustomize) {
    ...
    SpaceBuildingsComponent.prototype.customizeClick = function (event) {
        var contextObj = this;
    ...
    SpaceBuildingsComponent.prototype.onSplitViewClose = function (event) {
        this.splitviewInput.showSecondaryView = false;
    };
    SpaceBuildingsComponent.prototype.applyCustomRptClick = function (event) {
        this.splitviewInput.showSecondaryView = false;
        var contexObj = this;
    ...
    SpaceBuildingsComponent = __decorate([
        core_1.Component({
            selector: 'spaceBuildingsComponent-report',
            templateUrl: './app/Views/Reports/Space/Buildings/space.buildings.report.html',
    ...
    ], SpaceBuildingsComponent);
    return SpaceBuildingsComponent;
}());
exports.SpaceBuildingsComponent = SpaceBuildingsComponent;
//# sourceMappingURL=space.buildings.report.component.js.map