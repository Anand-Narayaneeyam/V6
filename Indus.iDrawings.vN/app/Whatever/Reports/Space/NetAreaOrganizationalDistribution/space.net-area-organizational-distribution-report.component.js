...
var spaceNetAreaOrganizationaDistribution = (function () {
    function spaceNetAreaOrganizationaDistribution(commonreportservice, commonService) {
    ...
    spaceNetAreaOrganizationaDistribution.prototype.ngOnInit = function () {
        var contexObj = this;
    ...
    spaceNetAreaOrganizationaDistribution.prototype.LoadReportData = function () {
        this.ReportData = { ModuleId: 0, ReportCategoryId: 0, ExportFileName: "", ReportTitle: "", ReportSubTitle: "", ListReportFieldIdValues: [] };
        var contexObj = this;
        var arrRptFieldIds = new Array();
        this.ReportData.ModuleId = 3;
        this.ReportData.ReportCategoryId = 92;
        this.ReportData.ExportFileName = "Net Area Organizational Distribution";
        this.ReportData.ReportTitle = "Net Area Organizational Distribution";
    ...
    spaceNetAreaOrganizationaDistribution.prototype.checkForScheduledReport = function () {
        var contextObj = this;
    ...
    spaceNetAreaOrganizationaDistribution.prototype.onChangeType = function (event) {
        switch (event) {
            case "16":
                this.ReportType = "0";
                this.IsTextType = false;
    ...
    spaceNetAreaOrganizationaDistribution.prototype.onSubmit = function (event) {
    ...
    spaceNetAreaOrganizationaDistribution.prototype.showSheduleReport = function (event) {
        var contextObj = this;
        contextObj.splitviewInput.showSecondaryView = true;
        contextObj.pageTitle = "New Scheduled Report";
        contextObj.showSheduleReportAddEdit = true;
    };
    spaceNetAreaOrganizationaDistribution.prototype.onSplitViewClose = function (event) {
        this.splitviewInput.showSecondaryView = false;
    };
    spaceNetAreaOrganizationaDistribution.prototype.handleInsertSuccess = function (event) {
        this.splitviewInput.showSecondaryView = false;
    };
    spaceNetAreaOrganizationaDistribution = __decorate([
        core_1.Component({
            selector: 'space-net-area-organizational-distribution-report',
            templateUrl: './app/Views/Reports/Space/NetAreaOrganizationalDistribution/space.net-area-organizational-distribution-report.component.html',
    ...
    ], spaceNetAreaOrganizationaDistribution);
    return spaceNetAreaOrganizationaDistribution;
}());
exports.spaceNetAreaOrganizationaDistribution = spaceNetAreaOrganizationaDistribution;
//# sourceMappingURL=space.net-area-organizational-distribution-report.component.js.map