...
var SpaceFloorsComponent = (function () {
    function SpaceFloorsComponent(commonService, notificationService) {
    ...
    SpaceFloorsComponent.prototype.ngOnInit = function () {
        this.pagePath = "Reports / Space / Floors";
        this.LoadReportData(0);
    };
    SpaceFloorsComponent.prototype.LoadReportData = function (IsCustomize) {
    ...
    SpaceFloorsComponent.prototype.customizeClick = function (event) {
        var contextObj = this;
    ...
    SpaceFloorsComponent.prototype.onSplitViewClose = function (event) {
        this.splitviewInput.showSecondaryView = false;
    };
    SpaceFloorsComponent.prototype.applyCustomRptClick = function (event) {
        this.splitviewInput.showSecondaryView = false;
        var contexObj = this;
    ...
    SpaceFloorsComponent = __decorate([
        core_1.Component({
            selector: 'spaceFloorsComponent-report',
            templateUrl: './app/Views/Reports/Space/Floors/space.floors.report.html',
    ...
    ], SpaceFloorsComponent);
    return SpaceFloorsComponent;
}());
exports.SpaceFloorsComponent = SpaceFloorsComponent;
//# sourceMappingURL=space.floors.report.component.js.map