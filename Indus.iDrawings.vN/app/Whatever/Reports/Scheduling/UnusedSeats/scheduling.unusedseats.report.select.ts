...
import { SchedulingReportUnusedSeatsComponent } from './scheduling.unusedseats.report';


@Component({
    selector: 'UnusedSeats',
    templateUrl: './app/Views/Reports/Scheduling/UnusedSeats/scheduling.unusedseats.select.html',
    directives: [Notification, DateTimeComponent, PageComponent, TabsComponent, TabComponent, SubMenu, SchedulingReportUnusedSeatsComponent],
    providers: [SchedulingService, NotificationService],
})

export class UnusedSeatsComponent implements OnInit {
    ...
    pagePath: any = "Reports / Scheduling / Unused Workspaces";
