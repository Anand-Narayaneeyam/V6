...
var SchedulingReportUnusedSeatsComponent = (function () {
    function SchedulingReportUnusedSeatsComponent(commonreportservice) {
    ...
    SchedulingReportUnusedSeatsComponent.prototype.ngOnInit = function () {
        this.LoadReportData();
        this.pagePath = "Reports / Scheduling / Unused Workspaces";
    };
    SchedulingReportUnusedSeatsComponent.prototype.LoadReportData = function () {
        this.ReportData = { ModuleId: 0, ReportCategoryId: 0, ExportFileName: "", ReportTitle: "", ReportSubTitle: "", ListReportFieldIdValues: [] };
    ...
    SchedulingReportUnusedSeatsComponent = __decorate([
        core_1.Component({
    ...
    ], SchedulingReportUnusedSeatsComponent);
    return SchedulingReportUnusedSeatsComponent;
}());
exports.SchedulingReportUnusedSeatsComponent = SchedulingReportUnusedSeatsComponent;
//# sourceMappingURL=scheduling.unusedseats.report.js.map