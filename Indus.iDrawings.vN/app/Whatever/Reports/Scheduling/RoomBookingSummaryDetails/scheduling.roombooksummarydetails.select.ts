...
import {SchedulingReportRoomBookingSummaryDetails  } from './scheduling.roombooksummarydetails.report';
...
@Component({
    ...
    directives: [Notification, DateComponent, PageComponent, TabsComponent, TabComponent, SubMenu, SchedulingReportRoomBookingSummaryDetails],
    providers: [SchedulingService, NotificationService],
})

export class RoomBookingSummaryDetails implements OnInit {
    ...
    pagePath: any = "Reports / Scheduling / Room Reservation Summary Details";
    roomtxt = "Room";
