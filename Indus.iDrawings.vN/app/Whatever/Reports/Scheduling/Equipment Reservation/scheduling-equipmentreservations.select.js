...
var scheduling_equipmentreservations_report_1 = require('./scheduling-equipmentreservations.report');
var EquipmentReservationData = (function () {
    function EquipmentReservationData(notificationService, schedulingService, generFun) {
    ...
    EquipmentReservationData.prototype.ngOnInit = function () {
        this.menuData = [
            {
                "id": 0,
                "title": "Show Report",
    ...
    EquipmentReservationData.prototype.onSubMenuChange = function (event) {
        this.nextClicked = false;
    ...
    EquipmentReservationData.prototype.getSelectedTab = function (event) {
        if (event[0] == 0) {
            this.selectedTab = 0;
    ...
    EquipmentReservationData = __decorate([
        core_1.Component({
            ...
            directives: [notify_component_1.Notification, datecomponent_component_1.DateComponent, page_component_1.PageComponent, tabs_component_1.TabsComponent, tab_component_1.TabComponent, submenu_component_1.SubMenu, scheduling_equipmentreservations_report_1.SchedulingReportEquipmentReservationData],
    ...
    return EquipmentReservationData;
}());
exports.EquipmentReservationData = EquipmentReservationData;
//# sourceMappingURL=scheduling-equipmentreservations.select.js.map