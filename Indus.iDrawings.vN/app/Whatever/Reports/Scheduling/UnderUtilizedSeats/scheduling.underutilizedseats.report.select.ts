...
import { SchedulingReportUnderUtilizedSeatsComponent } from './scheduling.underutilizedseats.report';
...
@Component({
    ...
    directives: [Notification, DateTimeComponent, PageComponent, TabsComponent, TabComponent, SubMenu, SchedulingReportUnderUtilizedSeatsComponent],
    providers: [SchedulingService, NotificationService],
})

export class UnderUtilizedSeatsComponent implements OnInit {
    ...
    pagePath: any = "Reports / Scheduling / Under Utilized Workspaces (Less than 20%)";
