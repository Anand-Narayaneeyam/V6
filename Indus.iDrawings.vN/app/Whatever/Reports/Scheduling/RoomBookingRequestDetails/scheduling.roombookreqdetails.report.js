...
var SchedulingReportRoomBookingRequestDetails = (function () {
    function SchedulingReportRoomBookingRequestDetails(commonreportservice, SchedulingService) {
    ...
    SchedulingReportRoomBookingRequestDetails.prototype.ngOnInit = function () {
        var contextObj = this;
    ...
    SchedulingReportRoomBookingRequestDetails.prototype.LoadReportData = function () {
        debugger;
        this.ReportData = { ModuleId: 0, ReportCategoryId: 0, ExportFileName: "", ReportTitle: "", ReportSubTitle: "", ListReportFieldIdValues: [] };
    ...
    SchedulingReportRoomBookingRequestDetails = __decorate([
        core_1.Component({
    ...
    ], SchedulingReportRoomBookingRequestDetails);
    return SchedulingReportRoomBookingRequestDetails;
}());
exports.SchedulingReportRoomBookingRequestDetails = SchedulingReportRoomBookingRequestDetails;
//# sourceMappingURL=scheduling.roombookreqdetails.report.js.map