...
import { SchedulingReportRoomBookingRequestDetails } from './scheduling.roombookreqdetails.report';
...
@Component({
    ...
    directives: [Notification, DateComponent, PageComponent, TabsComponent, TabComponent, SubMenu, SchedulingReportRoomBookingRequestDetails],
    providers: [SchedulingService, NotificationService],
})

export class RoomBookingRequestDetails implements OnInit {
    ...
    pagePath: any = "Reports / Scheduling / Room Reservation Details";
    roomtxt = "Room";
