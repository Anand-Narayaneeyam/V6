...
var scheduling_seatutilization_report_1 = require('./scheduling.seatutilization.report');
var SeatUtilizationComponent = (function () {
    function SeatUtilizationComponent(notificationService, schedulingService, generFun) {
        ...
        this.pagePath = "Reports / Scheduling / Workspace Utilization";
    }
    SeatUtilizationComponent.prototype.ngOnInit = function () {
        this.menuData = [
            {
                "id": 0,
                "title": "Show Report",
    ...
    SeatUtilizationComponent.prototype.onSubMenuChange = function (event) {
        this.nextClicked = false;
    ...
    SeatUtilizationComponent.prototype.getSelectedTab = function (event) {
        if (event[0] == 0) {
            this.selectedTab = 0;
    ...
    SeatUtilizationComponent.prototype.setPrevMonthsDate = function () {
    ...
    SeatUtilizationComponent = __decorate([
        core_1.Component({
            selector: 'SeatUtilization',
            templateUrl: './app/Views/Reports/Scheduling/SeatUtilization/scheduling.seatutilization.select.html',
            directives: [notify_component_1.Notification, datetimecomponent_component_1.DateTimeComponent, page_component_1.PageComponent, tabs_component_1.TabsComponent, tab_component_1.TabComponent, submenu_component_1.SubMenu, scheduling_seatutilization_report_1.SchedulingReportSeatUtilizationComponent],
    ...
    ], SeatUtilizationComponent);
    return SeatUtilizationComponent;
}());
exports.SeatUtilizationComponent = SeatUtilizationComponent;
//# sourceMappingURL=scheduling.seatutilization.report.select.js.map