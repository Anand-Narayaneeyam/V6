...
import { SchedulingReportSeatUtilizationComponent } from './scheduling.seatutilization.report';


@Component({
    selector: 'SeatUtilization',
    templateUrl: './app/Views/Reports/Scheduling/SeatUtilization/scheduling.seatutilization.select.html',
    directives: [Notification, DateTimeComponent, PageComponent, TabsComponent, TabComponent, SubMenu, SchedulingReportSeatUtilizationComponent],
    providers: [SchedulingService, NotificationService],
})

export class SeatUtilizationComponent implements OnInit {
    ...
    pagePath: any = "Reports / Scheduling / Workspace Utilization";
