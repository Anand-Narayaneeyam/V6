...
var SchedulingReportAllUserReservationData = (function () {
    function SchedulingReportAllUserReservationData(commonreportservice) {
    ...
    SchedulingReportAllUserReservationData.prototype.ngOnInit = function () {
        this.pagePath = "Reports / Scheduling / All User Reservation Data";
        this.LoadReportData();
    };
    SchedulingReportAllUserReservationData.prototype.LoadReportData = function () {
        this.ReportData = { ModuleId: 0, ReportCategoryId: 0, ExportFileName: "", ReportTitle: "", ReportSubTitle: "", ListReportFieldIdValues: [] };
    ...
    SchedulingReportAllUserReservationData = __decorate([
        core_1.Component({
    ...
    ], SchedulingReportAllUserReservationData);
    return SchedulingReportAllUserReservationData;
}());
exports.SchedulingReportAllUserReservationData = SchedulingReportAllUserReservationData;
//# sourceMappingURL=scheduling.alluserreservationdata.report.js.map