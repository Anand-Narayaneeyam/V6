...
import { SchedulingReportDailySeatUtilizationComponent } from './scheduling.dailyseatutilization.report';
...
@Component({
    ...
    directives: [Notification, DateTimeComponent, PageComponent, TabsComponent, TabComponent, SubMenu, SchedulingReportDailySeatUtilizationComponent],
    providers: [SchedulingService, NotificationService],
})

export class DailySeatUtilizationComponent implements OnInit {
    ...
    pagePath: any = "Reports / Scheduling / Daily Workspace Utilization";
