...
var SchedulingReportDailySeatUtilizationComponent = (function () {
    function SchedulingReportDailySeatUtilizationComponent(commonreportservice) {
    ...
    SchedulingReportDailySeatUtilizationComponent.prototype.ngOnInit = function () {
        this.LoadReportData();
        this.pagePath = "Reports / Scheduling / Daily Workspace Utilization";
    };
    SchedulingReportDailySeatUtilizationComponent.prototype.LoadReportData = function () {
        this.ReportData = { ModuleId: 0, ReportCategoryId: 0, ExportFileName: "", ReportTitle: "", ReportSubTitle: "", ListReportFieldIdValues: [] };
    ...
    SchedulingReportDailySeatUtilizationComponent = __decorate([
        core_1.Component({
    ...
    ], SchedulingReportDailySeatUtilizationComponent);
    return SchedulingReportDailySeatUtilizationComponent;
}());
exports.SchedulingReportDailySeatUtilizationComponent = SchedulingReportDailySeatUtilizationComponent;
//# sourceMappingURL=scheduling.dailyseatutilization.report.js.map