...
import { SchedulingReportSeatBookingRequestDetails } from './scheduling.seatbookreqdetails.report';
...
@Component({
    ...
    directives: [Notification, DateComponent, PageComponent, TabsComponent, TabComponent, SubMenu, SchedulingReportSeatBookingRequestDetails],
    providers: [SchedulingService, NotificationService],
})

export class SeatBookingRequestDetails implements OnInit {
    ...
    UserRoleId: any = 0;
    pagePath: any = "Reports / Scheduling / Workspace Reservation Details";
    seattxt = "Workspace";
    ...
    ngOnInit() {
        ...
        contextObj.schedulingService.checkSubscribedFeature('274').subscribe(function (result) {//275
