...
var scheduling_roombookreqdetailsbyuser_report_1 = require('./scheduling.roombookreqdetailsbyuser.report');
var RoomBookingRequestDetailsByUser = (function () {
    function RoomBookingRequestDetailsByUser(notificationService, schedulingService, generFun) {
        ...
        this.pagePath = "Reports / Scheduling / Room Reservation Details by User";
        this.roomtxt = "Room";
    }
    RoomBookingRequestDetailsByUser.prototype.ngOnInit = function () {
        this.menuData = [
            {
                "id": 0,
                "title": "Show Report",
    ...
    RoomBookingRequestDetailsByUser.prototype.onSubMenuChange = function (event) {
        this.nextClicked = false;
    ...
    RoomBookingRequestDetailsByUser.prototype.getSelectedTab = function (event) {
        if (event[0] == 0) {
            this.selectedTab = 0;
    ...
    RoomBookingRequestDetailsByUser = __decorate([
        core_1.Component({
            ...
            directives: [notify_component_1.Notification, datecomponent_component_1.DateComponent, page_component_1.PageComponent, tabs_component_1.TabsComponent, tab_component_1.TabComponent, submenu_component_1.SubMenu, scheduling_roombookreqdetailsbyuser_report_1.SchedulingReportRoomBookingRequestDetailsByUser],
    ...
    ], RoomBookingRequestDetailsByUser);
    return RoomBookingRequestDetailsByUser;
}());
exports.RoomBookingRequestDetailsByUser = RoomBookingRequestDetailsByUser;
//# sourceMappingURL=scheduling.roombookreqdetailsbyuser.select.js.map