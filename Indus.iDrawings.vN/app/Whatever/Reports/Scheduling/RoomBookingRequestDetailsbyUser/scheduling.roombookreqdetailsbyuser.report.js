...
var SchedulingReportRoomBookingRequestDetailsByUser = (function () {
    function SchedulingReportRoomBookingRequestDetailsByUser(commonreportservice, SchedulingService) {
    ...
    SchedulingReportRoomBookingRequestDetailsByUser.prototype.ngOnInit = function () {
        var contextObj = this;
    ...
    SchedulingReportRoomBookingRequestDetailsByUser.prototype.LoadReportData = function () {
        this.ReportData = { ModuleId: 0, ReportCategoryId: 0, ExportFileName: "", ReportTitle: "", ReportSubTitle: "", ListReportFieldIdValues: [] };
        var arrRptFieldIds = new Array();
        this.ReportData.ModuleId = 14;
        this.ReportData.ReportCategoryId = 414;
        this.ReportData.ExportFileName = this.roomtxt + " Reservation Details by User";
        this.ReportData.ReportTitle = this.roomtxt + " Reservation Details by User";
    ...
    SchedulingReportRoomBookingRequestDetailsByUser = __decorate([
        core_1.Component({
            selector: 'SchedulingReport-RoomBookingRequestDetailsByUser',
    ...
    ], SchedulingReportRoomBookingRequestDetailsByUser);
    return SchedulingReportRoomBookingRequestDetailsByUser;
}());
exports.SchedulingReportRoomBookingRequestDetailsByUser = SchedulingReportRoomBookingRequestDetailsByUser;
//# sourceMappingURL=scheduling.roombookreqdetailsbyuser.report.js.map