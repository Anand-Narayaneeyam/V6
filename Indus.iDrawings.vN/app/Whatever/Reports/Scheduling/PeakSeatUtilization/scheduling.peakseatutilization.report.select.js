...
var scheduling_peakseatutilization_report_1 = require('./scheduling.peakseatutilization.report');
var PeakSeatUtilizationComponent = (function () {
    function PeakSeatUtilizationComponent(notificationService, schedulingService, generFun) {
    ...
    PeakSeatUtilizationComponent.prototype.ngOnInit = function () {
        this.menuData = [
            {
                "id": 0,
                "title": "Show Report",
    ...
    PeakSeatUtilizationComponent.prototype.onSubMenuChange = function (event) {
        this.nextClicked = false;
    ...
    PeakSeatUtilizationComponent.prototype.getSelectedTab = function (event) {
        if (event[0] == 0) {
            this.selectedTab = 0;
    ...
    PeakSeatUtilizationComponent.prototype.setPrevMonthsDate = function () {
    ...
    PeakSeatUtilizationComponent = __decorate([
        core_1.Component({
            ...
            directives: [notify_component_1.Notification, datetimecomponent_component_1.DateTimeComponent, page_component_1.PageComponent, tabs_component_1.TabsComponent, tab_component_1.TabComponent, submenu_component_1.SubMenu, scheduling_peakseatutilization_report_1.SchedulingReportPeakSeatUtilizationComponent],
    ...
    ], PeakSeatUtilizationComponent);
    return PeakSeatUtilizationComponent;
}());
exports.PeakSeatUtilizationComponent = PeakSeatUtilizationComponent;
//# sourceMappingURL=scheduling.peakseatutilization.report.select.js.map