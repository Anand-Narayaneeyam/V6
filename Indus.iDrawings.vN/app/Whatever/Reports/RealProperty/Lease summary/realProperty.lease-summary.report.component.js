...
var realPropertyLeaseSummaryReport = (function () {
    function realPropertyLeaseSummaryReport(commonService, notificationService) {
    ...
    realPropertyLeaseSummaryReport.prototype.ngOnInit = function () {
        this.pagePath = "Reports / Real Property / Lease Summary";
        this.LoadReportData(0);
    };
    realPropertyLeaseSummaryReport.prototype.LoadReportData = function (IsCustomize) {
        this.ReportData = { ModuleId: 0, ReportCategoryId: 0, ExportFileName: "", ReportTitle: "", ReportSubTitle: "", ListReportFieldIdValues: [] };
        var arrRptFieldIds = new Array();
        this.ReportData.ModuleId = 30;
        this.ReportData.ReportCategoryId = 240;
        this.ReportData.ExportFileName = "Lease Summary";
        this.ReportData.ReportTitle = "Lease Summary";
    ...
    realPropertyLeaseSummaryReport.prototype.customizeClick = function (event) {
        var contextObj = this;
    ...
    realPropertyLeaseSummaryReport.prototype.onSplitViewClose = function (event) {
        this.splitviewInput.showSecondaryView = false;
    };
    realPropertyLeaseSummaryReport.prototype.applyCustomRptClick = function (event) {
        this.splitviewInput.showSecondaryView = false;
        var contexObj = this;
    ...
    realPropertyLeaseSummaryReport = __decorate([
        core_1.Component({
            selector: 'realProperty.LeaseSummary.report',
            templateUrl: './app/Views/Reports/RealProperty/LeaseSummary/rpm.leasesummary.report.html',
    ...
    ], realPropertyLeaseSummaryReport);
    return realPropertyLeaseSummaryReport;
}());
exports.realPropertyLeaseSummaryReport = realPropertyLeaseSummaryReport;
//# sourceMappingURL=realProperty.lease-summary.report.component.js.map