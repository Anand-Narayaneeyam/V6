...
var realPropertyCriticalDatesReport = (function () {
    function realPropertyCriticalDatesReport(commonService, notificationService) {
    ...
    realPropertyCriticalDatesReport.prototype.ngOnInit = function () {
        this.pagePath = "Reports / Real Property / Critical Dates";
        this.LoadReportData(0);
    };
    realPropertyCriticalDatesReport.prototype.LoadReportData = function (IsCustomize) {
        this.ReportData = { ModuleId: 0, ReportCategoryId: 0, ExportFileName: "", ReportTitle: "", ReportSubTitle: "", ListReportFieldIdValues: [] };
        var arrRptFieldIds = new Array();
        this.ReportData.ModuleId = 30;
        this.ReportData.ReportCategoryId = 239;
        this.ReportData.ExportFileName = "Critical Dates";
        this.ReportData.ReportTitle = "Critical Dates";
    ...
    realPropertyCriticalDatesReport.prototype.customizeClick = function (event) {
        var contextObj = this;
    ...
    realPropertyCriticalDatesReport.prototype.onSplitViewClose = function (event) {
        this.splitviewInput.showSecondaryView = false;
    };
    realPropertyCriticalDatesReport.prototype.applyCustomRptClick = function (event) {
        this.splitviewInput.showSecondaryView = false;
        var contexObj = this;
    ...
    realPropertyCriticalDatesReport = __decorate([
        core_1.Component({
            selector: 'realProperty.CriticalDates.report',
            templateUrl: './app/Views/Reports/RealProperty/CriticalDates/rpm.criticaldates.report.html',
    ...
    ], realPropertyCriticalDatesReport);
    return realPropertyCriticalDatesReport;
}());
exports.realPropertyCriticalDatesReport = realPropertyCriticalDatesReport;
//# sourceMappingURL=realProperty.critical-dates.report.component.js.map