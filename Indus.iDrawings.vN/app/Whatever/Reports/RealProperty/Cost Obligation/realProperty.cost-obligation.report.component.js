...
var realPropertyCostObligationReport = (function () {
    function realPropertyCostObligationReport(commonService, notificationService) {
    ...
    realPropertyCostObligationReport.prototype.ngOnInit = function () {
        this.pagePath = "Reports / Real Property / Cost Obligations";
        this.LoadReportData(0);
    };
    realPropertyCostObligationReport.prototype.LoadReportData = function (IsCustomize) {
        this.ReportData = { ModuleId: 0, ReportCategoryId: 0, ExportFileName: "", ReportTitle: "", ReportSubTitle: "", ListReportFieldIdValues: [] };
        var arrRptFieldIds = new Array();
        this.ReportData.ModuleId = 30;
        this.ReportData.ReportCategoryId = 314;
        this.ReportData.ExportFileName = "Cost Obligation";
        this.ReportData.ReportTitle = "Cost Obligation";
    ...
    realPropertyCostObligationReport.prototype.customizeClick = function (event) {
        var contextObj = this;
    ...
    realPropertyCostObligationReport.prototype.onSplitViewClose = function (event) {
        this.splitviewInput.showSecondaryView = false;
    };
    realPropertyCostObligationReport.prototype.applyCustomRptClick = function (event) {
        this.splitviewInput.showSecondaryView = false;
        var contexObj = this;
    ...
    realPropertyCostObligationReport = __decorate([
        core_1.Component({
            selector: 'realProperty.CostObligation.report',
            templateUrl: './app/Views/Reports/RealProperty/CostObligation/rpm.costobligation.report.html',
    ...
    ], realPropertyCostObligationReport);
    return realPropertyCostObligationReport;
}());
exports.realPropertyCostObligationReport = realPropertyCostObligationReport;
//# sourceMappingURL=realProperty.cost-obligation.report.component.js.map