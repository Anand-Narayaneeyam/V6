...
var employees_underoccupiedspaces_report_component_1 = require('../UnderOccupiedSpaces/employees.underoccupiedspaces.report.component');
...
var EmployeesUnderOccupiedSpacesTreeComponent = (function () {
    function EmployeesUnderOccupiedSpacesTreeComponent(commonreportservice) {
        this.commonreportservice = commonreportservice;
        this.ddlcriteriareport = undefined;
        this.selectedCriteria = 3;
        this.ReportCategoryId = 101;
    ...
    EmployeesUnderOccupiedSpacesTreeComponent.prototype.ngOnInit = function () {
        var contexObj = this;
        var id = 1;
    ...
    EmployeesUnderOccupiedSpacesTreeComponent.prototype.onChangeType = function (event) {
    ...
    EmployeesUnderOccupiedSpacesTreeComponent.prototype.submit = function (value) {
        this.isInitialised = false;
        this.next = value;
        var contexObj = this;
        setTimeout(function () {
    ...
    EmployeesUnderOccupiedSpacesTreeComponent.prototype.getSelectedTab = function (event) {
        this.selectedTab = event[0];
    };
    EmployeesUnderOccupiedSpacesTreeComponent.prototype.Selected = function (event) {
        this.isInitialised = false;
        var newselectedIds = '';
    ...
    EmployeesUnderOccupiedSpacesTreeComponent = __decorate([
        core_1.Component({
            selector: 'employee-detailedoccupancytree-report',
            templateUrl: './app/Views/Reports/Employee/UnderOccupiedSpacesTree/employees.underoccupiedspacestree.report.html',
            directives: [tabs_component_1.TabsComponent, tab_component_1.TabComponent, floorselection_report_component_1.FloorSelectionReportComponent, employees_underoccupiedspaces_report_component_1.EmployeesUnderOccupiedSpacesComponent, dropdownlistcomponent_component_1.DropDownListComponent, select_orgunit_report_component_1.SelectOrgUnitReportComponent],
            providers: [common_service_1.CommonReportService]
        }), 
        __metadata('design:paramtypes', [common_service_1.CommonReportService])
    ], EmployeesUnderOccupiedSpacesTreeComponent);
    return EmployeesUnderOccupiedSpacesTreeComponent;
}());
exports.EmployeesUnderOccupiedSpacesTreeComponent = EmployeesUnderOccupiedSpacesTreeComponent;
//# sourceMappingURL=employees.underoccupiedspacestree.report.component.js.map