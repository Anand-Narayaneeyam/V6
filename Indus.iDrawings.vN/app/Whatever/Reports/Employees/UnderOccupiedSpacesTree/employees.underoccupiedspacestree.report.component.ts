...
import {EmployeesUnderOccupiedSpacesComponent} from '../UnderOccupiedSpaces/employees.underoccupiedspaces.report.component'
...
@Component({
    ...
    directives: [TabsComponent, TabComponent, FloorSelectionReportComponent, EmployeesUnderOccupiedSpacesComponent, DropDownListComponent, SelectOrgUnitReportComponent],
    providers: [CommonReportService]
})


export class EmployeesUnderOccupiedSpacesTreeComponent implements OnInit {
    ddlcriteriareport: IField = undefined;
    alignContent: string;
    selectedCriteria: number = 3;
    ReportCategoryId: number = 101;
