...
export class EmployeesNominallyOccupiedSpacesComponent implements OnInit, IReportDataEntity {
    ...
    ngOnInit() {
        ...
        switch (this.reportBy) {
            case 1: this.ReportData.ReportTitle = "Nominally Occupied Spaces by Site ";
                this.ReportData.ExportFileName = "Nominally Occupied Spaces by Site ";
                break;
            case 2: this.ReportData.ReportTitle = "Nominally Occupied Spaces by Building";
                this.ReportData.ExportFileName = "Nominally Occupied Spaces by Building";
                break;
            case 3: this.ReportData.ReportTitle = "Nominally Occupied Spaces by Floor ";
                this.ReportData.ExportFileName = "Nominally Occupied Spaces by Floor ";
                break;
            case 14: this.ReportData.ReportTitle ="Nominally Occupied Spaces by " + this.orgName;;
                this.ReportData.ExportFileName = "Nominally Occupied Spaces by " + this.orgName;
                this.reportBy = 4;
                break;
            default: this.ReportData.ReportTitle = "Nominally Occupied Spaces by Floor";
                this.ReportData.ExportFileName = "Nominally Occupied Spaces by Floor";
                break;
        }
