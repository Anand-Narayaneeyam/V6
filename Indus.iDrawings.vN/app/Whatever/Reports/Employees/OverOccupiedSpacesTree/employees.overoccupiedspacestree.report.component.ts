...
import {EmployeesOverOccupiedSpacesComponent} from '../OverOccupiedSpaces/employees.overoccupiedspaces.report.component'
...
@Component({
    ...
    directives: [TabsComponent, TabComponent, FloorSelectionReportComponent, EmployeesOverOccupiedSpacesComponent, DropDownListComponent, SelectOrgUnitReportComponent],
    providers: [CommonReportService]
})


export class EmployeesOverOccupiedSpacesTreeComponent implements OnInit {
    ddlcriteriareport: IField = undefined;
    alignContent: string;
    selectedCriteria: number = 3;
    ReportCategoryId: number = 102;
