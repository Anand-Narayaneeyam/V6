...
var employees_detailedoccupancy_report_component_1 = require('../DetailedOccupancyReports/employees.detailedoccupancy.report.component');
...
var EmployeesDetailedOccupancyReportsTreeComponent = (function () {
    function EmployeesDetailedOccupancyReportsTreeComponent(commonreportservice) {
        this.commonreportservice = commonreportservice;
        this.ddlcriteriareport = undefined;
        this.selectedCriteria = 3;
        this.ReportCategoryId = 100;
    ...
    EmployeesDetailedOccupancyReportsTreeComponent.prototype.ngOnInit = function () {
        var contexObj = this;
        var id = 1;
    ...
    EmployeesDetailedOccupancyReportsTreeComponent.prototype.onChangeType = function (event) {
    ...
    EmployeesDetailedOccupancyReportsTreeComponent.prototype.submit = function (value) {
        this.isInitialised = false;
        this.next = value;
        var contexObj = this;
        setTimeout(function () {
    ...
    EmployeesDetailedOccupancyReportsTreeComponent.prototype.getSelectedTab = function (event) {
        this.selectedTab = event[0];
    };
    EmployeesDetailedOccupancyReportsTreeComponent.prototype.Selected = function (event) {
        this.isInitialised = false;
        var newselectedIds = '';
    ...
    EmployeesDetailedOccupancyReportsTreeComponent = __decorate([
        core_1.Component({
            ...
            directives: [tabs_component_1.TabsComponent, tab_component_1.TabComponent, floorselection_report_component_1.FloorSelectionReportComponent, employees_detailedoccupancy_report_component_1.EmployeesDetailedOccupancyReportsComponent, dropdownlistcomponent_component_1.DropDownListComponent, select_orgunit_report_component_1.SelectOrgUnitReportComponent],
            providers: [common_service_1.CommonReportService]
        }), 
        __metadata('design:paramtypes', [common_service_1.CommonReportService])
    ], EmployeesDetailedOccupancyReportsTreeComponent);
    return EmployeesDetailedOccupancyReportsTreeComponent;
}());
exports.EmployeesDetailedOccupancyReportsTreeComponent = EmployeesDetailedOccupancyReportsTreeComponent;
//# sourceMappingURL=employees.detailedoccupancytree.report.component.js.map