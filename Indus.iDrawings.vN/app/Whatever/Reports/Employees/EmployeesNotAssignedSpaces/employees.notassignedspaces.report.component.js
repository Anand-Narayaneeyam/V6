...
var EmployeesNotAssignedSpacesComponent = (function () {
    function EmployeesNotAssignedSpacesComponent(commonService, notificationService) {
    ...
    EmployeesNotAssignedSpacesComponent.prototype.ngOnInit = function () {
        this.pagePath = "Reports / Employees / Unassigned Employees";
        this.LoadReportData(0);
    };
    EmployeesNotAssignedSpacesComponent.prototype.LoadReportData = function (IsCustomize) {
        this.ReportData = { ModuleId: 0, ReportCategoryId: 0, ExportFileName: "", ReportTitle: "", ReportSubTitle: "", ListReportFieldIdValues: [] };
        var arrRptFieldIds = new Array();
        this.ReportData.ModuleId = 5;
        this.ReportData.ReportCategoryId = 46;
        this.ReportData.ExportFileName = "UnassignedEmployeesReport";
        this.ReportData.ReportTitle = "Unassigned Employees";
    ...
    EmployeesNotAssignedSpacesComponent.prototype.customizeClick = function (event) {
        var contextObj = this;
    ...
    EmployeesNotAssignedSpacesComponent.prototype.onSplitViewClose = function (event) {
        this.splitviewInput.showSecondaryView = false;
    };
    EmployeesNotAssignedSpacesComponent.prototype.applyCustomRptClick = function (event) {
        this.splitviewInput.showSecondaryView = false;
        var contexObj = this;
    ...
    EmployeesNotAssignedSpacesComponent = __decorate([
        core_1.Component({
            selector: 'employees-NotAssignedSpacesReport',
            templateUrl: './app/Views/Reports/Employee/EmployeesNotAssignedSpaces/employees.notassignedspaces.report.html',
    ...
    ], EmployeesNotAssignedSpacesComponent);
    return EmployeesNotAssignedSpacesComponent;
}());
exports.EmployeesNotAssignedSpacesComponent = EmployeesNotAssignedSpacesComponent;
//# sourceMappingURL=employees.notassignedspaces.report.component.js.map