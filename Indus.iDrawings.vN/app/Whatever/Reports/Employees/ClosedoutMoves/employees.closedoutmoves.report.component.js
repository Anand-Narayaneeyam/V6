...
var EmployeesClosedoutMovesComponent = (function () {
    function EmployeesClosedoutMovesComponent(commonService, notificationService) {
    ...
    EmployeesClosedoutMovesComponent.prototype.ngOnInit = function () {
        var CommonService;
        this.LoadReportData(0);
        this.pagePath = "Reports / Employees / Closed-out Moves";
        this.checkForScheduledReport();
    };
    EmployeesClosedoutMovesComponent.prototype.LoadReportData = function (IsCustomize) {
        this.ReportData = { ModuleId: 0, ReportCategoryId: 0, ExportFileName: "", ReportTitle: "", ReportSubTitle: "", ListReportFieldIdValues: [] };
        var contexObj = this;
        var arrRptFieldIds = new Array();
        this.ReportData.ModuleId = 5;
        this.ReportData.ReportCategoryId = 55;
        this.ReportData.ExportFileName = "EmployeeMoveDetailsReport(Closed-out Moves)";
        this.ReportData.ReportTitle = "Employee Move Details Report (Closed-out Moves)";
    ...
    EmployeesClosedoutMovesComponent.prototype.showSheduleReport = function (event) {
        debugger;
        var contextObj = this;
    ...
    EmployeesClosedoutMovesComponent.prototype.handleInsertSuccess = function (event) {
        this.splitviewInput.showSecondaryView = false;
    };
    EmployeesClosedoutMovesComponent.prototype.checkForScheduledReport = function () {
        var contextObj = this;
    ...
    EmployeesClosedoutMovesComponent.prototype.onSplitViewClose = function (event) {
        this.splitviewInput.showSecondaryView = false;
        this.showSheduleReportAddEdit = false;
        this.showCustomize = false;
    };
    EmployeesClosedoutMovesComponent.prototype.customizeClick = function (event) {
        this.showSheduleReportAddEdit = false;
        var contextObj = this;
    ...
    EmployeesClosedoutMovesComponent.prototype.applyCustomRptClick = function (event) {
        this.splitviewInput.showSecondaryView = false;
        this.showSheduleReportAddEdit = false;
        this.showCustomize = false;
        var contexObj = this;
    ...
    EmployeesClosedoutMovesComponent = __decorate([
        core_1.Component({
            selector: 'employees-ClosedoutMoves',
            templateUrl: './app/Views/Reports/Employee/ClosedoutMoves/employees.closedoutmoves.report.html',
    ...
    ], EmployeesClosedoutMovesComponent);
    return EmployeesClosedoutMovesComponent;
}());
exports.EmployeesClosedoutMovesComponent = EmployeesClosedoutMovesComponent;
//# sourceMappingURL=employees.closedoutmoves.report.component.js.map