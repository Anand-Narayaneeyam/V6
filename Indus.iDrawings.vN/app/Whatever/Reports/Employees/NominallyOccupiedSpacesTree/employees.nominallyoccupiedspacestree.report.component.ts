...
import {EmployeesNominallyOccupiedSpacesComponent} from '../NominallyOccupiedSpaces/employees.nominallyoccupiedspaces.report.component'
...
@Component({
    ...
    directives: [TabsComponent, TabComponent, FloorSelectionReportComponent, EmployeesNominallyOccupiedSpacesComponent, DropDownListComponent, SelectOrgUnitReportComponent],
