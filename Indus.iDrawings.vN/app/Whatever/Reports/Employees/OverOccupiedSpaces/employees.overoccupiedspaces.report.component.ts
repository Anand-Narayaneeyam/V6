...
export class EmployeesOverOccupiedSpacesComponent implements OnInit, IReportDataEntity {
    ...
    ngOnInit() {
        ...
        switch (this.reportBy) {
            case 1: this.ReportData.ReportTitle = "Over Occupied Spaces by Site ";
                this.ReportData.ExportFileName = "Over Occupied Spaces by Site ";
                break;
            case 2: this.ReportData.ReportTitle = "Over Occupied Spaces by Building";
                this.ReportData.ExportFileName = "Over Occupied Spaces by Building";
                break;
            case 3: this.ReportData.ReportTitle = "Over Occupied Spaces by Floor ";
                this.ReportData.ExportFileName = "Over Occupied Spaces by Floor ";
                break;
            case 14: this.ReportData.ReportTitle = "Over Occupied Spaces by " + this.orgName;;
                this.ReportData.ExportFileName = "Over Occupied Spaces by " + this.orgName;
                this.reportBy = 4;
                break;
            default: this.ReportData.ReportTitle = "Over Occupied Spaces by Floor";
                this.ReportData.ExportFileName = "Over Occupied Spaces by Floor";
                break;
        }
