...
var DocumentDetailsComponent = (function () {
    function DocumentDetailsComponent(commonreportservice, commonService, notificationService) {
    ...
    DocumentDetailsComponent.prototype.ngOnInit = function () {
        var contexObj = this;
        this.pagePath = "Reports / Documents / Documents";
        contexObj.LoadReportData(0);
    };
    DocumentDetailsComponent.prototype.LoadReportData = function (IsCustomize) {
        this.ReportData = { ModuleId: 0, ReportCategoryId: 0, ExportFileName: "", ReportTitle: "", ReportSubTitle: "", ListReportFieldIdValues: [] };
        var contexObj = this;
        var arrRptFieldIds = new Array();
        this.ReportData.ModuleId = 4;
        this.ReportData.ReportCategoryId = 63;
        this.ReportData.ExportFileName = "Documents";
        this.ReportData.ReportTitle = "Documents";
    ...
    DocumentDetailsComponent.prototype.customizeClick = function (event) {
        var contextObj = this;
    ...
    DocumentDetailsComponent.prototype.onSplitViewClose = function (event) {
        this.splitviewInput.showSecondaryView = false;
    };
    DocumentDetailsComponent.prototype.applyCustomRptClick = function (event) {
        this.splitviewInput.showSecondaryView = false;
        var contexObj = this;
    ...
    DocumentDetailsComponent = __decorate([
        core_1.Component({
            selector: 'documentdetails-report',
            templateUrl: './app/Views/Reports/Documents/DocumentDetails/documentdetails.report.html',
            ...
            providers: [common_service_2.CommonService, notify_service_1.NotificationService, common_service_1.CommonReportService]
        }), 
...
exports.DocumentDetailsComponent = DocumentDetailsComponent;
//# sourceMappingURL=documents.details.report.component.js.map