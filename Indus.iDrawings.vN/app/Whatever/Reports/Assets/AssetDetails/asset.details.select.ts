...
import {AssetDetailsComponent} from './asset.details.report'
...
@Component({
    ...
    directives: [PagingComponent, Notification, PageComponent, AssetDetailsComponent, ListBoxComponent, TabsComponent, TabComponent, SubMenu]
})

export class AssetDetailsSelect implements OnInit {
