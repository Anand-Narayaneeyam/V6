...
var asset_listbyclass_report_1 = require('./asset.listbyclass.report');
var tabs_component_1 = require('../../../../Framework/Whatever/Tab/tabs.component');
var tab_component_1 = require('../../../../Framework/Whatever/Tab/tab.component');
var submenu_component_1 = require('../../../../Framework/Whatever/Submenu/submenu.component');
var AssetListbyClassSelect = (function () {
    function AssetListbyClassSelect(commonreportservice, notificationService) {
    ...
    AssetListbyClassSelect.prototype.ngOnInit = function () {
        this.menuData = [
            {
                "id": 0,
                "title": "Show Report",
    ...
    AssetListbyClassSelect.prototype.getListBoxData = function (event) {
    ...
    AssetListbyClassSelect.prototype.onSubMenuChange = function (event) {
        this.isNextClicked = false;
    ...
    AssetListbyClassSelect.prototype.getSelectedTab = function (event) {
        this.selectedTab = event[0];
    };
    __decorate([
        core_1.Output(), 
        __metadata('design:type', Object)
    ], AssetListbyClassSelect.prototype, "onSubmitClick", void 0);
    AssetListbyClassSelect = __decorate([
        core_1.Component({
            ...
            directives: [paging_component_1.PagingComponent, notify_component_1.Notification, page_component_1.PageComponent, asset_listbyclass_report_1.AssetListbyClassComponent, listboxcomponent_component_1.ListBoxComponent, tabs_component_1.TabsComponent, tab_component_1.TabComponent, submenu_component_1.SubMenu]
        }), 
        __metadata('design:paramtypes', [common_service_1.CommonReportService, notify_service_1.NotificationService])
    ], AssetListbyClassSelect);
    return AssetListbyClassSelect;
}());
exports.AssetListbyClassSelect = AssetListbyClassSelect;
//# sourceMappingURL=asset.listbyclass.select.js.map