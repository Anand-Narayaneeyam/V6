...
var AssetListbyClassComponent = (function () {
    function AssetListbyClassComponent(commonService, notificationService) {
    ...
    AssetListbyClassComponent.prototype.ngOnInit = function () {
        this.LoadReportData(0);
        this.pagePath = "Reports / Assets / Asset List by Class";
    };
    AssetListbyClassComponent.prototype.LoadReportData = function (IsCustomize) {
        this.ReportData = { ModuleId: 0, ReportCategoryId: 0, ExportFileName: "", ReportTitle: "", ReportSubTitle: "", ListReportFieldIdValues: [] };
        var arrRptFieldIds = new Array();
        this.ReportData.ModuleId = 7;
        this.ReportData.ReportCategoryId = 74;
        this.ReportData.ExportFileName = "Asset List by Class";
        this.ReportData.ReportTitle = "Asset List by Class";
    ...
    AssetListbyClassComponent.prototype.customizeClick = function (event) {
        var contextObj = this;
    ...
    AssetListbyClassComponent.prototype.onSplitViewClose = function (event) {
        this.splitviewInput.showSecondaryView = false;
    };
    AssetListbyClassComponent.prototype.applyCustomRptClick = function (event) {
        this.splitviewInput.showSecondaryView = false;
        var contexObj = this;
    ...
    AssetListbyClassComponent = __decorate([
        core_1.Component({
            selector: 'assetListbyClass-report',
            templateUrl: './app/Views/Reports/Assets/AssetListByClass/asset.listbyclass.report.html',
    ...
    ], AssetListbyClassComponent);
    return AssetListbyClassComponent;
}());
exports.AssetListbyClassComponent = AssetListbyClassComponent;
//# sourceMappingURL=asset.listbyclass.report.js.map