...
var wo_servicereqfeedback_report_component_1 = require('./wo.servicereqfeedback.report.component');
...
var WOSRFeedbackReportSelect = (function () {
    function WOSRFeedbackReportSelect(commonreportservice, notificationService) {
    ...
    WOSRFeedbackReportSelect.prototype.ngOnInit = function () {
        this.menuData = [
            {
                "id": 0,
                "title": "Show Report",
    ...
    WOSRFeedbackReportSelect.prototype.getdata = function () {
        var contextObj = this;
    ...
    WOSRFeedbackReportSelect.prototype.onChangeWorkType = function (event) {
    ...
    WOSRFeedbackReportSelect.prototype.onSubMenuChange = function (event) {
        this.isnext = undefined;
        this.isNextClicked = false;
    ...
    WOSRFeedbackReportSelect.prototype.getSelectedTab = function (event) {
        if (event[0] == 0) {
            this.selectedTab = 0;
    ...
    WOSRFeedbackReportSelect = __decorate([
        core_1.Component({
