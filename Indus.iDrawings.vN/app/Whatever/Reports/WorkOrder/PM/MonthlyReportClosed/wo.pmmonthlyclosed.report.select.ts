...
import { WOPMMonthlyClosedReportComponent } from './wo.pmmonthlyclosed.report.component';
...
@Component({
    ...
    directives: [Notification, PageComponent, DropDownListComponent, DateComponent, TabsComponent, TabComponent, SubMenu, WOPMMonthlyClosedReportComponent]
})

export class WOPMMonthlyClosedReportSelect implements OnInit {
