...
var wo_pmmonthlyclosed_report_component_1 = require('./wo.pmmonthlyclosed.report.component');
...
var WOPMMonthlyClosedReportSelect = (function () {
    function WOPMMonthlyClosedReportSelect(commonreportservice, notificationService) {
    ...
    WOPMMonthlyClosedReportSelect.prototype.ngOnInit = function () {
        this.menuData = [
            {
                "id": 0,
                "title": "Show Report",
        ...
        this.enableMenu = [0];
        this.pagePath = "Reports / Work Order / PM Work Orders / Monthly Report - Closed";
        var contextObj = this;
    ...
    WOPMMonthlyClosedReportSelect.prototype.getdata = function () {
        var contextObj = this;
    ...
    //    });
    //}
    WOPMMonthlyClosedReportSelect.prototype.onChangeWorkType = function (event) {
    ...
    WOPMMonthlyClosedReportSelect.prototype.onChangePriority = function (event) {
    ...
    WOPMMonthlyClosedReportSelect.prototype.onSubMenuChange = function (event) {
        this.isnext = undefined;
        this.isNextClicked = false;
    ...
    WOPMMonthlyClosedReportSelect.prototype.getSelectedTab = function (event) {
        if (event[0] == 0) {
            this.selectedTab = 0;
    ...
    WOPMMonthlyClosedReportSelect = __decorate([
        core_1.Component({
            selector: 'wo-pmmonthlyclosed-report',
            templateUrl: './app/Views/Reports/WorkOrder/PM/MonthlyReportClosed/wo.pmmonthlyclosedreport.select.html',
            providers: [common_service_1.CommonReportService, notify_service_1.NotificationService],
            directives: [notify_component_1.Notification, page_component_1.PageComponent, dropdownlistcomponent_component_1.DropDownListComponent, datecomponent_component_1.DateComponent, tabs_component_1.TabsComponent, tab_component_1.TabComponent, submenu_component_1.SubMenu, wo_pmmonthlyclosed_report_component_1.WOPMMonthlyClosedReportComponent]
        }), 
        __metadata('design:paramtypes', [common_service_1.CommonReportService, notify_service_1.NotificationService])
    ], WOPMMonthlyClosedReportSelect);
    return WOPMMonthlyClosedReportSelect;
}());
exports.WOPMMonthlyClosedReportSelect = WOPMMonthlyClosedReportSelect;
//# sourceMappingURL=wo.pmmonthlyclosed.report.select.js.map