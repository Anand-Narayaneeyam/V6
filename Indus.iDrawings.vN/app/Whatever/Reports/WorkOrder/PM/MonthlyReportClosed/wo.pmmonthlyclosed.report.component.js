...
var WOPMMonthlyClosedReportComponent = (function () {
    function WOPMMonthlyClosedReportComponent(commonreportservice, commonService) {
    ...
    WOPMMonthlyClosedReportComponent.prototype.ngOnInit = function () {
        var contextObj = this;
    ...
    WOPMMonthlyClosedReportComponent.prototype.LoadReportData = function () {
        this.ReportData = { ModuleId: 0, ReportCategoryId: 0, ExportFileName: "", ReportTitle: "", ReportSubTitle: "", ListReportFieldIdValues: [] };
        var contextObj = this;
        var arrRptFieldIds = new Array();
        this.ReportData.ModuleId = 9;
        this.ReportData.ReportCategoryId = 310;
    ...
    WOPMMonthlyClosedReportComponent.prototype.checkForScheduledReport = function () {
        var contextObj = this;
    ...
    WOPMMonthlyClosedReportComponent.prototype.showSheduleReport = function (event) {
        debugger;
        var contextObj = this;
    ...
    WOPMMonthlyClosedReportComponent.prototype.handleInsertSuccess = function (event) {
        this.splitviewInput.showSecondaryView = false;
    };
    WOPMMonthlyClosedReportComponent = __decorate([
        core_1.Component({
    ...
    return WOPMMonthlyClosedReportComponent;
}());
exports.WOPMMonthlyClosedReportComponent = WOPMMonthlyClosedReportComponent;
//# sourceMappingURL=wo.pmmonthlyclosed.report.component.js.map