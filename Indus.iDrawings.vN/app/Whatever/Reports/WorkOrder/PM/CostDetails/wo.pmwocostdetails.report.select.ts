...
import { WOPMCostDetailsReportComponent } from './wo.pmwocostdetails.report.component';
...
@Component({
    ...
    directives: [GridComponent, WOPMCostDetailsReportComponent, PagingComponent, Notification, PageComponent, TabsComponent, TabComponent, SubMenu, DropDownListComponent]
})

export class WOPMCostDetailsSelect implements OnInit {
