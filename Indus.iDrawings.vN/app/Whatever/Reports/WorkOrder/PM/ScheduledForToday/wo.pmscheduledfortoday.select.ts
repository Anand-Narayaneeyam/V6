...
import { WOPMScheduledForTodayReportComponent } from './wo.pmscheduledfortoday.component';
...
@Component({
    ...
    directives: [Notification, PageComponent, DropDownListComponent, TabsComponent, TabComponent, SubMenu, WOPMScheduledForTodayReportComponent]
})

export class WOPMScheduledForTodayReportSelect implements OnInit {
