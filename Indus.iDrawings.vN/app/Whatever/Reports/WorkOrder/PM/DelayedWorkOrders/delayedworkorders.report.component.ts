...
@Component({
    ...
    templateUrl: './app/Views/Reports/WorkOrder/PM/DelayedWorkOrders/delayedworkorders.showreport.html',
...
export class DelayedWorkOrdersComponent implements OnInit, IReportDataEntity {
    ...
    LoadReportData(IsCustomize) {
        ...
        this.ReportData.ReportCategoryId = 142;
