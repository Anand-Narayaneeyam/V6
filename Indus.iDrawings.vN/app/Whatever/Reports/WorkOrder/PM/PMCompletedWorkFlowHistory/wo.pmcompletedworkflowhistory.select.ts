...
import { WOPMCompletedWorkFlowHistoryReportComponent} from './wo.pmcompletedworkflowhistory.report.component';
...
@Component({
    ...
    directives: [GridComponent, WOPMCompletedWorkFlowHistoryReportComponent, PagingComponent, Notification, PageComponent, TabsComponent, TabComponent, SubMenu]
})

export class WOPMCompletedWorkFlowHistorySelect implements OnInit {
