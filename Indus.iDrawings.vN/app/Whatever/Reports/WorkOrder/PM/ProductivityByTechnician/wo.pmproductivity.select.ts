...
import { WOPMProductivityReportComponent } from './wo.pmproductivity.component';
...
@Component({
    ...
    directives: [Notification, PageComponent, DropDownListComponent, TabsComponent, TabComponent, SubMenu, WOPMProductivityReportComponent]
})

export class WOPMProductivityReportSelect implements OnInit {
