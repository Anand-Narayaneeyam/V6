...
var wo_pmweekly_report_component_1 = require('./wo.pmweekly.report.component');
...
var WOPMWeeklyReportSelect = (function () {
    function WOPMWeeklyReportSelect(commonreportservice, notificationService) {
    ...
    WOPMWeeklyReportSelect.prototype.ngOnInit = function () {
        this.menuData = [
            {
                "id": 0,
                "title": "Show Report",
    ...
    WOPMWeeklyReportSelect.prototype.getdata = function () {
        var contextObj = this;
    ...
    WOPMWeeklyReportSelect.prototype.setDates = function () {
        var contextObj = this;
    ...
    WOPMWeeklyReportSelect.prototype.onChangeWorkType = function (event) {
    ...
    WOPMWeeklyReportSelect.prototype.onChangePriority = function (event) {
    ...
    WOPMWeeklyReportSelect.prototype.onSubMenuChange = function (event) {
        this.isnext = undefined;
        this.isNextClicked = false;
    ...
    WOPMWeeklyReportSelect.prototype.getSelectedTab = function (event) {
        if (event[0] == 0) {
            this.selectedTab = 0;
