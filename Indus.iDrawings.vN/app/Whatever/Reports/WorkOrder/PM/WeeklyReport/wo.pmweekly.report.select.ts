...
import { WOPMWeeklyReportComponent } from './wo.pmweekly.report.component';
...
@Component({
    ...
    directives: [Notification, PageComponent, DropDownListComponent, DateComponent, TabsComponent, TabComponent, SubMenu, WOPMWeeklyReportComponent]
})

export class WOPMWeeklyReportSelect implements OnInit {
