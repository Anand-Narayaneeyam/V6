...
import { WOMonthlyPMSummaryReportComponent } from './wo.monthlypmsummary.report.component';
...
@Component({
    ...
    directives: [Notification, PageComponent, WOMonthlyPMSummaryReportComponent, DropDownListComponent, DateComponent, TabsComponent, TabComponent, SubMenu]
})

export class WOMonthlyPMSummarySelect implements OnInit {
