...
import { WOPMMonthlyOpenReportComponent } from './wo.pmmonthlyopen.report.component';
...
@Component({
    ...
    directives: [Notification, PageComponent, DropDownListComponent, DateComponent, TabsComponent, TabComponent, SubMenu, WOPMMonthlyOpenReportComponent]
})

export class WOPMMonthlyOpenReportSelect implements OnInit {
