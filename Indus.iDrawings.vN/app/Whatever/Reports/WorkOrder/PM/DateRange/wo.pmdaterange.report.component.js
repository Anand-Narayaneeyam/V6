...
var WOPMDateRangeReportComponent = (function () {
    function WOPMDateRangeReportComponent(commonreportservice, commonService, notificationService) {
    ...
    WOPMDateRangeReportComponent.prototype.ngOnInit = function () {
        var contextObj = this;
        contextObj.alignContent = "horizontal";
        this.pagePath = "Reports / Work Order / PM Work Orders / Work Orders by Date Range";
        contextObj.LoadReportData(0);
    };
    WOPMDateRangeReportComponent.prototype.LoadReportData = function (IsCustomize) {
        this.ReportData = { ModuleId: 0, ReportCategoryId: 0, ExportFileName: "", ReportTitle: "", ReportSubTitle: "", ListReportFieldIdValues: [] };
        var contextObj = this;
    ...
    WOPMDateRangeReportComponent.prototype.customizeClick = function (event) {
        var contextObj = this;
    ...
    WOPMDateRangeReportComponent.prototype.onSplitViewClose = function (event) {
        this.splitviewInput.showSecondaryView = false;
    };
    WOPMDateRangeReportComponent.prototype.applyCustomRptClick = function (event) {
        this.splitviewInput.showSecondaryView = false;
        var contexObj = this;
    ...
    WOPMDateRangeReportComponent = __decorate([
        core_1.Component({
    ...
    ], WOPMDateRangeReportComponent);
    return WOPMDateRangeReportComponent;
}());
exports.WOPMDateRangeReportComponent = WOPMDateRangeReportComponent;
//# sourceMappingURL=wo.pmdaterange.report.component.js.map