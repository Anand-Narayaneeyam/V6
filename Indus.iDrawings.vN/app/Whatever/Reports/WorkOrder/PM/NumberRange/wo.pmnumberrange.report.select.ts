...
import { WOPMNumberRangeReportComponent } from './wo.pmnumberrange.report.component';
...
@Component({
    ...
    directives: [Notification, PageComponent, StringTextBoxComponent, DropDownListComponent, TabsComponent, TabComponent, SubMenu, WOPMNumberRangeReportComponent]
})

export class WOPMNumberRangeReportSelect implements OnInit {
