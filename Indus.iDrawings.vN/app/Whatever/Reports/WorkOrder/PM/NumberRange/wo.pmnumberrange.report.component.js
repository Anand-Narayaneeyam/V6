...
var WOPMNumberRangeReportComponent = (function () {
    function WOPMNumberRangeReportComponent(commonreportservice, commonService, notificationService) {
    ...
    WOPMNumberRangeReportComponent.prototype.ngOnInit = function () {
        var contextObj = this;
        contextObj.alignContent = "horizontal";
        this.pagePath = "Reports / Work Order / PM Work Orders / Work Orders by Number Range";
        contextObj.LoadReportData(0);
    };
    WOPMNumberRangeReportComponent.prototype.LoadReportData = function (IsCustomize) {
        this.ReportData = { ModuleId: 0, ReportCategoryId: 0, ExportFileName: "", ReportTitle: "", ReportSubTitle: "", ListReportFieldIdValues: [] };
        var contextObj = this;
        var arrRptFieldIds = new Array();
        this.ReportData.ModuleId = 9;
        this.ReportData.ReportCategoryId = 139;
        this.ReportData.ExportFileName = "Work Orders by Number Range";
        this.ReportData.ReportTitle = "Work Orders by Number Range";
        ...
        arrRptFieldIds.push({
            ReportFieldId: 500086,
            Value: this.NumberFrom.toString()
        });
        arrRptFieldIds.push({
            ReportFieldId: 500087,
            Value: this.NumberTo.toString()
        });
        arrRptFieldIds.push({
            ReportFieldId: 1416,
    ...
    WOPMNumberRangeReportComponent.prototype.customizeClick = function (event) {
        var contextObj = this;
    ...
    WOPMNumberRangeReportComponent.prototype.onSplitViewClose = function (event) {
        this.splitviewInput.showSecondaryView = false;
    };
    WOPMNumberRangeReportComponent.prototype.applyCustomRptClick = function (event) {
        this.splitviewInput.showSecondaryView = false;
        var contexObj = this;
    ...
    WOPMNumberRangeReportComponent = __decorate([
        core_1.Component({
            selector: 'wo-pmnumberrange-report',
            templateUrl: './app/Views/Reports/WorkOrder/PM/NumberRange/wo.pmnumberrange.report.html',
            ...
            inputs: ['NumberFrom', 'NumberTo', 'WorkTypeId']
        }), 
    ...
    ], WOPMNumberRangeReportComponent);
    return WOPMNumberRangeReportComponent;
}());
exports.WOPMNumberRangeReportComponent = WOPMNumberRangeReportComponent;
//# sourceMappingURL=wo.pmnumberrange.report.component.js.map