...
var wo_srdaily_report_component_1 = require('./wo.srdaily.report.component');
...
var WOSRDailyReportSelect = (function () {
    function WOSRDailyReportSelect(commonreportservice, notificationService) {
    ...
    WOSRDailyReportSelect.prototype.ngOnInit = function () {
        this.menuData = [
            {
                "id": 0,
                "title": "Show Report",
    ...
    WOSRDailyReportSelect.prototype.getdata = function () {
        var contextObj = this;
    ...
    WOSRDailyReportSelect.prototype.onChangeWorkType = function (event) {
    ...
    WOSRDailyReportSelect.prototype.onChangePriority = function (event) {
    ...
    WOSRDailyReportSelect.prototype.onSubMenuChange = function (event) {
        this.isnext = undefined;
        this.isNextClicked = false;
    ...
    WOSRDailyReportSelect.prototype.getSelectedTab = function (event) {
        if (event[0] == 0) {
            this.selectedTab = 0;
    ...
    WOSRDailyReportSelect = __decorate([
        core_1.Component({
