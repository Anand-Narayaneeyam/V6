...
var WOSRScheduledForTodayReportComponent = (function () {
    function WOSRScheduledForTodayReportComponent(commonreportservice, commonService, notificationService) {
        this.commonreportservice = commonreportservice;
        this.commonService = commonService;
        this.notificationService = notificationService;
        this.ReportData = { ModuleId: 0, ReportCategoryId: 0, ExportFileName: "", ReportTitle: "", ReportSubTitle: "", ListReportFieldIdValues: [] };
        this.WorkTypeId = 0;
        this.reportCatId = 149;
        this.IsCustomRprt = 0;
    ...
    WOSRScheduledForTodayReportComponent.prototype.ngOnInit = function () {
        var contextObj = this;
    ...
    WOSRScheduledForTodayReportComponent.prototype.LoadReportData = function (IsCustomize) {
        this.ReportData = { ModuleId: 0, ReportCategoryId: 0, ExportFileName: "", ReportTitle: "", ReportSubTitle: "", ListReportFieldIdValues: [] };
        var contextObj = this;
    ...
    WOSRScheduledForTodayReportComponent.prototype.checkForScheduledReport = function () {
        var contextObj = this;
    ...
    WOSRScheduledForTodayReportComponent.prototype.showSheduleReport = function (event) {
        var contextObj = this;
    ...
    WOSRScheduledForTodayReportComponent.prototype.handleInsertSuccess = function (event) {
        this.splitviewInput.showSecondaryView = false;
    };
    WOSRScheduledForTodayReportComponent.prototype.onSplitViewClose = function (event) {
        this.splitviewInput.showSecondaryView = false;
        this.showSheduleReportAddEdit = false;
        this.showCustomize = false;
    };
    WOSRScheduledForTodayReportComponent.prototype.customizeClick = function (event) {
        this.showSheduleReportAddEdit = false;
        var contextObj = this;
    ...
    WOSRScheduledForTodayReportComponent.prototype.applyCustomRptClick = function (event) {
        this.splitviewInput.showSecondaryView = false;
        this.showSheduleReportAddEdit = false;
        this.showCustomize = false;
        var contexObj = this;
    ...
    WOSRScheduledForTodayReportComponent = __decorate([
        core_1.Component({
    ...
    ], WOSRScheduledForTodayReportComponent);
    return WOSRScheduledForTodayReportComponent;
}());
exports.WOSRScheduledForTodayReportComponent = WOSRScheduledForTodayReportComponent;
//# sourceMappingURL=wo.srscheduledfortoday.component.js.map