...
var WOSRMonthlyOpenReportComponent = (function () {
    function WOSRMonthlyOpenReportComponent(commonreportservice, commonService) {
    ...
    WOSRMonthlyOpenReportComponent.prototype.ngOnInit = function () {
        var contextObj = this;
    ...
    WOSRMonthlyOpenReportComponent.prototype.LoadReportData = function () {
        this.ReportData = { ModuleId: 0, ReportCategoryId: 0, ExportFileName: "", ReportTitle: "", ReportSubTitle: "", ListReportFieldIdValues: [] };
        var contextObj = this;
        var arrRptFieldIds = new Array();
        this.ReportData.ModuleId = 9;
        this.ReportData.ReportCategoryId = 267;
        this.ReportData.ExportFileName = "Monthly Report - Open";
        this.ReportData.ReportTitle = "Monthly Report - Open";
    ...
    WOSRMonthlyOpenReportComponent.prototype.checkForScheduledReport = function () {
        var contextObj = this;
    ...
    WOSRMonthlyOpenReportComponent.prototype.showSheduleReport = function (event) {
        debugger;
        var contextObj = this;
    ...
    WOSRMonthlyOpenReportComponent.prototype.handleInsertSuccess = function (event) {
        this.splitviewInput.showSecondaryView = false;
    };
    WOSRMonthlyOpenReportComponent = __decorate([
        core_1.Component({
            ...
            providers: [common_service_1.CommonReportService,
                common_service_2.CommonService],
    ...
    ], WOSRMonthlyOpenReportComponent);
    return WOSRMonthlyOpenReportComponent;
}());
exports.WOSRMonthlyOpenReportComponent = WOSRMonthlyOpenReportComponent;
//# sourceMappingURL=wo.srmonthlyopen.report.component.js.map