...
import { WOSRMonthlyOpenReportComponent } from './wo.srmonthlyopen.report.component';
...
@Component({
    ...
    directives: [Notification, PageComponent, DropDownListComponent, DateComponent, TabsComponent, TabComponent, SubMenu, WOSRMonthlyOpenReportComponent]
})

export class WOSRMonthlyOpenReportSelect implements OnInit {
