...
var wo_srcompletedworkflowhistory_report_component_1 = require('./wo.srcompletedworkflowhistory.report.component');
...
var WOSRCompletedWorkFlowHistorySelect = (function () {
    function WOSRCompletedWorkFlowHistorySelect(commonreportservice, notificationService) {
        this.commonreportservice = commonreportservice;
        this.notificationService = notificationService;
        this.equipmentCategoryId = 0;
        this.equipmentClassId = 0;
        this.inputItems = { dataKey: "WorkRequestId", groupBy: [], grpWithCheckBx: false, sortCol: "", sortDir: "", selectedIds: [], allowAdd: false, allowEdit: false };
        this.itemsPerPage = 0;
        this.pageIndex = 0;
    ...
    WOSRCompletedWorkFlowHistorySelect.prototype.ngOnInit = function () {
    ...
    WOSRCompletedWorkFlowHistorySelect.prototype.LoadData = function (target) {
        var contextObj = this;
    ...
    WOSRCompletedWorkFlowHistorySelect.prototype.onSubMenuChange = function (event) {
        this.isNextClicked = false;
    ...
    WOSRCompletedWorkFlowHistorySelect.prototype.onSort = function (objGrid) {
        this.LoadData(0);
    };
    WOSRCompletedWorkFlowHistorySelect.prototype.pageChanged = function (event) {
        this.pageIndex = event.pageEvent.page;
        this.LoadData(0);
    };
    WOSRCompletedWorkFlowHistorySelect.prototype.getSelectedTab = function (event) {
        this.selectedTab = event[0];
        if (event[0] == 0 && event[1] == true) {
            this.LoadData(0);
        }
    };
    WOSRCompletedWorkFlowHistorySelect = __decorate([
        core_1.Component({
            selector: 'workhistory-selector',
            templateUrl: './app/Views/Reports/WorkOrder/SR/SRCompletedWorkFlowHistory/wo.srcompletedworkflowhistory.select.html',
            providers: [common_service_1.CommonReportService, notify_service_1.NotificationService],
            directives: [grid_component_1.GridComponent, wo_srcompletedworkflowhistory_report_component_1.WOSRCompletedWorkFlowHistoryReportComponent, paging_component_1.PagingComponent, notify_component_1.Notification, page_component_1.PageComponent, tabs_component_1.TabsComponent, tab_component_1.TabComponent, submenu_component_1.SubMenu]
        }), 
        __metadata('design:paramtypes', [common_service_1.CommonReportService, notify_service_1.NotificationService])
    ], WOSRCompletedWorkFlowHistorySelect);
    return WOSRCompletedWorkFlowHistorySelect;
}());
exports.WOSRCompletedWorkFlowHistorySelect = WOSRCompletedWorkFlowHistorySelect;
//# sourceMappingURL=wo.srcompletedworkflowhistory.select.js.map