...
import { WOSRCompletedWorkFlowHistoryReportComponent} from './wo.srcompletedworkflowhistory.report.component';
...
@Component({
    ...
    directives: [GridComponent, WOSRCompletedWorkFlowHistoryReportComponent, PagingComponent, Notification, PageComponent, TabsComponent, TabComponent,SubMenu]
})

export class WOSRCompletedWorkFlowHistorySelect implements OnInit {
    ...
    fieldObject: IField[];
    itemsSource: any[];
    inputItems: IGrid = { dataKey: "WorkRequestId", groupBy: [], grpWithCheckBx: false, sortCol: "", sortDir: "", selectedIds: [], allowAdd: false, allowEdit: false };
