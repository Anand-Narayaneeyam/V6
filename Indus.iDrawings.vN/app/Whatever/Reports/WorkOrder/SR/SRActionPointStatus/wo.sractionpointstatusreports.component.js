...
var WOSRActionPointStatusReportComponent = (function () {
    function WOSRActionPointStatusReportComponent(commonService, notificationService) {
    ...
    WOSRActionPointStatusReportComponent.prototype.ngOnInit = function () {
        this.LoadReportData(0);
        this.pagePath = "Reports / Work Order / Service Requests / Requests based on Action Point";
    };
    WOSRActionPointStatusReportComponent.prototype.LoadReportData = function (IsCustomize) {
        this.ReportData = { ModuleId: 0, ReportCategoryId: 0, ExportFileName: "", ReportTitle: "", ReportSubTitle: "", ListReportFieldIdValues: [] };
        var contextObj = this;
        var arrRptFieldIds = new Array();
        this.ReportData.ModuleId = 9;
        this.ReportData.ReportCategoryId = 128;
        this.ReportData.ExportFileName = "Service Request Details";
        this.ReportData.ReportTitle = "Service Request Details";
        ...
        arrRptFieldIds.push({
            ReportFieldId: 5827,
            Value: this.ActionPointId.toString()
        });
        arrRptFieldIds.push({
            ReportFieldId: 5873,
    ...
    WOSRActionPointStatusReportComponent.prototype.customizeClick = function (event) {
        var contextObj = this;
    ...
    WOSRActionPointStatusReportComponent.prototype.onSplitViewClose = function (event) {
        this.splitviewInput.showSecondaryView = false;
    };
    WOSRActionPointStatusReportComponent.prototype.applyCustomRptClick = function (event) {
        this.splitviewInput.showSecondaryView = false;
        var contexObj = this;
    ...
    WOSRActionPointStatusReportComponent = __decorate([
        core_1.Component({
            selector: 'woSRActionPointStatusComponent-report',
            templateUrl: './app/Views/Reports/WorkOrder/SR/SRActionPointStatus/wo.sractionpointstatus.report.html',
            ...
            inputs: ['ActionPointId', 'WorkTypeId', 'WorkTypeName']
        }), 
        __metadata('design:paramtypes', [common_service_1.CommonService, notify_service_1.NotificationService])
    ], WOSRActionPointStatusReportComponent);
    return WOSRActionPointStatusReportComponent;
}());
exports.WOSRActionPointStatusReportComponent = WOSRActionPointStatusReportComponent;
//# sourceMappingURL=wo.sractionpointstatusreports.component.js.map