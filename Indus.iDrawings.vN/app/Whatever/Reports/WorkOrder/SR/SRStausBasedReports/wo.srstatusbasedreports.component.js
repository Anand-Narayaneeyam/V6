...
var WOSRStatusBasedReportComponent = (function () {
    function WOSRStatusBasedReportComponent(commonService, notificationService) {
    ...
    WOSRStatusBasedReportComponent.prototype.ngOnInit = function () {
        this.LoadReportData(0);
        this.pagePath = "Reports / Work Order / Service Requests / Status based Reports";
    };
    WOSRStatusBasedReportComponent.prototype.LoadReportData = function (IsCustomize) {
    ...
    WOSRStatusBasedReportComponent.prototype.customizeClick = function (event) {
        var contextObj = this;
    ...
    WOSRStatusBasedReportComponent.prototype.onSplitViewClose = function (event) {
        this.splitviewInput.showSecondaryView = false;
    };
    WOSRStatusBasedReportComponent.prototype.applyCustomRptClick = function (event) {
        this.splitviewInput.showSecondaryView = false;
        var contexObj = this;
    ...
    WOSRStatusBasedReportComponent = __decorate([
        core_1.Component({
    ...
    ], WOSRStatusBasedReportComponent);
    return WOSRStatusBasedReportComponent;
}());
exports.WOSRStatusBasedReportComponent = WOSRStatusBasedReportComponent;
//# sourceMappingURL=wo.srstatusbasedreports.component.js.map