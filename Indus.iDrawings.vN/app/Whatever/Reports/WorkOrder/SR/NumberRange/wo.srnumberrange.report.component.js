...
var WOSRNumberRangeReportComponent = (function () {
    function WOSRNumberRangeReportComponent(commonreportservice, commonService, notificationService) {
    ...
    WOSRNumberRangeReportComponent.prototype.ngOnInit = function () {
        var contextObj = this;
        contextObj.alignContent = "horizontal";
        this.pagePath = "Reports / Work Order / Service Requests / Work Orders by Number Range";
        contextObj.LoadReportData(0);
    };
    WOSRNumberRangeReportComponent.prototype.LoadReportData = function (IsCustomize) {
        this.ReportData = { ModuleId: 0, ReportCategoryId: 0, ExportFileName: "", ReportTitle: "", ReportSubTitle: "", ListReportFieldIdValues: [] };
        var contextObj = this;
        var arrRptFieldIds = new Array();
        this.ReportData.ModuleId = 9;
        this.ReportData.ReportCategoryId = 147;
    ...
    WOSRNumberRangeReportComponent.prototype.customizeClick = function (event) {
        var contextObj = this;
    ...
    WOSRNumberRangeReportComponent.prototype.onSplitViewClose = function (event) {
        this.splitviewInput.showSecondaryView = false;
    };
    WOSRNumberRangeReportComponent.prototype.applyCustomRptClick = function (event) {
        this.splitviewInput.showSecondaryView = false;
        var contexObj = this;
    ...
    WOSRNumberRangeReportComponent = __decorate([
        core_1.Component({
            selector: 'wo-srnumberrange-report',
            templateUrl: './app/Views/Reports/WorkOrder/SR/NumberRange/wo.srnumberrange.report.html',
    ...
    return WOSRNumberRangeReportComponent;
}());
exports.WOSRNumberRangeReportComponent = WOSRNumberRangeReportComponent;
//# sourceMappingURL=wo.srnumberrange.report.component.js.map