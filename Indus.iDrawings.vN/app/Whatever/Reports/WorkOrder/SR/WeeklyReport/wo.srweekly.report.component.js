...
var WOSRWeeklyReportComponent = (function () {
    function WOSRWeeklyReportComponent(commonreportservice, commonService) {
    ...
    WOSRWeeklyReportComponent.prototype.ngOnInit = function () {
        var contextObj = this;
    ...
    WOSRWeeklyReportComponent.prototype.LoadReportData = function () {
        debugger;
        this.ReportData = { ModuleId: 0, ReportCategoryId: 0, ExportFileName: "", ReportTitle: "", ReportSubTitle: "", ListReportFieldIdValues: [] };
        var contextObj = this;
    ...
    WOSRWeeklyReportComponent.prototype.checkForScheduledReport = function () {
        var contextObj = this;
    ...
    WOSRWeeklyReportComponent.prototype.showSheduleReport = function (event) {
        debugger;
        var contextObj = this;
    ...
    WOSRWeeklyReportComponent.prototype.handleInsertSuccess = function (event) {
        this.splitviewInput.showSecondaryView = false;
    };
    WOSRWeeklyReportComponent = __decorate([
        core_1.Component({
    ...
    ], WOSRWeeklyReportComponent);
    return WOSRWeeklyReportComponent;
}());
exports.WOSRWeeklyReportComponent = WOSRWeeklyReportComponent;
//# sourceMappingURL=wo.srweekly.report.component.js.map