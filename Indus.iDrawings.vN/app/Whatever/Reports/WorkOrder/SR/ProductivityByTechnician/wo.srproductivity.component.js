...
var WOSRProductivityReportComponent = (function () {
    function WOSRProductivityReportComponent(commonreportservice, commonService) {
    ...
    WOSRProductivityReportComponent.prototype.ngOnInit = function () {
        var contextObj = this;
    ...
    WOSRProductivityReportComponent.prototype.LoadReportData = function () {
        this.ReportData = { ModuleId: 0, ReportCategoryId: 0, ExportFileName: "", ReportTitle: "", ReportSubTitle: "", ListReportFieldIdValues: [] };
        var contextObj = this;
        var arrRptFieldIds = new Array();
        this.ReportData.ModuleId = 9;
        this.ReportData.ReportCategoryId = 148;
    ...
    WOSRProductivityReportComponent.prototype.checkForScheduledReport = function () {
        var contextObj = this;
    ...
    WOSRProductivityReportComponent.prototype.showSheduleReport = function (event) {
        debugger;
        var contextObj = this;
    ...
    WOSRProductivityReportComponent.prototype.handleInsertSuccess = function (event) {
        this.splitviewInput.showSecondaryView = false;
    };
    WOSRProductivityReportComponent = __decorate([
        core_1.Component({
    ...
    ], WOSRProductivityReportComponent);
    return WOSRProductivityReportComponent;
}());
exports.WOSRProductivityReportComponent = WOSRProductivityReportComponent;
//# sourceMappingURL=wo.srproductivity.component.js.map