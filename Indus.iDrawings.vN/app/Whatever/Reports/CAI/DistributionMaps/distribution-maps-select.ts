...
import { DistributionMapsArchiveEditComponent } from './distribution-maps-archive-edit';


@Component({
    selector: 'archive-distributionMaps-report',
    templateUrl: './app/Views/Reports/CAI/DistributionMaps/distribution-maps-select.html',
    directives: [TabsComponent, TabComponent, FloorSelectionReportComponent, FieldComponent, Notification, PageComponent, DateComponent, GridComponent, PagingComponent, SubMenu, SplitViewComponent, DistributionMapsArchiveEditComponent],
    providers: [CommonReportService, NotificationService, GeneralFunctions],
})


export class DistributionMapsComponent implements OnInit {
