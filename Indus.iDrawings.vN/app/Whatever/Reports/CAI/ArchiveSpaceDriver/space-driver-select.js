...
var space_driver_report_1 = require('./space-driver-report');
var archivedrawings_component_1 = require('../../../cai/drawings/archivedrawings.component');
var ArchiveSpaceDriverComponent = (function () {
    function ArchiveSpaceDriverComponent(commonReportService, _notificationService, generalFunctions) {
        ...
        this.selectedArchivedId = 0;
        this.selectedArchiveDrawingCount = 0;
        this.selectedArchiveDrawingId = 0;
        this.archivedwgWidth = 0;
        this.archivedwgWidth = window.innerWidth - 150;
    }
    ArchiveSpaceDriverComponent.prototype.ngOnInit = function () {
        this.menuData = [
            {
                "id": 0,
                "title": "Show Report",
    ...
    ArchiveSpaceDriverComponent.prototype.getData = function () {
        var contextObj = this;
        this.commonReportService.getArchivesData(2, 0, this.dateSelectorField[0].FieldValue, this.dateSelectorField[1].FieldValue, contextObj.pageIndex, contextObj.inputItems.sortCol, contextObj.inputItems.sortDir).subscribe(function (result) {
    ...
    ArchiveSpaceDriverComponent.prototype.getSelectedTab = function (event) {
        this.selectedTab = event[0];
    };
    ArchiveSpaceDriverComponent.prototype.onSubMenuChange = function (event) {
        switch (event.value) {
            case 0:
            ...
            case 1:
                ...
                break;
            case 2:
                this.showDrawingOnClick();
                break;
        }
    };
    ArchiveSpaceDriverComponent.prototype.showDrawingOnClick = function () {
        var selectedLength = this.inputItems.selectedIds.length;
        if (selectedLength == 0) {
            ...
            if (this.inputItems.rowData['Drawing Count'] > 0) {
                this.splitviewTarget = 2;
                this.selectedArchiveDrawingId = this.inputItems.rowData['DrawingId'];
                this.selectedArchiveDrawingCount = this.inputItems.rowData['Drawing Count'];
                this.selectedArchivedId = this.inputItems.selectedIds[0];
                this.splitviewInput.showSecondaryView = true;
            }
            else {
                this._notificationService.ShowToaster("No drawing exists for this archive", 2);
            }
        }
    };
    ArchiveSpaceDriverComponent.prototype.editClick = function () {
    ...
    ArchiveSpaceDriverComponent.prototype.onSplitViewClose = function () {
        this.splitviewTarget = 0;
        this.splitviewInput.showSecondaryView = false;
    };
    ArchiveSpaceDriverComponent.prototype.onNextClick = function (event) {
        var contextObj = this;
    ...
    ArchiveSpaceDriverComponent.prototype.setPrevMonthsDate = function () {
    ...
    ArchiveSpaceDriverComponent.prototype.submitReturn = function (event) {
        var retUpdatedSrc;
        var contextObj = this;
    ...
    ], ArchiveSpaceDriverComponent);
    return ArchiveSpaceDriverComponent;
}());
exports.ArchiveSpaceDriverComponent = ArchiveSpaceDriverComponent;
