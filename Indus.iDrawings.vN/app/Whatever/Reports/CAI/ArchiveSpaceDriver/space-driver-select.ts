...
import { SpaceArchiveEditComponent } from './archive-edit';
import { ArchiveSpaceDriverReportComponent } from './space-driver-report';
import {ArchivedDrawings} from '../../../cai/drawings/archivedrawings.component';

@Component({
    selector: 'archive-spaceDriver-report',
    templateUrl: './app/Views/Reports/CAI/ArchiveSpaceDriver/space-driver-select.html',
    directives: [TabsComponent, TabComponent, FloorSelectionReportComponent, CAISpaceDriverComponent, FieldComponent, Notification, PageComponent, DateComponent, GridComponent, PagingComponent, SubMenu, SplitViewComponent, SpaceArchiveEditComponent, ArchiveSpaceDriverReportComponent, ArchivedDrawings],
    providers: [CommonReportService, NotificationService, GeneralFunctions],
})


export class ArchiveSpaceDriverComponent implements OnInit {
    ...
    selectedArchivedId: number = 0;
    selectedArchiveDrawingCount: number = 0;
    selectedArchiveDrawingId: number = 0;
    archivedwgWidth: number = 0;
