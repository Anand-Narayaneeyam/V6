...
import {FurnitureListbyClassComponent} from './furniture.listbyclass.report'
...
@Component({
    ...
    directives: [PagingComponent, Notification, PageComponent, FurnitureListbyClassComponent, ListBoxComponent, TabsComponent, TabComponent, SubMenu],
    encapsulation: ViewEncapsulation.None
})

export class FurnitureListbyClassSelect implements OnInit {
