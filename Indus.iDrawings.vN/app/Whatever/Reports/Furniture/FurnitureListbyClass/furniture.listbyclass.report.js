...
var FurnitureListbyClassComponent = (function () {
    function FurnitureListbyClassComponent(commonService, notificationService) {
    ...
    FurnitureListbyClassComponent.prototype.ngOnInit = function () {
        this.LoadReportData(0);
        this.pagePath = "Reports / Furniture / Furniture List by Class";
    };
    FurnitureListbyClassComponent.prototype.LoadReportData = function (IsCustomize) {
        this.ReportData = { ModuleId: 0, ReportCategoryId: 0, ExportFileName: "", ReportTitle: "", ReportSubTitle: "", ListReportFieldIdValues: [] };
        var arrRptFieldIds = new Array();
        this.ReportData.ModuleId = 8;
        this.ReportData.ReportCategoryId = 189;
        this.ReportData.ExportFileName = "Furniture List by Class";
        this.ReportData.ReportTitle = "Furniture List by Class";
    ...
    FurnitureListbyClassComponent.prototype.customizeClick = function (event) {
        var contextObj = this;
    ...
    FurnitureListbyClassComponent.prototype.onSplitViewClose = function (event) {
        this.splitviewInput.showSecondaryView = false;
    };
    FurnitureListbyClassComponent.prototype.applyCustomRptClick = function (event) {
        this.splitviewInput.showSecondaryView = false;
        var contexObj = this;
    ...
    FurnitureListbyClassComponent = __decorate([
        core_1.Component({
            selector: 'furnitureListbyClass-report',
            templateUrl: './app/Views/Reports/Furniture/FurnitureListByClass/furniture.listbyclass.report.html',
    ...
    ], FurnitureListbyClassComponent);
    return FurnitureListbyClassComponent;
}());
exports.FurnitureListbyClassComponent = FurnitureListbyClassComponent;
//# sourceMappingURL=furniture.listbyclass.report.js.map