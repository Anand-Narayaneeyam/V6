...
var furniture_listbyclass_report_1 = require('./furniture.listbyclass.report');
var tabs_component_1 = require('../../../../Framework/Whatever/Tab/tabs.component');
var tab_component_1 = require('../../../../Framework/Whatever/Tab/tab.component');
var submenu_component_1 = require('../../../../Framework/Whatever/Submenu/submenu.component');
var FurnitureListbyClassSelect = (function () {
    function FurnitureListbyClassSelect(commonreportservice, notificationService) {
    ...
    FurnitureListbyClassSelect.prototype.ngOnInit = function () {
        this.menuData = [
            {
                "id": 0,
                "title": "Show Report",
        ...
        this.enableMenu = [0];
        this.pagePath = "Reports / Furniture / Furniture List by Class";
        var contextObj = this;
    ...
    FurnitureListbyClassSelect.prototype.getListBoxData = function (event) {
    ...
    FurnitureListbyClassSelect.prototype.onSubMenuChange = function (event) {
        this.isNextClicked = false;
    ...
    FurnitureListbyClassSelect.prototype.getSelectedTab = function (event) {
        this.selectedTab = event[0];
    };
    __decorate([
        core_1.Output(), 
        __metadata('design:type', Object)
    ], FurnitureListbyClassSelect.prototype, "onSubmitClick", void 0);
    FurnitureListbyClassSelect = __decorate([
        core_1.Component({
            selector: 'furniturelistbyclass-selector',
            templateUrl: './app/Views/Reports/Furniture/FurnitureListByClass/furniture.listbyclass.select.html',
            providers: [common_service_1.CommonReportService, notify_service_1.NotificationService],
            directives: [paging_component_1.PagingComponent, notify_component_1.Notification, page_component_1.PageComponent, furniture_listbyclass_report_1.FurnitureListbyClassComponent, listboxcomponent_component_1.ListBoxComponent, tabs_component_1.TabsComponent, tab_component_1.TabComponent, submenu_component_1.SubMenu],
            encapsulation: core_1.ViewEncapsulation.None
        }), 
        __metadata('design:paramtypes', [common_service_1.CommonReportService, notify_service_1.NotificationService])
    ], FurnitureListbyClassSelect);
    return FurnitureListbyClassSelect;
}());
exports.FurnitureListbyClassSelect = FurnitureListbyClassSelect;
//# sourceMappingURL=furniture.listbyclass.select.js.map