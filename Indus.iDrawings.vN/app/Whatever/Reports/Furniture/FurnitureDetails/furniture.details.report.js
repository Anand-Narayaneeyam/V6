...
var FurnitureDetailsComponent = (function () {
    function FurnitureDetailsComponent(commonService, notificationService) {
    ...
    FurnitureDetailsComponent.prototype.ngOnInit = function () {
        this.LoadReportData(0);
        this.pagePath = "Reports / Furniture / Furniture Details";
    };
    FurnitureDetailsComponent.prototype.LoadReportData = function (IsCustomize) {
        this.ReportData = { ModuleId: 0, ReportCategoryId: 0, ExportFileName: "", ReportTitle: "", ReportSubTitle: "", ListReportFieldIdValues: [] };
        var arrRptFieldIds = new Array();
        this.ReportData.ModuleId = 8;
        this.ReportData.ReportCategoryId = 187;
        this.ReportData.ExportFileName = "Furniture Details";
        this.ReportData.ReportTitle = "Furniture Details";
    ...
    FurnitureDetailsComponent.prototype.customizeClick = function (event) {
        var contextObj = this;
    ...
    FurnitureDetailsComponent.prototype.onSplitViewClose = function (event) {
        this.splitviewInput.showSecondaryView = false;
    };
    FurnitureDetailsComponent.prototype.applyCustomRptClick = function (event) {
        this.splitviewInput.showSecondaryView = false;
        var contexObj = this;
    ...
    FurnitureDetailsComponent = __decorate([
        core_1.Component({
            selector: 'furnitureDetails-report',
            templateUrl: './app/Views/Reports/Furniture/FurnitureDetails/furniture.details.report.html',
    ...
    return FurnitureDetailsComponent;
}());
exports.FurnitureDetailsComponent = FurnitureDetailsComponent;
//# sourceMappingURL=furniture.details.report.js.map