...
var furniture_details_report_1 = require('./furniture.details.report');
var tabs_component_1 = require('../../../../Framework/Whatever/Tab/tabs.component');
var tab_component_1 = require('../../../../Framework/Whatever/Tab/tab.component');
var submenu_component_1 = require('../../../../Framework/Whatever/Submenu/submenu.component');
var FurnitureDetailsSelect = (function () {
    function FurnitureDetailsSelect(commonreportservice, notificationService) {
    ...
    FurnitureDetailsSelect.prototype.ngOnInit = function () {
        this.menuData = [
            {
                "id": 0,
                "title": "Show Report",
    ...
    FurnitureDetailsSelect.prototype.getListBoxData = function (event) {
    ...
    FurnitureDetailsSelect.prototype.onSubMenuChange = function (event) {
        this.isNextClicked = false;
    ...
    FurnitureDetailsSelect.prototype.getSelectedTab = function (event) {
        this.selectedTab = event[0];
    };
    __decorate([
        core_1.Output(), 
        __metadata('design:type', Object)
    ], FurnitureDetailsSelect.prototype, "onSubmitClick", void 0);
    FurnitureDetailsSelect = __decorate([
        core_1.Component({
            ...
            directives: [paging_component_1.PagingComponent, notify_component_1.Notification, page_component_1.PageComponent, furniture_details_report_1.FurnitureDetailsComponent, listboxcomponent_component_1.ListBoxComponent, tabs_component_1.TabsComponent, tab_component_1.TabComponent, submenu_component_1.SubMenu],
            encapsulation: core_1.ViewEncapsulation.None
        }), 
        __metadata('design:paramtypes', [common_service_1.CommonReportService, notify_service_1.NotificationService])
    ], FurnitureDetailsSelect);
    return FurnitureDetailsSelect;
}());
exports.FurnitureDetailsSelect = FurnitureDetailsSelect;
//# sourceMappingURL=furniture.details.select.js.map