...
var AdminFloorsComponent = (function () {
    function AdminFloorsComponent(commonService, notificationService) {
    ...
    AdminFloorsComponent.prototype.ngOnInit = function () {
        this.pagePath = "Reports / Administration / Floors";
        this.LoadReportData(0);
    };
    AdminFloorsComponent.prototype.LoadReportData = function (IsCustomize) {
    ...
    AdminFloorsComponent.prototype.customizeClick = function (event) {
        var contextObj = this;
    ...
    AdminFloorsComponent.prototype.onSplitViewClose = function (event) {
        this.splitviewInput.showSecondaryView = false;
    };
    AdminFloorsComponent.prototype.applyCustomRptClick = function (event) {
        this.splitviewInput.showSecondaryView = false;
        var contexObj = this;
    ...
    AdminFloorsComponent = __decorate([
        core_1.Component({
            selector: 'adminFloors-report',
            templateUrl: './app/Views/Reports/Administration/Floors/admin.floors.report.html',
    ...
    ], AdminFloorsComponent);
    return AdminFloorsComponent;
}());
exports.AdminFloorsComponent = AdminFloorsComponent;
//# sourceMappingURL=admin.floors.report.component.js.map