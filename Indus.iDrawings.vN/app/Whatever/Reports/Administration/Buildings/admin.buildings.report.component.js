...
var AdminBuildingsComponent = (function () {
    function AdminBuildingsComponent(commonService, notificationService) {
    ...
    AdminBuildingsComponent.prototype.ngOnInit = function () {
        this.pagePath = "Reports / Administration / Buildings";
        this.LoadReportData(0);
    };
    AdminBuildingsComponent.prototype.LoadReportData = function (IsCustomize) {
    ...
    AdminBuildingsComponent.prototype.customizeClick = function (event) {
        var contextObj = this;
    ...
    AdminBuildingsComponent.prototype.onSplitViewClose = function (event) {
        this.splitviewInput.showSecondaryView = false;
    };
    AdminBuildingsComponent.prototype.applyCustomRptClick = function (event) {
        this.splitviewInput.showSecondaryView = false;
        var contexObj = this;
    ...
    AdminBuildingsComponent = __decorate([
        core_1.Component({
            selector: 'adminBuildings-report',
            templateUrl: './app/Views/Reports/Administration/Buildings/admin.buildings.report.html',
    ...
    return AdminBuildingsComponent;
}());
exports.AdminBuildingsComponent = AdminBuildingsComponent;
//# sourceMappingURL=admin.buildings.report.component.js.map