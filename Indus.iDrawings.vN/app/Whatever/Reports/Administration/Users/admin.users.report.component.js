...
var AdminUsersComponent = (function () {
    function AdminUsersComponent(commonreportservice) {
    ...
    AdminUsersComponent.prototype.LoadReportData = function () {
        this.ReportData = { ModuleId: 0, ReportCategoryId: 0, ExportFileName: "", ReportTitle: "", ReportSubTitle: "", ListReportFieldIdValues: [] };
        var contexObj = this;
    ...
    AdminUsersComponent.prototype.onChangeType = function (event) {
        switch (event) {
            case "3":
                this.StatusId = "0";
                break;
    ...
    AdminUsersComponent.prototype.showPeriodSelector = function () {
        this.splitviewInput.showSecondaryView = true;
    };
    AdminUsersComponent.prototype.dateSelect = function (event) {
...
//# sourceMappingURL=admin.users.report.component.js.map