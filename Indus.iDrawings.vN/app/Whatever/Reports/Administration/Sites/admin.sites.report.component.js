...
var AdminSitesComponent = (function () {
    function AdminSitesComponent(commonService, notificationService) {
    ...
    AdminSitesComponent.prototype.ngOnInit = function () {
        this.pagePath = "Reports / Administration / Sites";
        this.LoadReportData(0);
    };
    AdminSitesComponent.prototype.LoadReportData = function (IsCustomize) {
    ...
    AdminSitesComponent.prototype.customizeClick = function (event) {
        var contextObj = this;
    ...
    AdminSitesComponent.prototype.onSplitViewClose = function (event) {
        this.splitviewInput.showSecondaryView = false;
    };
    AdminSitesComponent.prototype.applyCustomRptClick = function (event) {
        this.splitviewInput.showSecondaryView = false;
        var contexObj = this;
    ...
    AdminSitesComponent = __decorate([
        core_1.Component({
            selector: 'adminSites-report',
            templateUrl: './app/Views/Reports/Administration/Sites/sitelist.report.component.html',
    ...
    return AdminSitesComponent;
}());
exports.AdminSitesComponent = AdminSitesComponent;
//# sourceMappingURL=admin.sites.report.component.js.map