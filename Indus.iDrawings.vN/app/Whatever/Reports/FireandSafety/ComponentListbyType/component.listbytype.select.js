...
var component_listbytype_report_1 = require('./component.listbytype.report');
var tabs_component_1 = require('../../../../Framework/Whatever/Tab/tabs.component');
var tab_component_1 = require('../../../../Framework/Whatever/Tab/tab.component');
var submenu_component_1 = require('../../../../Framework/Whatever/Submenu/submenu.component');
var ComponentListbyTypeSelect = (function () {
    function ComponentListbyTypeSelect(commonreportservice, notificationService) {
    ...
    ComponentListbyTypeSelect.prototype.ngOnInit = function () {
        this.menuData = [
            {
                "id": 0,
                "title": "Show Report",
        ...
        this.enableMenu = [0];
        this.pagePath = "Reports / Fire and Safety / Component List by Type";
        var contextObj = this;
    ...
    ComponentListbyTypeSelect.prototype.getListBoxData = function (event) {
    ...
    ComponentListbyTypeSelect.prototype.onSubMenuChange = function (event) {
        this.isNextClicked = false;
    ...
    ComponentListbyTypeSelect.prototype.getSelectedTab = function (event) {
        this.selectedTab = event[0];
    };
    __decorate([
        core_1.Output(), 
        __metadata('design:type', Object)
    ], ComponentListbyTypeSelect.prototype, "onSubmitClick", void 0);
    ComponentListbyTypeSelect = __decorate([
        core_1.Component({
            selector: 'componentlistbytype-selector',
            templateUrl: './app/Views/Reports/FireandSafety/ComponentListbyType/component.listbytype.select.html',
            providers: [common_service_1.CommonReportService, notify_service_1.NotificationService],
            directives: [paging_component_1.PagingComponent, notify_component_1.Notification, page_component_1.PageComponent, component_listbytype_report_1.ComponentListbyTypeComponent, listboxcomponent_component_1.ListBoxComponent, tabs_component_1.TabsComponent, tab_component_1.TabComponent, submenu_component_1.SubMenu],
            encapsulation: core_1.ViewEncapsulation.None
        }), 
        __metadata('design:paramtypes', [common_service_1.CommonReportService, notify_service_1.NotificationService])
    ], ComponentListbyTypeSelect);
    return ComponentListbyTypeSelect;
}());
exports.ComponentListbyTypeSelect = ComponentListbyTypeSelect;
//# sourceMappingURL=component.listbytype.select.js.map