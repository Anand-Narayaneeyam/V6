...
var ComponentListbyTypeComponent = (function () {
    function ComponentListbyTypeComponent(commonService, notificationService) {
    ...
    ComponentListbyTypeComponent.prototype.ngOnInit = function () {
        this.LoadReportData(0);
        this.pagePath = "Reports / Fire and Safety / Component List by Type";
    };
    ComponentListbyTypeComponent.prototype.LoadReportData = function (IsCustomize) {
        this.ReportData = { ModuleId: 0, ReportCategoryId: 0, ExportFileName: "", ReportTitle: "", ReportSubTitle: "", ListReportFieldIdValues: [] };
        var arrRptFieldIds = new Array();
        this.ReportData.ModuleId = 18;
        this.ReportData.ReportCategoryId = 201;
    ...
    ComponentListbyTypeComponent.prototype.customizeClick = function (event) {
        var contextObj = this;
    ...
    ComponentListbyTypeComponent.prototype.onSplitViewClose = function (event) {
        this.splitviewInput.showSecondaryView = false;
    };
    ComponentListbyTypeComponent.prototype.applyCustomRptClick = function (event) {
        this.splitviewInput.showSecondaryView = false;
        var contexObj = this;
    ...
    ComponentListbyTypeComponent = __decorate([
        core_1.Component({
            selector: 'componentListbyType-report',
            templateUrl: './app/Views/Reports/FireandSafety/ComponentListbyType/component.listbytype.report.html',
    ...
    ], ComponentListbyTypeComponent);
    return ComponentListbyTypeComponent;
}());
exports.ComponentListbyTypeComponent = ComponentListbyTypeComponent;
//# sourceMappingURL=component.listbytype.report.js.map