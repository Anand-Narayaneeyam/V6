...
import {ComponentListbyTypeComponent} from './component.listbytype.report'
...
@Component({
    ...
    directives: [PagingComponent, Notification, PageComponent, ComponentListbyTypeComponent, ListBoxComponent, TabsComponent, TabComponent, SubMenu],
    encapsulation: ViewEncapsulation.None
})

export class ComponentListbyTypeSelect implements OnInit {

    ListboxData: IField = undefined;
    @Output() onSubmitClick = new EventEmitter();
    objectCategoryId: any = 9;
    drawingIds: any = "";
    dataOption: any = 1;
