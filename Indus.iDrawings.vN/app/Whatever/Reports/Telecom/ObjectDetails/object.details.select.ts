...
import {ObjectDetailsComponent} from './object.details.report'
...
@Component({
    ...
    directives: [PagingComponent, Notification, PageComponent, ObjectDetailsComponent, ListBoxComponent, TabsComponent, TabComponent, SubMenu],
    encapsulation: ViewEncapsulation.None
})

export class ObjectDetailsSelect implements OnInit {
