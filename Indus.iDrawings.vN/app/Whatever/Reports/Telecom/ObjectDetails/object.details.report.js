...
var ObjectDetailsComponent = (function () {
    function ObjectDetailsComponent(commonService, notificationService) {
    ...
    ObjectDetailsComponent.prototype.LoadReportData = function (IsCustomize) {
        this.ReportData = { ModuleId: 0, ReportCategoryId: 0, ExportFileName: "", ReportTitle: "", ReportSubTitle: "", ListReportFieldIdValues: [] };
        var arrRptFieldIds = new Array();
        this.ReportData.ModuleId = 6;
        this.ReportData.ReportCategoryId = 190;
        this.ReportData.ExportFileName = "Object Details";
        this.ReportData.ReportTitle = "Object Details";
    ...
    ObjectDetailsComponent.prototype.customizeClick = function (event) {
        var contextObj = this;
    ...
    ObjectDetailsComponent.prototype.onSplitViewClose = function (event) {
        this.splitviewInput.showSecondaryView = false;
    };
    ObjectDetailsComponent.prototype.applyCustomRptClick = function (event) {
        this.splitviewInput.showSecondaryView = false;
        var contexObj = this;
    ...
    ObjectDetailsComponent = __decorate([
        core_1.Component({
            selector: 'objectDetails-report',
            templateUrl: './app/Views/Reports/Telecom/ObjectDetails/object.details.report.html',
...
exports.ObjectDetailsComponent = ObjectDetailsComponent;
//# sourceMappingURL=object.details.report.js.map