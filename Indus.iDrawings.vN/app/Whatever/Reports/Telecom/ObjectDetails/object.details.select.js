...
var object_details_report_1 = require('./object.details.report');
var tabs_component_1 = require('../../../../Framework/Whatever/Tab/tabs.component');
var tab_component_1 = require('../../../../Framework/Whatever/Tab/tab.component');
var submenu_component_1 = require('../../../../Framework/Whatever/Submenu/submenu.component');
var ObjectDetailsSelect = (function () {
    function ObjectDetailsSelect(commonreportservice, notificationService) {
    ...
    ObjectDetailsSelect.prototype.ngOnInit = function () {
        this.menuData = [
            {
                "id": 0,
                "title": "Show Report",
        ...
        this.enableMenu = [0];
        this.pagePath = "Reports / Telecom / Object Details";
        var contextObj = this;
    ...
    ObjectDetailsSelect.prototype.getListBoxData = function (event) {
    ...
    ObjectDetailsSelect.prototype.onSubMenuChange = function (event) {
        this.isNextClicked = false;
    ...
    ObjectDetailsSelect.prototype.getSelectedTab = function (event) {
        this.selectedTab = event[0];
    };
    __decorate([
        core_1.Output(), 
        __metadata('design:type', Object)
    ], ObjectDetailsSelect.prototype, "onSubmitClick", void 0);
    ObjectDetailsSelect = __decorate([
        core_1.Component({
            selector: 'objectdetails-selector',
            templateUrl: './app/Views/Reports/Telecom/ObjectDetails/object.details.select.html',
            providers: [common_service_1.CommonReportService, notify_service_1.NotificationService],
            directives: [paging_component_1.PagingComponent, notify_component_1.Notification, page_component_1.PageComponent, object_details_report_1.ObjectDetailsComponent, listboxcomponent_component_1.ListBoxComponent, tabs_component_1.TabsComponent, tab_component_1.TabComponent, submenu_component_1.SubMenu],
            encapsulation: core_1.ViewEncapsulation.None
        }), 
        __metadata('design:paramtypes', [common_service_1.CommonReportService, notify_service_1.NotificationService])
    ], ObjectDetailsSelect);
    return ObjectDetailsSelect;
}());
exports.ObjectDetailsSelect = ObjectDetailsSelect;
//# sourceMappingURL=object.details.select.js.map