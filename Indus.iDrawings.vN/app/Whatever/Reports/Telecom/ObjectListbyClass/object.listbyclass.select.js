...
var object_listbyclass_report_1 = require('./object.listbyclass.report');
var tabs_component_1 = require('../../../../Framework/Whatever/Tab/tabs.component');
var tab_component_1 = require('../../../../Framework/Whatever/Tab/tab.component');
var submenu_component_1 = require('../../../../Framework/Whatever/Submenu/submenu.component');
var ObjectListbyClassSelect = (function () {
    function ObjectListbyClassSelect(commonreportservice, notificationService) {
    ...
    ObjectListbyClassSelect.prototype.ngOnInit = function () {
        this.menuData = [
            {
                "id": 0,
                "title": "Show Report",
    ...
    ObjectListbyClassSelect.prototype.getListBoxData = function (event) {
    ...
    ObjectListbyClassSelect.prototype.onSubMenuChange = function (event) {
        this.isNextClicked = false;
        var selectedClassIds = '';
        if (this.ListboxData.MultiFieldValues == null || this.ListboxData.MultiFieldValues.length == 0) {
            this.notificationService.ShowToaster("Select an Object Class", 2);
        }
        else {
    ...
    ObjectListbyClassSelect.prototype.getSelectedTab = function (event) {
        this.selectedTab = event[0];
    };
    __decorate([
        core_1.Output(), 
        __metadata('design:type', Object)
    ], ObjectListbyClassSelect.prototype, "onSubmitClick", void 0);
    ObjectListbyClassSelect = __decorate([
        core_1.Component({
            selector: 'objectlistbyclass-selector',
            templateUrl: './app/Views/Reports/Telecom/ObjectListbyClass/object.listbyclass.select.html',
            providers: [common_service_1.CommonReportService, notify_service_1.NotificationService],
            directives: [paging_component_1.PagingComponent, notify_component_1.Notification, page_component_1.PageComponent, object_listbyclass_report_1.ObjectListbyClassComponent, listboxcomponent_component_1.ListBoxComponent, tabs_component_1.TabsComponent, tab_component_1.TabComponent, submenu_component_1.SubMenu],
            encapsulation: core_1.ViewEncapsulation.None
        }), 
        __metadata('design:paramtypes', [common_service_1.CommonReportService, notify_service_1.NotificationService])
    ], ObjectListbyClassSelect);
    return ObjectListbyClassSelect;
}());
exports.ObjectListbyClassSelect = ObjectListbyClassSelect;
//# sourceMappingURL=object.listbyclass.select.js.map