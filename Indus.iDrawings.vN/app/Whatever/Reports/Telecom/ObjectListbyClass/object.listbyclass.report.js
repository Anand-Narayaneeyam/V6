...
var ObjectListbyClassComponent = (function () {
    function ObjectListbyClassComponent(commonService, notificationService) {
    ...
    ObjectListbyClassComponent.prototype.ngOnInit = function () {
        this.LoadReportData(0);
        this.pagePath = "Reports / Telecom / Object List by Class";
    };
    ObjectListbyClassComponent.prototype.LoadReportData = function (IsCustomize) {
    ...
    ObjectListbyClassComponent.prototype.customizeClick = function (event) {
        var contextObj = this;
    ...
    ObjectListbyClassComponent.prototype.onSplitViewClose = function (event) {
        this.splitviewInput.showSecondaryView = false;
    };
    ObjectListbyClassComponent.prototype.applyCustomRptClick = function (event) {
        this.splitviewInput.showSecondaryView = false;
        var contexObj = this;
    ...
    ObjectListbyClassComponent = __decorate([
        core_1.Component({
    ...
    ], ObjectListbyClassComponent);
    return ObjectListbyClassComponent;
}());
exports.ObjectListbyClassComponent = ObjectListbyClassComponent;
//# sourceMappingURL=object.listbyclass.report.js.map