...
import {ObjectListbyClassComponent} from './object.listbyclass.report'
...
@Component({
    ...
    directives: [PagingComponent, Notification, PageComponent, ObjectListbyClassComponent, ListBoxComponent, TabsComponent, TabComponent, SubMenu],
    encapsulation: ViewEncapsulation.None
})

export class ObjectListbyClassSelect implements OnInit {
