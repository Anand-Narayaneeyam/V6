...
var Amenities = (function () {
    ...
    Amenities.prototype.ngOnInit = function () {
    };
    Amenities.prototype.listbuttonadd = function (event) {
        var ContextObj = this;
        ContextObj.list = event["List"];
        ContextObj.splitviewInput.showSecondaryView = !ContextObj.splitviewInput.showSecondaryView;
    };
    Amenities.prototype.listbuttondelete = function (event) {
        var ContextObj = this;
        ...
        for (var i = 0; i < ContextObj.Amniety.length; i++) {
    ...
    Amenities.prototype.Remove = function () {
        var ContextObj = this;
        var temp = ContextObj;
    };
    Amenities.prototype.OnSuccessfulSubmit = function (event) {
        var ContextObj = this;
        var tempInviteesList = "";
        ContextObj.Amnietyvalueforinsert = event["Amenityvalue"];
        ContextObj.Amniety = event["arrayList"];
        for (var i_1 = 0; i_1 < ContextObj.Amniety.length; i_1++) {
            ContextObj.ShowinListItem = ContextObj.Amniety[i_1]["Value"];
    ...
    ], Amenities.prototype, "AmnietyList", void 0);
    Amenities = __decorate([
        core_1.Component({
            ...
            directives: [fieldGeneration_component_1.FieldComponent, notify_component_1.Notification, slide_component_1.SlideComponent, dynamiclist_component_1.DynamicListComponent, split_view_component_1.SplitViewComponent, Amenities_listcustomadd_componet_1.AmenitiesCustomadd],
...
//# sourceMappingURL=Amenities-listforreservation.component.js.map