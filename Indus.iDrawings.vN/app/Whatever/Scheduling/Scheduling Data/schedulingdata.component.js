...
var SchedulingDataComponent = (function () {
    function SchedulingDataComponent(_spaceService, _notificationService) {
        this._spaceService = _spaceService;
        this._notificationService = _notificationService;
        this.pagePath = "Scheduling / Data";
        this.moduleId = 14; //scheduling
        this.selectedTab = 0;
    ...
    SchedulingDataComponent.prototype.getSelectedTab = function (event) {
        var contextObj = this;
        switch (event[0]) {
            case 0:
    ...
    SchedulingDataComponent.prototype.closeTab = function (index) {
        var contextObj = this;
        setTimeout(function () {
    ...
    SchedulingDataComponent.prototype.getSelectedIds = function (event) {
        var contextObj = this;
    ...
    SchedulingDataComponent.prototype.onTabClose = function (event) {
        this.selectedTab = 0;
        this.spaceTabEnabled = false;
    };
    SchedulingDataComponent.prototype.getDrawingObject = function (event) {
        this.objiWhiz = event.dwgObject;
    };
    SchedulingDataComponent.prototype.spShowInDrawingOnClick = function (event) {
        this.dwgPageTarget = 3;
        this.selectedDrawingId = event["drawingId"];
        this.openDrawing(event["selectedIds"]);
    };
    SchedulingDataComponent.prototype.spShowZoomOnClick = function (event) {
        this.dwgPageTarget = 4;
        this.selectedDrawingId = event["drawingId"];
        this.openDrawing(event["selectedIds"]);
    };
    SchedulingDataComponent.prototype.openDrawing = function (selectedIds) {
    ...
    SchedulingDataComponent.prototype.onSecondaryClose = function () {
    ...
    SchedulingDataComponent = __decorate([
        core_1.Component({
    ...
    ], SchedulingDataComponent);
    return SchedulingDataComponent;
}());
exports.SchedulingDataComponent = SchedulingDataComponent;
//# sourceMappingURL=schedulingdata.component.js.map