...
var deficiencycategories_addedit_component_1 = require('./deficiencycategories-addedit.component');
var ListDeficiencyCategoriesComponent = (function () {
    function ListDeficiencyCategoriesComponent(generFun, objectsService, AdministrationService, notificationService, differs) {
    ...
    ListDeficiencyCategoriesComponent.prototype.ngOnInit = function () {
        this.enableMenu = [0];
        var contextObj = this;
    ...
    ListDeficiencyCategoriesComponent.prototype.dataLoad = function () {
        var contextObj = this;
    ...
    ListDeficiencyCategoriesComponent.prototype.pageChanged = function (event) {
        var contextObj = this;
    ...
    ListDeficiencyCategoriesComponent.prototype.onSort = function (objGrid) {
        debugger;
    ...
    ListDeficiencyCategoriesComponent.prototype.onSubMenuChange = function (event) {
    ...
    ListDeficiencyCategoriesComponent.prototype.addClick = function () {
        this.action = "add";
        this.btnName = "Save";
        var contextObj = this;
    ...
    ListDeficiencyCategoriesComponent.prototype.editClick = function () {
        debugger;
        this.action = "edit";
    ...
    ListDeficiencyCategoriesComponent.prototype.deleteClick = function () {
        var contextObj = this;
        var Isinuse;
        if (this.inputItems.selectedIds.length > 1) {
            this.notificationService.ShowToaster("This operation can be performed only one row at a time", 2);
    ...
    ListDeficiencyCategoriesComponent.prototype.OnSuccessfulSubmit = function (event) {
        var contextObj = this;
    ...
    ListDeficiencyCategoriesComponent.prototype.deleteDeficiencyCategories = function () {
        var contextObj = this;
    ...
    ListDeficiencyCategoriesComponent.prototype.okDelete = function (event) {
        this.showSlide = !this.showSlide;
        this.deleteDeficiencyCategories();
    };
    ListDeficiencyCategoriesComponent.prototype.cancelClick = function (event) {
        this.showSlide = !this.showSlide;
    };
    ListDeficiencyCategoriesComponent.prototype.closeSlideDialog = function (value) {
        this.showSlide = value.value;
    };
    ListDeficiencyCategoriesComponent.prototype.loadControl = function (eventValue, contextObj, action) {
    };
    ListDeficiencyCategoriesComponent.prototype.Successfulladd = function (event) {
    };
    __decorate([
        core_1.Input(), 
        __metadata('design:type', Number)
    ], ListDeficiencyCategoriesComponent.prototype, "objectCategoryId", void 0);
    __decorate([
        core_1.Input(), 
        __metadata('design:type', Number)
    ], ListDeficiencyCategoriesComponent.prototype, "moduleId", void 0);
    ListDeficiencyCategoriesComponent = __decorate([
        core_1.Component({
            selector: 'ListDeficiencyCategories',
            templateUrl: './app/Views/Objects/Deficiency/ListDeficiencyCategories.html',
            directives: [slide_component_1.SlideComponent, split_view_component_1.SplitViewComponent, fieldGeneration_component_1.FieldComponent, submenu_component_1.SubMenu, grid_component_1.GridComponent, paging_component_1.PagingComponent, deficiencycategories_addedit_component_1.DeficiencyCategoriesAddEdit],
    ...
    return ListDeficiencyCategoriesComponent;
}());
exports.ListDeficiencyCategoriesComponent = ListDeficiencyCategoriesComponent;
//# sourceMappingURL=Listdeficiencycategories.js.map