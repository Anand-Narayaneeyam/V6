...
var TelecomDataComponent = (function () {
    function TelecomDataComponent(cdr) {
        this.pageTitle = "Data";
        this.selectedTab = 0;
        this.floorSelected = false;
        this.selectedDrawingIds = '';
        this.selectedDrawingIds = '';
        this.pagePath = "Telecom / Data";
        this.cdr = cdr;
    }
    TelecomDataComponent.prototype.getSelectedTab = function (event) {
        this.selectedDrawingIds = '';
        this.selectedTab = event[0];
        this.floorSelected = false;
    };
    TelecomDataComponent.prototype.getSelectedIds = function (event) {
        this.selectedDrawingIds = '';
    ...
    TelecomDataComponent.prototype.pagepathchange = function (event) {
        this.pagePath = null;
        this.cdr.detectChanges();
        this.pagePath = "Telecom / Data ";
        this.cdr.detectChanges();
    };
    TelecomDataComponent = __decorate([
        core_1.Component({
            selector: 'telecomData',
            templateUrl: './app/Views/Objects/Telecom/telecomData.component.html',
    ...
    ], TelecomDataComponent);
    return TelecomDataComponent;
}());
exports.TelecomDataComponent = TelecomDataComponent;
//# sourceMappingURL=telecomData.component.js.map