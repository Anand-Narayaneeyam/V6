...
var TelecomQueryBuilderComponent = (function () {
    function TelecomQueryBuilderComponent(objectsService) {
        this.objectsService = objectsService;
        this.dataoption = "1";
    }
    TelecomQueryBuilderComponent.prototype.ngOnInit = function () {
        var contextObj = this;
        contextObj.pagePath = "Telecom / Query Builder";
    ...
    TelecomQueryBuilderComponent.prototype.Next = function (event) {
    };
    TelecomQueryBuilderComponent = __decorate([
        core_1.Component({
            selector: 'telecom-querybuilder',
    ...
    ], TelecomQueryBuilderComponent);
    return TelecomQueryBuilderComponent;
}());
exports.TelecomQueryBuilderComponent = TelecomQueryBuilderComponent;
//# sourceMappingURL=telecom-querybuilder.component.js.map