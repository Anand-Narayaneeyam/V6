...
var serviceReview_list_component_1 = require('../../workorder/review/serviceReview-list.component');
var reviewServiceRequests_component_1 = require('../../workorder/review/reviewServiceRequests.component');
var reviewDocument_list_component_1 = require('../../workorder/review/reviewDocument-list.component');
var reviewEquipment_list_component_1 = require('../../workorder/review/reviewEquipment-list.component');
var review_Cost_component_1 = require('../../workorder/review/Review Cost/review-Cost.component');
var reviewPmWorkorder_list_component_1 = require('../../workorder/review/reviewPmWorkorder-list.component');
var reviewPMWorkorder_component_1 = require('../../workorder/review/reviewPMWorkorder.component');
var reviewteam_members_component_1 = require('../../workorder/review/review team members/reviewteam-members.component');
var reviewhistory_1 = require('../../workorder/review/review history/reviewhistory');
var chargeback_list_1 = require('../../workorder/review/Manage Chargeback/chargeback-list');
var attachments_component_1 = require('../../Common/Attachments/attachments.component');
var ReviewServiceRequestInDrawingComponent = (function () {
    function ReviewServiceRequestInDrawingComponent(notificationService, workOrdereService, generalFunctions, _validateService) {
    ...
    ReviewServiceRequestInDrawingComponent.prototype.ngOnInit = function () {
        var contextObj = this;
    ...
    *
    ************************************************************************************************************/
    ReviewServiceRequestInDrawingComponent.prototype.getSelectedTab = function (event) {
        switch (event[0]) {
            case 0:
                if (event[1]) {
    ...
    ************************************************************************************************************/
    ...
    //                this.reviewTabEnabled = false;
    //                if (this.createRequestEnabled) {
    //                    this.selectedTab = 0;
    //                }
    //                this.createRequestEnabled = this.addOnTabEnabled = this.equipmentTabEnabled = this.documentTabEnabled = this.costTabEnabled = this.teamMemberTabEnabled = this.historyTabEnabled = this.chargebackTabEnabled = false;
    //                this.closeTab(3);
    //            }
    //            break;
    //        default:
    ...
    *
    ************************************************************************************************************/
    ReviewServiceRequestInDrawingComponent.prototype.closeTab = function (index) {
        var contextObj = this;
        switch (index) {
            case 3:
    ...
    *
    *************************************************************************/
    ReviewServiceRequestInDrawingComponent.prototype.onServiceListSourceUpdated = function (event) {
    ...
    ReviewServiceRequestInDrawingComponent.prototype.onDocumentSourceUpdated = function (event) {
        this.documentSource = event;
    };
    ReviewServiceRequestInDrawingComponent.prototype.onEquipmentListSourceUpdated = function (event) {
    ...
    *
    ************************************************************************************************************/
    ReviewServiceRequestInDrawingComponent.prototype.onServiceRequestAddEditClicked = function (event) {
        var contextObj = this;
        contextObj.createRequestEnabled = contextObj.reviewTabEnabled = false;
    ...
    ReviewServiceRequestInDrawingComponent.prototype.changeServiceRequestField = function () {
    };
    /***********************************************************************************************************
    ...
    *
    ************************************************************************************************************/
    ReviewServiceRequestInDrawingComponent.prototype.getPermissionDetails = function (workFlowActionPointId, dataKeyId) {
        var contextObj = this;
    ...
    *
    ************************************************************************************************************/
    ReviewServiceRequestInDrawingComponent.prototype.onRequesterPermissionUpdate = function (event) {
    ...
    *
    ************************************************************************************************************/
    ReviewServiceRequestInDrawingComponent.prototype.updateLinkArray = function (fieldDetailsArray, dataKeyId) {
        this.linkArray = undefined;
    ...
    *
    ************************************************************************************************************/
    ReviewServiceRequestInDrawingComponent.prototype.onLinkClick = function (linkDetails) {
        var contextObj = this;
    ...
    *
    ************************************************************************************************************/
    ReviewServiceRequestInDrawingComponent.prototype.getWorkFlowEntityIds = function () {
        var inputItems = this.serviceRequestInputItems;
    ...
    *
    ************************************************************************************************************/
    ReviewServiceRequestInDrawingComponent.prototype.getEditableFields = function () {
        var check;
        var contextObj = this;
        var tempArray = new Array();
        tempArray.push({
            ReportFieldId: 5827,
            Value: contextObj.serviceRequestInputItems.rowData["CurrentWorkFlowActionPointId"]
        });
    ...
    *
    ************************************************************************************************************/
    ReviewServiceRequestInDrawingComponent.prototype.getAutoPopulatedTimeSpentValue = function () {
        var contextObj = this;
    ...
    *
    ************************************************************************************************************/
    ReviewServiceRequestInDrawingComponent.prototype.getReviewCostDetails = function () {
        var contextObj = this;
    ...
    *
    ************************************************************************************************************/
    ReviewServiceRequestInDrawingComponent.prototype.onSubmitClick = function (event) {
        var contextObj = this;
        var entityId = 0;
        if (event.isPm) {
    ...
    *
    ************************************************************************************************************/
    ReviewServiceRequestInDrawingComponent.prototype.updateListSource = function (retUpdatedSrc, requestNumber, entityId) {
        var contextObj = this;
    ...
    *
    ************************************************************************************************************/
    ReviewServiceRequestInDrawingComponent.prototype.onDocumentSubmitClick = function (event) {
        var contextObj = this;
    ...
    *
    ************************************************************************************************************/
    ReviewServiceRequestInDrawingComponent.prototype.onDocumentDelete = function (event) {
        var contextObj = this;
    ...
    ReviewServiceRequestInDrawingComponent.prototype.updateDocumentEnableMenu = function () {
    ...
    *
    ************************************************************************************************************/
    ReviewServiceRequestInDrawingComponent.prototype.onCostSubmit = function (event) {
        var contextObj = this;
    ...
    *
    ************************************************************************************************************/
    ReviewServiceRequestInDrawingComponent.prototype.onTeamMemberUpdate = function (event) {
        debugger;
        var contextObj = this;
    ...
    *
    ************************************************************************************************************/
    ReviewServiceRequestInDrawingComponent.prototype.getReportfiedlIdValuesForTeamMemberDelete = function () {
        var tempArray = [];
     ...
     *
     *************************************************************************/
    ReviewServiceRequestInDrawingComponent.prototype.initiateValidation = function (fieldObject) {
        var contextObj = this;
    ...
    ReviewServiceRequestInDrawingComponent.prototype.attachmentSuccess = function (event) {
        this.refreshgrid = [];
    ...
    ], ReviewServiceRequestInDrawingComponent.prototype, "objectId", void 0);
    ReviewServiceRequestInDrawingComponent = __decorate([
        core_1.Component({
            selector: 'review-workorder-fromDrawing',
            templateUrl: './app/Views/Objects/Drawings/reviewServiceRequestFromDrawing.component.html',
    ...
    ], ReviewServiceRequestInDrawingComponent);
    return ReviewServiceRequestInDrawingComponent;
}());
exports.ReviewServiceRequestInDrawingComponent = ReviewServiceRequestInDrawingComponent;
//# sourceMappingURL=reviewServiceRequestFromDrawing.component.js.map