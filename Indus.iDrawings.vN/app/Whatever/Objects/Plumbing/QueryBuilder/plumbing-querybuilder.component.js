...
var PlumbingQueryBuilderComponent = (function () {
    function PlumbingQueryBuilderComponent(objectsService) {
        this.objectsService = objectsService;
        this.dataoption = "1";
    }
    PlumbingQueryBuilderComponent.prototype.ngOnInit = function () {
        var contextObj = this;
        contextObj.pagePath = "Plumbing / Query Builder";
    ...
    PlumbingQueryBuilderComponent.prototype.Next = function (event) {
    };
    PlumbingQueryBuilderComponent = __decorate([
        core_1.Component({
            selector: 'plumbing-querybuilder',
    ...
    ], PlumbingQueryBuilderComponent);
    return PlumbingQueryBuilderComponent;
}());
exports.PlumbingQueryBuilderComponent = PlumbingQueryBuilderComponent;
//# sourceMappingURL=plumbing-querybuilder.component.js.map