...
var PlumbingDataComponent = (function () {
    function PlumbingDataComponent(cdr) {
        this.pageTitle = "Data";
        this.selectedTab = 0;
        this.floorSelected = false;
        this.selectedDrawingIds = '';
        this.selectedDrawingIds = '';
        this.pagePath = "Plumbing / Data";
        this.cdr = cdr;
    }
    PlumbingDataComponent.prototype.getSelectedTab = function (event) {
        this.selectedDrawingIds = '';
        this.selectedTab = event[0];
        this.floorSelected = false;
    };
    PlumbingDataComponent.prototype.getSelectedIds = function (event) {
        this.selectedDrawingIds = '';
    ...
    PlumbingDataComponent.prototype.pagepathchange = function (event) {
        this.pagePath = null;
        this.cdr.detectChanges();
        this.pagePath = "Plumbing / Data ";
        this.cdr.detectChanges();
    };
    PlumbingDataComponent = __decorate([
        core_1.Component({
            selector: 'plumbingData',
            templateUrl: './app/Views/Objects/Plumbing/plumbingData.component.html',
    ...
    ], PlumbingDataComponent);
    return PlumbingDataComponent;
}());
exports.PlumbingDataComponent = PlumbingDataComponent;
//# sourceMappingURL=plumbingData.component.js.map