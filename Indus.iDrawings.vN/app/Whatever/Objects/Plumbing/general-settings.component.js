...
var PlumbingGeneralSettingsComponent = (function () {
    function PlumbingGeneralSettingsComponent(administrationService) {
        this.administrationService = administrationService;
        this.pagePath = "Settings / Plumbing / General Settings ";
    ...
    PlumbingGeneralSettingsComponent.prototype.ngOnInit = function () {
        var context = this;
        this.administrationService.getSessionData().subscribe(function (data) {
            var retData = data["Data"];
            context.userRoleId = retData["UserRoleId"];
        });
        context.administrationService.getCustomerSubscribedFeatures("135,28").subscribe(function (rt) {
    ...
    PlumbingGeneralSettingsComponent.prototype.onSectionExpandChange = function (obj) {
    ...
    ;
    PlumbingGeneralSettingsComponent = __decorate([
        core_1.Component({
            selector: 'plumbing-general-settings',
            templateUrl: './app/Views/Objects/Plumbing/general-settings.component.html',
    ...
    ], PlumbingGeneralSettingsComponent);
    return PlumbingGeneralSettingsComponent;
}());
exports.PlumbingGeneralSettingsComponent = PlumbingGeneralSettingsComponent;
