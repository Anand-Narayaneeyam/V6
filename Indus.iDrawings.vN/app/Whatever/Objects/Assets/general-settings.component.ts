...
@Component({
    ...
    directives: [SectionComponent, PageComponent, ObjectClassesComponent,
        ...
        CustomReportGridComponent, ListDeficiencyCategoriesComponent, ListDeficiencyComponent, ColorPreferenceComponent,
        DefaultDisplayLayerComponent, CreateSymbolComponent]
})

export class AssetsGeneralSettingsComponent {
    pagePath ="Settings / Assets / General Settings "
