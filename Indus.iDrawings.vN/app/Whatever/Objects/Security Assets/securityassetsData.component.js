...
var SecurityAssetsDataComponent = (function () {
    function SecurityAssetsDataComponent(cdr) {
        this.pageTitle = "Data";
        this.selectedTab = 0;
    ...
    SecurityAssetsDataComponent.prototype.getSelectedTab = function (event) {
        this.selectedDrawingIds = '';
        this.selectedTab = event[0];
        this.floorSelected = false;
    };
    SecurityAssetsDataComponent.prototype.getSelectedIds = function (event) {
        this.selectedDrawingIds = '';
    ...
    SecurityAssetsDataComponent.prototype.pagepathchange = function (event) {
        this.pagePath = null;
        this.cdr.detectChanges();
        this.pagePath = "Security Assets  / Data ";
        this.cdr.detectChanges();
    };
    SecurityAssetsDataComponent = __decorate([
        core_1.Component({
    ...
    ], SecurityAssetsDataComponent);
    return SecurityAssetsDataComponent;
}());
exports.SecurityAssetsDataComponent = SecurityAssetsDataComponent;
//# sourceMappingURL=securityassetsData.component.js.map