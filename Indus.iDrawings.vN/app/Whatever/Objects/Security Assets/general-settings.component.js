...
var SecurityAssetsGeneralSettingsComponent = (function () {
    function SecurityAssetsGeneralSettingsComponent(administrationService) {
        this.administrationService = administrationService;
        this.pagePath = "Settings / Security Assets / General Settings ";
    ...
    SecurityAssetsGeneralSettingsComponent.prototype.ngOnInit = function () {
        var context = this;
    ...
    SecurityAssetsGeneralSettingsComponent.prototype.onSectionExpandChange = function (obj) {
    ...
    ;
    SecurityAssetsGeneralSettingsComponent = __decorate([
        core_1.Component({
            ...
            directives: [section_component_1.SectionComponent, page_component_1.PageComponent,
                objectclasses_component_1.ObjectClassesComponent, drawingmanagement_component_1.DrawingManagementComponent,
                ...
                connection_relationship_component_1.ConnectionRelationships, Listdeficiencycategories_1.ListDeficiencyCategoriesComponent,
                deficiencies_list_1.ListDeficiencyComponent, connectivity_rules_component_1.ConnectivityRules, color_preference_component_1.ColorPreferenceComponent,
    ...
    ], SecurityAssetsGeneralSettingsComponent);
    return SecurityAssetsGeneralSettingsComponent;
}());
exports.SecurityAssetsGeneralSettingsComponent = SecurityAssetsGeneralSettingsComponent;
