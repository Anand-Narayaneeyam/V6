...
@Component({
    ...
    directives: [SectionComponent, PageComponent, ObjectClassesComponent,
        DrawingManagementComponent, AttributesComponent, ClassAttributesComponent,
        CustomReportGridComponent, ConnectionRelationships, ConnectivityRules, ListDeficiencyCategoriesComponent, ListDeficiencyComponent, ColorPreferenceComponent,
        DefaultDisplayLayerComponent, CreateSymbolComponent]
})

export class ElectricalGeneralSettingsComponent {
    pagePath = "Settings / Electrical / General Settings "
