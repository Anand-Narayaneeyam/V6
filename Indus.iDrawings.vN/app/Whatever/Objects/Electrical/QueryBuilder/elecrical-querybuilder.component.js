...
var ElecricalQueryBuilderComponent = (function () {
    function ElecricalQueryBuilderComponent(objectsService) {
        this.objectsService = objectsService;
        this.dataoption = "1";
    }
    ElecricalQueryBuilderComponent.prototype.ngOnInit = function () {
        var contextObj = this;
    ...
    ElecricalQueryBuilderComponent.prototype.Next = function (event) {
    };
    ElecricalQueryBuilderComponent = __decorate([
        core_1.Component({
    ...
    ], ElecricalQueryBuilderComponent);
    return ElecricalQueryBuilderComponent;
}());
exports.ElecricalQueryBuilderComponent = ElecricalQueryBuilderComponent;
//# sourceMappingURL=elecrical-querybuilder.component.js.map