...
var ElectricalDataComponent = (function () {
    function ElectricalDataComponent(realpropertyservice, notificationService, cdr) {
        ...
        this.selectedDrawingIds = '';
        this.pagePath = "Electrical / Data";
        this.cdr = cdr;
    }
    ElectricalDataComponent.prototype.getSelectedTab = function (event) {
        this.selectedDrawingIds = '';
        this.selectedTab = event[0];
        this.floorSelected = false;
    };
    ElectricalDataComponent.prototype.getSelectedIds = function (event) {
        this.selectedDrawingIds = '';
    ...
    ElectricalDataComponent.prototype.pagepathchange = function (event) {
        this.pagePath = null;
        this.cdr.detectChanges();
        this.pagePath = "Electrical / Data ";
        this.cdr.detectChanges();
    };
    ElectricalDataComponent = __decorate([
        core_1.Component({
            selector: 'electricalData',
            templateUrl: './app/Views/Objects/Electrical/electricalData.component.html',
    ...
    return ElectricalDataComponent;
}());
exports.ElectricalDataComponent = ElectricalDataComponent;
//# sourceMappingURL=electricalData.component.js.map