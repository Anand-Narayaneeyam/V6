...
var MechanicalDataComponent = (function () {
    function MechanicalDataComponent(cdr) {
        this.pageTitle = "Data";
        this.selectedTab = 0;
    ...
    MechanicalDataComponent.prototype.getSelectedTab = function (event) {
        this.selectedDrawingIds = '';
        this.selectedTab = event[0];
        this.floorSelected = false;
    };
    MechanicalDataComponent.prototype.getSelectedIds = function (event) {
        this.selectedDrawingIds = '';
    ...
    MechanicalDataComponent.prototype.pagepathchange = function (event) {
        this.pagePath = null;
        this.cdr.detectChanges();
        this.pagePath = "Mechanical / Data ";
        this.cdr.detectChanges();
    };
    MechanicalDataComponent = __decorate([
        core_1.Component({
    ...
    ], MechanicalDataComponent);
    return MechanicalDataComponent;
}());
exports.MechanicalDataComponent = MechanicalDataComponent;
//# sourceMappingURL=mechanicalData.component.js.map