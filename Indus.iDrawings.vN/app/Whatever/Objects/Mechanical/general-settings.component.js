...
var MechanicalGeneralSettingsComponent = (function () {
    function MechanicalGeneralSettingsComponent(administrationService) {
        this.administrationService = administrationService;
        this.pagePath = "Settings / Mechanical / General Settings ";
    ...
    MechanicalGeneralSettingsComponent.prototype.ngOnInit = function () {
        var context = this;
    ...
    MechanicalGeneralSettingsComponent.prototype.onSectionExpandChange = function (obj) {
    ...
    ;
    MechanicalGeneralSettingsComponent = __decorate([
        core_1.Component({
            ...
            directives: [section_component_1.SectionComponent,
                page_component_1.PageComponent, objectclasses_component_1.ObjectClassesComponent, drawingmanagement_component_1.DrawingManagementComponent,
                attributes_component_1.AttributesComponent, class_attributes_component_1.ClassAttributesComponent,
    ...
    ], MechanicalGeneralSettingsComponent);
    return MechanicalGeneralSettingsComponent;
}());
exports.MechanicalGeneralSettingsComponent = MechanicalGeneralSettingsComponent;
