...
export class ClassAttributescomponentAddEdit implements OnInit {
    success: any;
    public ClassAttributesAddEdit: IField[];
    classname: any = "Class";
    ...
    postSubmit(contextObj, pageDetails: string, target: number) {        
        ...
        if (index > -1)
            ...
            if (contextObj.ClassAttributesAddEdit[2].FieldValue == 2) {
                arr[3].Value = "30";
                //contextObj.ClassAttributesAddEdit[3].FieldValue = 30;
            }
            else if (contextObj.ClassAttributesAddEdit[2].FieldValue == 3) {
                arr[3].Value = "9";
                //contextObj.ClassAttributesAddEdit[3].FieldValue = 9;
            }
