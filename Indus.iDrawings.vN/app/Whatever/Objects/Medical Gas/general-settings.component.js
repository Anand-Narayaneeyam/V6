...
var MedicalGasGeneralSettingsComponent = (function () {
    function MedicalGasGeneralSettingsComponent(administrationService) {
        this.administrationService = administrationService;
        this.pagePath = "Settings / Medical Gas / General Settings ";
    ...
    MedicalGasGeneralSettingsComponent.prototype.ngOnInit = function () {
        var context = this;
        this.administrationService.getSessionData().subscribe(function (data) {
            var retData = data["Data"];
            context.userRoleId = retData["UserRoleId"];
        });
        context.administrationService.getCustomerSubscribedFeatures("145,28").subscribe(function (rt) {
    ...
    MedicalGasGeneralSettingsComponent.prototype.onSectionExpandChange = function (obj) {
    ...
    ;
    MedicalGasGeneralSettingsComponent = __decorate([
        core_1.Component({
            selector: 'medicalgas-general-settings',
            templateUrl: './app/Views/Objects/Medical Gas/general-settings.component.html',
    ...
    ], MedicalGasGeneralSettingsComponent);
    return MedicalGasGeneralSettingsComponent;
}());
exports.MedicalGasGeneralSettingsComponent = MedicalGasGeneralSettingsComponent;
