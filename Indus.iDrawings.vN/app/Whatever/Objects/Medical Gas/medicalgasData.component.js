...
var MedicalGasDataComponent = (function () {
    function MedicalGasDataComponent(cdr) {
        this.pageTitle = "Data";
        this.selectedTab = 0;
        this.floorSelected = false;
        this.selectedDrawingIds = '';
        this.selectedDrawingIds = '';
        this.pagePath = "Medical Gas / Data";
        this.cdr = cdr;
    }
    MedicalGasDataComponent.prototype.getSelectedTab = function (event) {
        this.selectedDrawingIds = '';
        this.selectedTab = event[0];
        this.floorSelected = false;
    };
    MedicalGasDataComponent.prototype.getSelectedIds = function (event) {
        this.selectedDrawingIds = '';
    ...
    MedicalGasDataComponent.prototype.pagepathchange = function (event) {
        this.pagePath = null;
        this.cdr.detectChanges();
        this.pagePath = "Medical Gas / Data ";
        this.cdr.detectChanges();
    };
    MedicalGasDataComponent = __decorate([
        core_1.Component({
            selector: 'medicalgasData',
            templateUrl: './app/Views/Objects/Medical Gas/medicalgasData.component.html',
    ...
    ], MedicalGasDataComponent);
    return MedicalGasDataComponent;
}());
exports.MedicalGasDataComponent = MedicalGasDataComponent;
//# sourceMappingURL=medicalgasData.component.js.map