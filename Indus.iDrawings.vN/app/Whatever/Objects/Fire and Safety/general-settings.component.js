...
var FireandSafetyGeneralSettingsComponent = (function () {
    function FireandSafetyGeneralSettingsComponent(administrationService) {
        this.administrationService = administrationService;
        this.pagePath = "Settings / Fire and Safety / General Settings ";
    ...
    FireandSafetyGeneralSettingsComponent.prototype.ngOnInit = function () {
        var context = this;
        this.administrationService.getSessionData().subscribe(function (data) {
            var retData = data["Data"];
            context.userRoleId = retData["UserRoleId"];
        });
        context.administrationService.getCustomerSubscribedFeatures("95,28").subscribe(function (rt) {
    ...
    FireandSafetyGeneralSettingsComponent.prototype.onSectionExpandChange = function (obj) {
    ...
    ;
    FireandSafetyGeneralSettingsComponent = __decorate([
        core_1.Component({
            selector: 'fireandsafety-general-settings',
            templateUrl: './app/Views/Objects/Fire and Safety/general-settings.component.html',
            directives: [section_component_1.SectionComponent, page_component_1.PageComponent, objectclasses_component_1.ObjectClassesComponent,
                drawingmanagement_component_1.DrawingManagementComponent, attributes_component_1.AttributesComponent,
                class_attributes_component_1.ClassAttributesComponent, customreport_grid_component_1.CustomReportGridComponent,
                ...
                deficiencies_list_1.ListDeficiencyComponent, color_preference_component_1.ColorPreferenceComponent,
    ...
    ], FireandSafetyGeneralSettingsComponent);
    return FireandSafetyGeneralSettingsComponent;
}());
exports.FireandSafetyGeneralSettingsComponent = FireandSafetyGeneralSettingsComponent;
