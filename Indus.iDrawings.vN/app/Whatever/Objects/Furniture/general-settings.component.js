...
var FurnitureGeneralSettingsComponent = (function () {
    function FurnitureGeneralSettingsComponent(administrationService) {
        this.administrationService = administrationService;
        this.pagePath = "Settings / Furniture / General Settings ";
    ...
    FurnitureGeneralSettingsComponent.prototype.ngOnInit = function () {
        var context = this;
    ...
    FurnitureGeneralSettingsComponent.prototype.onSectionExpandChange = function (obj) {
    ...
    ;
    FurnitureGeneralSettingsComponent = __decorate([
        core_1.Component({
    ...
    ], FurnitureGeneralSettingsComponent);
    return FurnitureGeneralSettingsComponent;
}());
exports.FurnitureGeneralSettingsComponent = FurnitureGeneralSettingsComponent;
