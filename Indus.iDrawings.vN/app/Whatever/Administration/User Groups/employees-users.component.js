...
var EmployeeUsersComponent = (function () {
    function EmployeeUsersComponent(administrationService, notificationService) {
        var _this = this;
        this.administrationService = administrationService;
        this.notificationService = notificationService;
        this.inputItems = { dataKey: "Id", groupBy: [], grpWithCheckBx: true };
        administrationService.getEmployeesUsersFields().subscribe(function (result) { return _this.fieldObject = result["data"]; }, function (error) { return _this.errorMessage = error; });
        administrationService.getEmployeesUsersData().subscribe(function (fieldDetails) { return _this.itemsSource = fieldDetails["data"]; }, function (error) { return _this.errorMessage = error; });
    }
    EmployeeUsersComponent.prototype.updateEmployeeUsers = function () {
    ...
    EmployeeUsersComponent = __decorate([
        core_1.Component({
...
exports.EmployeeUsersComponent = EmployeeUsersComponent;
//# sourceMappingURL=employees-users.component.js.map