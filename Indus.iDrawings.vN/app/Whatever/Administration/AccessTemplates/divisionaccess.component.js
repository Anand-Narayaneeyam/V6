...
var DivisionAccessComponent = (function () {
    function DivisionAccessComponent(administrationService, notificationService) {
    ...
    DivisionAccessComponent.prototype.updateDivisionAccess = function () {
    ...
    DivisionAccessComponent = __decorate([
        core_1.Component({
    ...
    ], DivisionAccessComponent);
    return DivisionAccessComponent;
}());
exports.DivisionAccessComponent = DivisionAccessComponent;
//# sourceMappingURL=divisionaccess.component.js.map