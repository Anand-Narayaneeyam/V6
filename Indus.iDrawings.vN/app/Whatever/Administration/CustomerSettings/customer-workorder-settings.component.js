...
var CustomerWorkorderSettingsComponent = (function () {
    function CustomerWorkorderSettingsComponent(_validateService, _notificationService, _objAdministrationService, notificationService) {
        var _this = this;
    ...
    CustomerWorkorderSettingsComponent.prototype.LoadAllDetails = function () {
        var contextObj = this;
        var length;
    ...
    CustomerWorkorderSettingsComponent.prototype.SetDefaultValueForSubComponent = function (Position, FieldId) {
        var contextObj = this;
        var isvalidate = true;
        if (Position == -1) {
            isvalidate = false;
    ...
    CustomerWorkorderSettingsComponent.prototype.chkBoxChange = function (event) {
        var contextObj = this;
        var length;
        length = contextObj.subscribeddetails.length;
        contextObj.fieldDetails.find(function (item) {
    ...
    CustomerWorkorderSettingsComponent.prototype.SelectAll = function (event) {
        var contextObj = this;
    ...
    CustomerWorkorderSettingsComponent.prototype.showComponent = function (fieldName, isVisible) {
        if (isVisible == false) {
            return "none";
        }
        else {
    ...
    CustomerWorkorderSettingsComponent.prototype.updateSubscribedFeature = function (event) {
        var contextObj = this;
        var FeatureDetails = "[";
        var length = contextObj.fieldDetails.length;
    ...
    CustomerWorkorderSettingsComponent.prototype.ChangeMargin = function (Fieldid) {
        var contextObj = this;
        var Margin;
        contextObj.subscribeddetails.find(function (item) {
    ...
    CustomerWorkorderSettingsComponent.prototype.onChangeDataFieldCategory = function (event) {
        //this.notificationService.ShowToaster("dropdown changed has been updated", 3);
    };
    CustomerWorkorderSettingsComponent.prototype.rbtnChange = function (event) {
        var contextObj = this;
        var length;
        length = contextObj.subscribeddetails.length;
        var Parent;
    ...
    ], CustomerWorkorderSettingsComponent.prototype, "ModuleSelect", void 0);
    __decorate([
        core_1.Input(), 
        __metadata('design:type', Number)
    ], CustomerWorkorderSettingsComponent.prototype, "FormId", void 0);
    __decorate([
        core_1.Input(), 
        __metadata('design:type', Number)
    ], CustomerWorkorderSettingsComponent.prototype, "ModuleId", void 0);
    __decorate([
        core_1.Input(), 
        __metadata('design:type', Number)
    ], CustomerWorkorderSettingsComponent.prototype, "ParentModuleId", void 0);
    __decorate([
        core_1.Input(), 
        __metadata('design:type', String)
    ], CustomerWorkorderSettingsComponent.prototype, "Modulename", void 0);
    __decorate([
        core_1.Input(), 
        __metadata('design:type', Boolean)
    ], CustomerWorkorderSettingsComponent.prototype, "Moduleenabled", void 0);
    CustomerWorkorderSettingsComponent = __decorate([
        core_1.Component({
    ...
    ], CustomerWorkorderSettingsComponent);
    return CustomerWorkorderSettingsComponent;
}());
exports.CustomerWorkorderSettingsComponent = CustomerWorkorderSettingsComponent;
//# sourceMappingURL=customer-workorder-settings.component.js.map