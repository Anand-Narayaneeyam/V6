...
var CustomerCommonSettingsComponent = (function () {
    function CustomerCommonSettingsComponent(_validateService, _notificationService, _objAdministrationService, notificationService) {
        var _this = this;
    ...
    CustomerCommonSettingsComponent.prototype.ngOnInit = function () {
        ...
        contextObj._objAdministrationService.getSubscribedFeaturesWithFields(contextObj.FormId, contextObj.ModuleId).subscribe(function (resultData) {
            ...
            contextObj._objAdministrationService.getAdminstnCustomerSettingsFormFields(contextObj.FormId).subscribe(function (resultData) {
                ...
                contextObj._objAdministrationService.getCustomerSubscribedFeatures("278").subscribe(function (resultData) {
                    var OtherSubscribeddetails = resultData["Data"];
                    if (contextObj.FormId == 387) {
                        for (var i = 0; i < OtherSubscribeddetails.length; i++) {
                            if (OtherSubscribeddetails[i]["IsSubscribed"] == 1 || OtherSubscribeddetails[i]["IsSubscribed"] == true) {
                                switch (OtherSubscribeddetails[i]["Id"]) {
                                    case 278:
                                        contextObj.IsBaseTeamReservation = true;
                                        break;
                                }
                            }
                        }
                    ...
                    for (var i = 0; i < length; i++) {
                        ...
                        if (contextObj.FormId == 387) {
                            if (contextObj.fieldDetails[i]["FieldId"] == 2732 && contextObj.IsBaseTeamReservation) {
    ...
    CustomerCommonSettingsComponent.prototype.LoadAllDetails = function () {
        var contextObj = this;
        var length;
    ...
    CustomerCommonSettingsComponent.prototype.SetDefaultValueForSubComponent = function (Position, FieldId) {
        var contextObj = this;
        var isvalidate = true;
        if (Position == -1) {
            isvalidate = false;
    ...
    CustomerCommonSettingsComponent.prototype.chkBoxChange = function (event) {
        var contextObj = this;
        var length;
        length = contextObj.subscribeddetails.length;
        contextObj.fieldDetails.find(function (item) {
    ...
    CustomerCommonSettingsComponent.prototype.SelectAll = function (event) {
        var contextObj = this;
    ...
    CustomerCommonSettingsComponent.prototype.showComponent = function (fieldName, isVisible) {
        if (isVisible == false) {
            return "none";
        }
        else {
    ...
    CustomerCommonSettingsComponent.prototype.updateSubscribedFeature = function (event) {
        var contextObj = this;
        var FeatureDetails = "[";
        var length = contextObj.fieldDetails.length;
    ...
    CustomerCommonSettingsComponent.prototype.ChangeMargin = function (Fieldid) {
        var contextObj = this;
        var Margin;
        contextObj.subscribeddetails.find(function (item) {
    ...
    CustomerCommonSettingsComponent.prototype.onChangeDataFieldCategory = function (event) {
        //this.notificationService.ShowToaster("dropdown changed has been updated", 3);
    };
    CustomerCommonSettingsComponent.prototype.rbtnChange = function (event) {
        var contextObj = this;
        var length;
        length = contextObj.subscribeddetails.length;
        var Parent;
    ...
    ], CustomerCommonSettingsComponent.prototype, "ModuleSelect", void 0);
    __decorate([
        core_1.Input(), 
        __metadata('design:type', Number)
    ], CustomerCommonSettingsComponent.prototype, "FormId", void 0);
    __decorate([
        core_1.Input(), 
        __metadata('design:type', Number)
    ], CustomerCommonSettingsComponent.prototype, "ModuleId", void 0);
    __decorate([
        core_1.Input(), 
        __metadata('design:type', Number)
    ], CustomerCommonSettingsComponent.prototype, "ParentModuleId", void 0);
    __decorate([
        core_1.Input(), 
        __metadata('design:type', String)
    ], CustomerCommonSettingsComponent.prototype, "Modulename", void 0);
    __decorate([
        core_1.Input(), 
        __metadata('design:type', Boolean)
    ], CustomerCommonSettingsComponent.prototype, "Moduleenabled", void 0);
    CustomerCommonSettingsComponent = __decorate([
        core_1.Component({
            selector: 'customer-common-settings',
            templateUrl: 'app/Views/Administration/CustomerSettings/customer-common-settings.component.html',
    ...
    ], CustomerCommonSettingsComponent);
    return CustomerCommonSettingsComponent;
}());
exports.CustomerCommonSettingsComponent = CustomerCommonSettingsComponent;
//# sourceMappingURL=customer-common-settings.component.js.map