...
var OrganizationalStructureComponent = (function () {
    function OrganizationalStructureComponent(administrationService, notificationService, getData) {
        ...
        this.success = "";
        this.dataKey = "";
        this.restrictedWordsArray = ["team"];
    }
    OrganizationalStructureComponent.prototype.ngOnInit = function () {
        var contextObj = this;
    ...
    OrganizationalStructureComponent.prototype.onSubmitData = function (event) {
        // let oldData:any
        //this.administrationService.getOrganizationalStructureFields(34).subscribe(function (resultData) {
        //    debugger
        ...
        var isValid = true;
        var fieldValues = contextObj.getData.getFieldValuesAsReportFieldArray(contextObj.organizationalStructureFields);
        ...
        if (jsonobject) {
            ...
            for (var i = 0; i < jsonobject.length; i++) {
                switch (i) {
                    case 0:
                        level1 = jsonobject[i].FieldValue;
                        break;
                    case 1:
                        level1Short = jsonobject[i].FieldValue;
                        break;
                    case 2:
                        level2 = jsonobject[i].FieldValue;
                        break;
                    case 3:
                        level2Short = jsonobject[i].FieldValue;
                        break;
                    case 4:
                        level3 = jsonobject[i].FieldValue;
                        break;
                    case 5:
                        level3Short = jsonobject[i].FieldValue;
                        break;
                    case 6:
                        level4 = jsonobject[i].FieldValue;
                        break;
                    case 7:
                        level4Short = jsonobject[i].FieldValue;
                        break;
                    case 8:
                        level5 = jsonobject[i].FieldValue;
                        break;
                    case 9:
                        level5Short = jsonobject[i].FieldValue;
                        break;
                }
            }
    ...
    OrganizationalStructureComponent = __decorate([
        core_1.Component({
    ...
    return OrganizationalStructureComponent;
}());
exports.OrganizationalStructureComponent = OrganizationalStructureComponent;
//# sourceMappingURL=organizational-structure.component.js.map