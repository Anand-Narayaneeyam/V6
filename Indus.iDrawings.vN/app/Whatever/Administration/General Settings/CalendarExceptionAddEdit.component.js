...
var CalendarExceptionAddEditComponent = (function () {
    function CalendarExceptionAddEditComponent(administrationService, _notificationService, validateService, elemRef) {
        ...
        this.ddlDisableShowSelect = [2887, 2906, 2894, 2907, 2904, 2893, 2901, 2892, 2903, 2902, 2908];
        this.ddlOnChangeMonthly = [2893, 2901, 2892, 2903, 2902];
        this.ddlOnChangeYearly = [2906, 2894, 2907, 2904, 2908];
        this.ddlOnChangeMonthlyDay = [2893, 2901];
        this.ddlOnChangeMonthlyThe = [2892, 2903, 2902];
        this.ddlOnChangeYearlyOn = [2906, 2894];
        this.ddlOnChangeYearlyThe = [2907, 2904, 2908];
        this.ddlOnChangeDaily = [2887];
        this.ddlOnChangeWeekly = [2887];
        this.ddlOnChangeRecFrequency = [2895];
        this.showHideArrayPre = [2887, 2889, 2888, 2893, 2892, 2901, 2903, 2902, 2905, 2906, 2894, 2907, 2904, 2908];
        this.showHideArray1Pre = [2887]; //show daily 
        this.showHideArray2Pre = [2887, 2889]; //show weekly days  
        this.showHideArray3Pre = [2888, 2893, 2892, 2901, 2903, 2902]; //show monthly fields
        this.showHideArray4Pre = [2905, 2906, 2894, 2907, 2904, 2908]; // show yearly fields
        this.showHideArrayRecRangeDDL = [2895];
        this.showHideArrayRecRangeDatePicker = [2896];
        this.HideArray3Pre = [2893, 2901, 2892, 2903, 2902];
        this.showHideArray3of1Pre = [2893, 2901];
        this.showHideArray3of2Pre = [2892, 2903, 2902];
        this.HideArray4Pre = [2906, 2894, 2907, 2904, 2908];
        this.showHideArray4of1Pre = [2906, 2894];
        this.showHideArray4of2Pre = [2907, 2904, 2908];
    ...
    CalendarExceptionAddEditComponent.prototype.ngOnInit = function () {
        //this.loadFields(this.action);
    };
    CalendarExceptionAddEditComponent.prototype.ngDoCheck = function () {
        ...
        if (this.iselementinsert) {
            var changetimeElement = document.getElementById("changetime"), WorkingRadioElement = this.elref.nativeElement.getElementsByClassName("MainContainer_2885"), dynamiclistElement = this.elref.nativeElement.getElementsByClassName("list-group");
    ...
    CalendarExceptionAddEditComponent.prototype.ngOnChanges = function (changes) {
        var contextObj = this;
        //this.loadFields(this.action);
    ...
    CalendarExceptionAddEditComponent.prototype.loadFields = function (action) {
        var contextObj = this;
        this.exceptionAddEditfields.find(function (item) { if (item.FieldId == 2885) {
            return item.FieldLabel = "";
        } });
        this.exceptionAddEditfields.find(function (item) { if (item.FieldId == 2891) {
            return item.FieldLabel = "";
        } });
        this.exceptionAddEditfields.find(function (item) { if (item.FieldId == 2889) {
            return item.FieldLabel = "week(s) on:";
        } });
        this.exceptionAddEditfields.find(function (item) { if (item.FieldId == 2901) {
            return item.FieldLabel = "of every month(s)";
        } });
        this.exceptionAddEditfields.find(function (item) { if (item.FieldId == 2893) {
            return item.FieldLabel = "";
        } });
        this.exceptionAddEditfields.find(function (item) { if (item.FieldId == 2892) {
            return item.FieldLabel = "";
        } });
        this.exceptionAddEditfields.find(function (item) { if (item.FieldId == 2903) {
            return item.FieldLabel = "";
        } });
        this.exceptionAddEditfields.find(function (item) { if (item.FieldId == 2902) {
            return item.FieldLabel = "of every month(s)";
        } });
        this.exceptionAddEditfields.find(function (item) { if (item.FieldId == 2905) {
            return item.FieldLabel = "";
        } });
        this.exceptionAddEditfields.find(function (item) { if (item.FieldId == 2906) {
            return item.FieldLabel = "";
        } });
        this.exceptionAddEditfields.find(function (item) { if (item.FieldId == 2894) {
            return item.FieldLabel = "";
        } });
        this.exceptionAddEditfields.find(function (item) { if (item.FieldId == 2907) {
            return item.FieldLabel = "";
        } });
        this.exceptionAddEditfields.find(function (item) { if (item.FieldId == 2904) {
            return item.FieldLabel = "";
        } });
        this.exceptionAddEditfields.find(function (item) { if (item.FieldId == 2904) {
            return item.FieldLabel = "";
        ...
        this.exceptionAddEditfields.find(function (item) { if (item.FieldId == 2908) {
            return item.FieldLabel = "of";
        } });
        this.exceptionAddEditfields.find(function (item) { if (item.FieldId == 2895) {
            return item.FieldLabel = "";
        } });
        this.exceptionAddEditfields.find(function (item) { if (item.FieldId == 2896) {
            return item.FieldLabel = "";
        } });
        this.exceptionAddEditfields.find(function (item) { if (item.FieldId == 2888) {
            return item.FieldLabel = "";
        } });
        this.exceptionAddEditfields.find(function (item) { if (item.FieldId == 2887) {
            return item.FieldLabel = "Recur every";
        } });
        ...
        if (contextObj.fieldDetailsEdit) {
            if (contextObj.fieldDetailsEdit.IsWorkDay == 0) {
                ...
                for (var cnt = 0; cnt < this.itemsSourceGrid.length; cnt++) {
                    this.workTimeList.push((_a = {}, _a["StartTime"] = this.itemsSourceGrid[cnt]["Start Time"], _a["EndTime"] = this.itemsSourceGrid[cnt]["End Time"], _a));
                }
            }
    ...
    CalendarExceptionAddEditComponent.prototype.initiateValidation = function (id, fieldObject) {
        var contextObj = this;
    ...
    CalendarExceptionAddEditComponent.prototype.reRenderCriteria = function (targetRecId) {
        switch (targetRecId) {
            case "1":
    ...
    CalendarExceptionAddEditComponent.prototype.showDailyFields = function () {
    ...
    CalendarExceptionAddEditComponent.prototype.showWeeklyFields = function () {
        for (var i = 0; i < this.fieldDetails.length; i++) {
    ...
    CalendarExceptionAddEditComponent.prototype.showMonthlyFields = function () {
        for (var i = 0; i < this.fieldDetails.length; i++) {
    ...
    CalendarExceptionAddEditComponent.prototype.showYearlyFields = function () {
        for (var i = 0; i < this.fieldDetails.length; i++) {
    ...
    CalendarExceptionAddEditComponent.prototype.refreshMontlyDayThe = function () {
        for (var i = 0; i < this.fieldDetails.length; i++) {
    ...
    CalendarExceptionAddEditComponent.prototype.showMonthlyDay = function () {
        for (var i = 0; i < this.fieldDetails.length; i++) {
    ...
    CalendarExceptionAddEditComponent.prototype.showMonthlyThe = function () {
        for (var i = 0; i < this.fieldDetails.length; i++) {
    ...
    CalendarExceptionAddEditComponent.prototype.refreshYearlyOnThe = function () {
        for (var i = 0; i < this.fieldDetails.length; i++) {
    ...
    CalendarExceptionAddEditComponent.prototype.showYearlyOn = function () {
        for (var i = 0; i < this.fieldDetails.length; i++) {
    ...
    CalendarExceptionAddEditComponent.prototype.showYearlyThe = function () {
        for (var i = 0; i < this.fieldDetails.length; i++) {
    ...
    CalendarExceptionAddEditComponent.prototype.refreshBeforeRender = function () {
        for (var i = 0; i < this.fieldDetails.length; i++) {
    ...
    CalendarExceptionAddEditComponent.prototype.refreshRecRangeDDL = function () {
        for (var i = 0; i < this.fieldDetails.length; i++) {
    ...
    CalendarExceptionAddEditComponent.prototype.refreshRecRangeDatePicker = function () {
        for (var i = 0; i < this.fieldDetails.length; i++) {
    ...
    CalendarExceptionAddEditComponent.prototype.enableRecFields = function () {
        ...
        var parentddlField = this.elref.nativeElement.getElementsByClassName("MainContainer_2895");
    ...
    CalendarExceptionAddEditComponent.prototype.clearDDlShowSelect = function () {
        for (var i = 0; i < this.fieldDetails.length; i++) {
    ...
    CalendarExceptionAddEditComponent.prototype.enableMonthlyDay = function () {
        for (var i = 0; i < this.fieldDetails.length; i++) {
    ...
    CalendarExceptionAddEditComponent.prototype.enableMonthlyThe = function () {
        for (var i = 0; i < this.fieldDetails.length; i++) {
    ...
    CalendarExceptionAddEditComponent.prototype.enableYearlyOn = function () {
        for (var i = 0; i < this.fieldDetails.length; i++) {
    ...
    CalendarExceptionAddEditComponent.prototype.enableYearlyThe = function () {
        for (var i = 0; i < this.fieldDetails.length; i++) {
    ...
    CalendarExceptionAddEditComponent.prototype.enableDaily = function () {
        for (var i = 0; i < this.fieldDetails.length; i++) {
    ...
    CalendarExceptionAddEditComponent.prototype.enableWeekly = function () {
        for (var i = 0; i < this.fieldDetails.length; i++) {
    ...
    CalendarExceptionAddEditComponent.prototype.enableRecFrequency = function () {
        for (var i = 0; i < this.fieldDetails.length; i++) {
    ...
    CalendarExceptionAddEditComponent.prototype.enableRecDatePicker = function () {
        var datePickerRecRange = this.fieldDetails.find(function (item) {
            return item.FieldId === 2896;
        });
    ...
    CalendarExceptionAddEditComponent.prototype.getFormattedDate = function (dt) {
        var strDate = "";
        var date;
        if (dt != undefined) {
            date = new Date(dt);
    ...
    CalendarExceptionAddEditComponent.prototype.radioBtnChange = function (event) {
        debugger;
    ...
    CalendarExceptionAddEditComponent.prototype.showRecRangeDDL = function () {
    ...
    CalendarExceptionAddEditComponent.prototype.showRecRangeDatePicker = function () {
    ...
    CalendarExceptionAddEditComponent.prototype.onSubmitData = function (event) {
        debugger;
        var dateError = false;
    ...
    CalendarExceptionAddEditComponent.prototype.postSubmit = function (strsubmitField) {
        var contextObj = this;
        debugger;
    ...
    //    debugger
    //}
    CalendarExceptionAddEditComponent.prototype.fieldChange = function ($evevt) {
        debugger;
    };
    CalendarExceptionAddEditComponent.prototype.ChangeTimeClick = function (event) {
        debugger;
        this.pageTitle = "Working Time";
        this.workTime = this.itemsSource;
        this.splitviewInput.showSecondaryView = !this.splitviewInput.showSecondaryView;
    };
    CalendarExceptionAddEditComponent.prototype.submitWorkTime = function (event) {
        debugger;
        var retdata = event.returnData;
        this.workTimeList = [];
        for (var cnt = 0; cnt < retdata.length; cnt++) {
            this.workTimeList.push((_a = {}, _a["Start Time"] = retdata[cnt]["Start Time"], _a["End Time"] = retdata[cnt]["End Time"], _a["StartTime"] = retdata[cnt]["Start Time"], _a["EndTime"] = retdata[cnt]["End Time"], _a));
        }
        this.itemsSourceGrid = [];
    ...
    ], CalendarExceptionAddEditComponent.prototype, "action", void 0);
    __decorate([
        core_1.Input(), 
        __metadata('design:type', Object)
    ], CalendarExceptionAddEditComponent.prototype, "exceptionAddEditfields", void 0);
    __decorate([
        core_1.Input(), 
        __metadata('design:type', Object)
    ], CalendarExceptionAddEditComponent.prototype, "fieldDetailsEdit", void 0);
    __decorate([
        core_1.Output(), 
        __metadata('design:type', Object)
    ], CalendarExceptionAddEditComponent.prototype, "submitSuccess", void 0);
    CalendarExceptionAddEditComponent = __decorate([
        core_1.Component({
            ...
            directives: [fieldGeneration_component_1.FieldComponent, grid_component_1.GridComponent, split_view_component_1.SplitViewComponent, setWorkingTime_component_1.SetWorkingTimeComponent],
            inputs: ['selectedId', 'action', 'exceptionAddEditfields', 'btnName', 'fieldDetailsEdit', 'CalendarId'],
            encapsulation: core_1.ViewEncapsulation.None
        }), 
        __metadata('design:paramtypes', [administration_service_1.AdministrationService, notify_service_1.NotificationService, validation_service_1.ValidateService, core_1.ElementRef])
    ], CalendarExceptionAddEditComponent);
    return CalendarExceptionAddEditComponent;
}());
exports.CalendarExceptionAddEditComponent = CalendarExceptionAddEditComponent;
//# sourceMappingURL=CalendarExceptionAddEdit.component.js.map