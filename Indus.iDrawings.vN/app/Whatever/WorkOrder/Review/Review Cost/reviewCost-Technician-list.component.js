...
var ReviewTechniciansComponent = (function () {
    function ReviewTechniciansComponent(administrationServices, workOrderService, notificationService, generFun) {
        ...
        this.types = true;
        this.pageTitle = "Select Technicians";
        this.menuData = [
            {
                "id": 1,
                "title": "Add",
    ...
    ReviewTechniciansComponent.prototype.ngAfterViewInit = function () {
        var contextObj = this;
    ...
    ReviewTechniciansComponent.prototype.dataLoad = function (target) {
        var contextObj = this;
        debugger;
    ...
    ReviewTechniciansComponent.prototype.getWorkFlowEntityReportFieldIdValues = function () {
        var tempArray = [];
    ...
    ReviewTechniciansComponent.prototype.onSubMenuChange = function (event) {
        switch (event.value) {
            case 1:
                this.addClick();
                break;
    ...
    ReviewTechniciansComponent.prototype.onTechnicianSubmit = function (event) {
        ...
        var technicianField = this.fieldDetailsAdd1.find(function (item) {
            return item.ReportFieldId === 1383;
        });
        if (technicianField.MultiFieldValues != null) {
            for (var _i = 0, _a = technicianField.MultiFieldValues; _i < _a.length; _i++) {
                var item = _a[_i];
    ...
    ReviewTechniciansComponent.prototype.onCellUpdate = function (event) {
        debugger;
        this.onCostUpdate.emit(event);
    };
    ReviewTechniciansComponent.prototype.addClick = function () {
        var contextObj = this;
        this.action = "add";
        this.btnName = "Save";
        this.workOrderService.loadReviewTechnicianAdd(contextObj.getLookupWorkFlowEntityReportFieldIdValues(0, "add")).subscribe(function (resultData) {
            ...
            var technicianField = contextObj.fieldDetailsAdd1.find(function (item) {
                return item.ReportFieldId === 1383;
            });
    ...
    ReviewTechniciansComponent.prototype.getLookupWorkFlowEntityReportFieldIdValues = function (siteId, target) {
        if (target == "add") {
            var tempArray = [];
    ...
    ReviewTechniciansComponent.prototype.onDropDownChange = function (event) {
        var contextObj = this;
        switch (event.FieldId) {
            case 1321:
                contextObj.workOrderService.getValuesWithDbObjectDetails(50735, contextObj.getLookupWorkFlowEntityReportFieldIdValues(event.FieldValue == "-1" ? "0" : event.FieldValue, "dropDown")).subscribe(function (resultData) {
                    var technicianName = contextObj.fieldDetailsAdd1.find(function (item) {
    ...
    ReviewTechniciansComponent.prototype.deleteClick = function () {
    ...
    ReviewTechniciansComponent.prototype.updateFieldDetails = function (fieldDetailsArray) {
        var contextObj = this;
    ...
    /*slide events*/
    ReviewTechniciansComponent.prototype.okDelete = function (event) {
        this.showSlide = !this.showSlide;
        this.onDelete.emit(this.inputItems.selectedIds);
    };
    ReviewTechniciansComponent.prototype.cancelClick = function (event) {
        this.showSlide = !this.showSlide;
    };
    ReviewTechniciansComponent.prototype.closeSlideDialog = function (value) {
        this.showSlide = value.value;
    };
    __decorate([
        core_1.Output(), 
        __metadata('design:type', Object)
    ], ReviewTechniciansComponent.prototype, "itemSourceUpdate", void 0);
    __decorate([
        core_1.Output(), 
        __metadata('design:type', Object)
    ], ReviewTechniciansComponent.prototype, "onSubmit", void 0);
    __decorate([
        core_1.Output(), 
        __metadata('design:type', Object)
    ], ReviewTechniciansComponent.prototype, "onDelete", void 0);
    __decorate([
        core_1.Output(), 
        __metadata('design:type', Object)
    ], ReviewTechniciansComponent.prototype, "onCostUpdate", void 0);
    ReviewTechniciansComponent = __decorate([
        core_1.Component({
    ...
    ], ReviewTechniciansComponent);
    return ReviewTechniciansComponent;
}());
exports.ReviewTechniciansComponent = ReviewTechniciansComponent;
//# sourceMappingURL=reviewCost-Technician-list.component.js.map