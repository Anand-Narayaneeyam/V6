...
var PMSchedulesAddEditComponent = (function () {
    function PMSchedulesAddEditComponent(workOrdereService, notificationService, el) {
        this.workOrdereService = workOrdereService;
        this.notificationService = notificationService;
        this.el = el;
        this.dataKey = "Id";
        this.isMeterBased = false;
        this.isApplyUpdatesforMasterPM = false;
        this.isAutoGeneratedWorkOrder = false;
        this.ngStatus = false;
        this.submitSuccess = new core_1.EventEmitter();
    }
    PMSchedulesAddEditComponent.prototype.ngOnInit = function () {
    ...
    PMSchedulesAddEditComponent.prototype.onSubmitData = function (event) {
        var contextObj = this;
        switch (this.action) {
            case "add":
    ...
    PMSchedulesAddEditComponent.prototype.ngDoCheck = function () {
        var context = this;
    ...
    PMSchedulesAddEditComponent.prototype.ngOnChanges = function (changes) {
        if (changes["fieldDetailsAddEdit"] && changes["fieldDetailsAddEdit"]["currentValue"] != undefined) {
            this.fieldDetailsAddEditChk = undefined;
            this.ngStatus = false;
        }
    };
    PMSchedulesAddEditComponent.prototype.postSubmit = function (contextObj, pageDetails, target) {
    ...
    PMSchedulesAddEditComponent.prototype.rbtnOnChange = function (event, target) {
        var contextObj = this;
        var value;
        if (target != null) {
            value = target;
    ...
    PMSchedulesAddEditComponent.prototype.checkBoxChange = function (event) {
        var contextObj = this;
    ...
    PMSchedulesAddEditComponent.prototype.fieldChange = function (event) {
        var contextObj = this;
    ...
    PMSchedulesAddEditComponent.prototype.lstBoxChange = function (event) {
        var contextObj = this;
        var arrList = [];
        var fieldLabel = event["listChangeObject"]["fieldObject"]["FieldLabel"];
        if (this.scheduleTypesRouteId > -1 && fieldLabel == "Equipment No.") {
            var tempIds = event["listChangeObject"]["fieldObject"]["MultiFieldValues"];
            if (tempIds.length > 0) {
                var temp = event["listChangeObject"]["fieldObject"]["LookupDetails"]["LookupValues"];
                var classId = 0;
    ...
    PMSchedulesAddEditComponent.prototype.loadReccurencePatternFromMastePM = function (masterPMDetails) {
        var contextObj = this;
    ...
    PMSchedulesAddEditComponent.prototype.clearFieldDetails = function () {
        var contextObj = this;
        if (this.scheduleTypesRouteId == -1) {
            this.ckblEquipmentNo.IsMandatory = true;
            this.ckblEquipmentNo.IsEnabled = false;
    ...
    ], PMSchedulesAddEditComponent.prototype, "action", void 0);
    __decorate([
        core_1.Output(), 
        __metadata('design:type', Object)
    ], PMSchedulesAddEditComponent.prototype, "submitSuccess", void 0);
    PMSchedulesAddEditComponent = __decorate([
        core_1.Component({
    ...
    ], PMSchedulesAddEditComponent);
    return PMSchedulesAddEditComponent;
}());
exports.PMSchedulesAddEditComponent = PMSchedulesAddEditComponent;
//# sourceMappingURL=pmschedules-addedit.js.map