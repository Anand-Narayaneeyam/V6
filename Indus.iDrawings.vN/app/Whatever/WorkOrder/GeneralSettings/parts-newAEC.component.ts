...
@Component({
    ...
    providers: [HTTP_PROVIDERS, WorkOrdereService, NotificationService, GeneralFunctions],
    inputs: ['target', 'equipmentId']
})

export class NewAssociateEquipmentComponent implements AfterViewInit {
    target: number;
    equipmentId: number;
    totalItems: number = 0;
    ...
    constructor(private workOrderService: WorkOrdereService, private notificationService: NotificationService, private getData: GeneralFunctions) {
    }
