...
var mat4;
var vec3;
function xViewer(canvas, maT4, veC3) {
    mat4 = maT4;
    vec3 = veC3;
...
xViewer.prototype._initMouseEvents = function () {
    ...
    function handleMouseMove(event) {
        ...
        //this is for picking
        id = viewer._getID(viewX, viewY);
        viewer._fire('mouseMove', { id: id, clientX: event.clientX, clientY: event.clientY});
        ///////////////////newly added for ifcviewer////////////////
    ...
    function navigate(type, deltaX, deltaY) {
        ...
        switch (type) {
            ...
            case 'fixed-orbit':
            case 'orbit':
                mat4.rotate(transform, transform, degToRad(deltaY), [1, 0, 0]);
                ...
                transform = mat4.rotate(mat4.create(), transform, degToRad(deltaX), mvZ);

                break;

            case 'pan':
                mat4.translate(transform, transform, [deltaX * distance / 500, 0, 0]);
                mat4.translate(transform, transform, [0, (-1.0 * deltaY) * distance / 500, 0]);
                break;
